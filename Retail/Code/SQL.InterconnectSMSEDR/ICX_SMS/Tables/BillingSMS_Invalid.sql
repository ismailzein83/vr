CREATE TABLE [ICX_SMS].[BillingSMS_Invalid] (
    [ID]                             BIGINT           NULL,
...
GO
CREATE CLUSTERED INDEX [IX_BillingSMS_Invalid_Sent_Operator]
    ON [ICX_SMS].[BillingSMS_Invalid]([SentDateTime] ASC, [OperatorID] ASC);
