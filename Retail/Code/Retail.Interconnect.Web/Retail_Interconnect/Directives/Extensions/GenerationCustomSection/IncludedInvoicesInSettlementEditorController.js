(function (appControllers) {
    ...
    includedInvoicesInSettlementEditorController.$inject = ["$scope", "UtilsService", "VRNotificationService", "VRNavigationService", "VRUIUtilsService", 'Retail_Interconnect_IncludedInvoicesInSettlementAPIService'];

    function includedInvoicesInSettlementEditorController($scope, UtilsService, VRNotificationService, VRNavigationService, VRUIUtilsService, Retail_Interconnect_IncludedInvoicesInSettlementAPIService) {
        ...
        function loadInvoicesDetails()
        {
            ...
            return Retail_Interconnect_IncludedInvoicesInSettlementAPIService.LoadInvoicesDetails(loadInvoicesDetailsInput).then(function (response) {
        ...
        function onIncludedInvoicesInSettlement() {
            ...
            return Retail_Interconnect_IncludedInvoicesInSettlementAPIService.TryLoadInvoicesAndGetAmountByCurrency(summaryObjectInput).then(function (response) {
    ...
    appControllers.controller("Retail_Interconnect_IncludedInvoicesInSettlementEditorController", includedInvoicesInSettlementEditorController);
})(appControllers);
