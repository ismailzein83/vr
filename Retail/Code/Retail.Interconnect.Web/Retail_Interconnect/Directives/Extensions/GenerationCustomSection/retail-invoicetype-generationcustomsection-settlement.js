...
app.directive("retailInvoicetypeGenerationcustomsectionSettlement", ['$filter', "UtilsService", "VRNotificationService", "VRUIUtilsService", 'Retail_Interconnect_IncludedInvoicesInSettlementService', 'Retail_Interconnect_IncludedInvoicesInSettlementAPIService',
    function ($filter, UtilsService, VRNotificationService, VRUIUtilsService, Retail_Interconnect_IncludedInvoicesInSettlementService, Retail_Interconnect_IncludedInvoicesInSettlementAPIService) {
        ...
        var directiveDefinitionObject = {
            ...
            templateUrl: "/Client/Modules/Retail_Interconnect/Directives/Extensions/GenerationCustomSection/Templates/SettlementGenerationCustomSectionTemplate.html"
        };
        ...
        function CustomerGenerationCustomSection($scope, ctrl, $attrs) {
            ...
            function initializeController() {
                ...
                $scope.scopeModel.openInvoicesEditor = function () {
                    ...
                    Retail_Interconnect_IncludedInvoicesInSettlementService.openIncludedInvoicesInSettlement(invoiceTypeId, financialAccountId, availableCustomerInvoices, availableSupplierInvoices, customPayload.isCustomerApplicable, customPayload.isSupplierApplicable, fromDate, toDate, onIncludedInvoicesInSettlement);
                };
            ...
            function defineAPI() {
                ...
                function loadCustomPayload(invoice) {
                    return Retail_Interconnect_IncludedInvoicesInSettlementAPIService.EvaluatePartnerCustomPayload(invoice.PartnerId, invoice.InvoiceTypeId, invoice.FromDate, invoice.ToDate).then(function (response) {
                ...
                api.getData = function () {
                    return {
                        $type: "Retail.Interconnect.Entities.SettlementGenerationCustomSectionPayload,Retail.Interconnect.Entities",
