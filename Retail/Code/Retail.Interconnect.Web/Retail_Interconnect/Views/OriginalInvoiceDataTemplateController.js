(function (appControllers) {
    ...
    originalInvoiceDataTemplateController.$inject = ['$scope', 'UtilsService', 'VRUIUtilsService', 'VRNavigationService', 'VRNotificationService', 'Retail_Interconnect_InvoiceAPIService','VR_Invoice_InvoiceAPIService','VRCommon_VRMailAPIService'];

    function originalInvoiceDataTemplateController($scope, UtilsService, VRUIUtilsService, VRNavigationService, VRNotificationService, Retail_Interconnect_InvoiceAPIService, VR_Invoice_InvoiceAPIService, VRCommon_VRMailAPIService) {
        ...
        {
            return Retail_Interconnect_InvoiceAPIService.GetOriginalInvoiceDataRuntime(invoiceId).then(function (response) {
        ...
        function updateOriginalInvoiceData() {
            ...
            return Retail_Interconnect_InvoiceAPIService.UpdateOriginalInvoiceData(originalInvoiceDataObj).then(function (response) {
    ...
    appControllers.controller('Retail_Interconnect_OriginalInvoiceDataTemplateController', originalInvoiceDataTemplateController);
