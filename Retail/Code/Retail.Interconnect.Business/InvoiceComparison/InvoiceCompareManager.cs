using Retail.Interconnect.Business.Extensions;
...
namespace Retail.Interconnect.Business
{
    public class InvoiceCompareManager
    {
        ...
        private List<InvoiceComparisonVoiceResult> ProccessInvoiceComparisonResult(ConvertedExcel convertedExcel, Dictionary<VoiceComparisonKey, VoiceInvoiceItemToCompare> systemInvoiceItems, decimal threshold, string dateTimeFormat, List<ComparisonVoiceCriteria> comparisonCriterias, int? decimalDigits, int longPrecision)
        {
        ...
        private ComparisonResult GetInvoiceComparisonVoiceResult(decimal threshold, decimal sysAmount, decimal sysNCalls, decimal sysDuration, decimal? providerAmount, decimal? providerNCalls, decimal? providerDuration, List<ComparisonVoiceCriteria> comparisonCriterias, out LabelColor resultLabelColor)
        {
        ...
        private bool VoiceCheckIfMajorErrorDiff(List<ComparisonVoiceCriteria> comparisonCriterias, decimal threshold, decimal sysAmount, decimal sysNCalls, decimal sysDuration, decimal? providerAmount, decimal? providerNCalls, decimal? providerDuration)
        {
            if (comparisonCriterias != null && comparisonCriterias.Count > 0)
            {
                foreach (var item in comparisonCriterias)
                {
                    switch (item)
                    {
                        case ComparisonVoiceCriteria.Calls:
                            ...
                            break;
                        case ComparisonVoiceCriteria.Amount:
                            ...
                            break;
                        case ComparisonVoiceCriteria.Duration:
        ...
        private bool VoiceCheckIfMinorErrorDiff(List<ComparisonVoiceCriteria> comparisonCriterias, decimal threshold, decimal sysAmount, decimal sysNCalls, decimal sysDuration, decimal? providerAmount, decimal? providerNCalls, decimal? providerDuration)
        {
            if (comparisonCriterias != null && comparisonCriterias.Count > 0)
            {
                foreach (var item in comparisonCriterias)
        ...
        private List<InvoiceComparisonSMSResult> ProccessInvoiceComparisonVoiceResult(ConvertedExcel convertedExcel, Dictionary<SMSComparisonKey, SMSInvoiceItemToCompare> systemInvoiceItems, decimal threshold, string dateTimeFormat, List<ComparisonSMSCriteria> comparisonCriterias, int? decimalDigits, int longPrecision)
        {
        ...
        private ComparisonResult GetInvoiceComparisonSMSResult(decimal threshold, decimal sysAmount, decimal sysNCalls, decimal? providerAmount, decimal? providerNCalls, List<ComparisonSMSCriteria> comparisonCriterias, out LabelColor resultLabelColor)
        {
        ...
        private bool SMSCheckIfMajorErrorDiff(List<ComparisonSMSCriteria> comparisonCriterias, decimal threshold, decimal sysAmount, decimal sysNSMSs, decimal? providerAmount, decimal? providerNSMSs)
        {
            if (comparisonCriterias != null && comparisonCriterias.Count > 0)
            {
                foreach (var item in comparisonCriterias)
                {
                    switch (item)
                    {
                        case ComparisonSMSCriteria.NbOfSMSs:
                            ...
                            break;
                        case ComparisonSMSCriteria.Amount:
                            if (CheckThresholdPercentage(sysAmount, providerAmount, threshold))
                            {
        ...
        private bool SMSCheckIfMinorErrorDiff(List<ComparisonSMSCriteria> comparisonCriterias, decimal threshold, decimal sysAmount, decimal sysNSMSs, decimal? providerAmount, decimal? providerNSMSs)
        {
            if (comparisonCriterias != null && comparisonCriterias.Count > 0)
            {
                foreach (var item in comparisonCriterias)
