...
app.directive('retailMultinetAccounttypeSelector', ['UtilsService', 'VRUIUtilsService', 'Retail_MultiNet_AccountTypeEnum',
    function (UtilsService, VRUIUtilsService, Retail_MultiNet_AccountTypeEnum) {
        return {
            restrict: 'E',
            scope: {
                onReady: '=',
            ...
            controller: function ($scope, $element, $attrs) {
                ...
                var ctor = new AccountTypeCtor(ctrl, $scope, $attrs);
        ...
        function AccountTypeCtor(ctrl, $scope, attrs) {
            ...
            function defineAPI() {
                ...
                api.load = function (payload) {
                    ...
                    var accountTypes = UtilsService.getArrayEnum(Retail_MultiNet_AccountTypeEnum);

                    if (accountTypes != null) {
                        for (var i = 0; i < accountTypes.length; i++) {
                            ctrl.datasource.push(accountTypes[i]);
                        }
                        ...
                        if (selectedIds != undefined) {
                            ...
                            VRUIUtilsService.setSelectedValues(accountTypes[0].value, 'value', attrs, ctrl);
                        }
                    }
                };
