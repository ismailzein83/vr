...
app.directive('retailMultinetSubscriberConvertorEditor', ['UtilsService', 'VRUIUtilsService', 'Retail_BE_EntityTypeEnum', 'VRNotificationService',
    function (UtilsService, VRUIUtilsService, Retail_BE_EntityTypeEnum, VRNotificationService) {
        ...
        var directiveDefinitionObject = {
            ...
            controller: function ($scope, $element, $attrs) {
                var ctrl = this;
                var ctor = new retailMultinetSubscriberConvertorEditorCtor(ctrl, $scope, $attrs);
            ...
            templateUrl: "/Client/Modules/Retail_MultiNet/Directives/Subscriber/Templates/SubscriberConvertorEditor.html"
        };

        function retailMultinetSubscriberConvertorEditorCtor(ctrl, $scope, $attrs) {
            ...
            $scope.scopeModel.onUserProfilePartDefinitionSelectorReady = function (api) {
            ...
            function defineAPI() {
                ...
                api.getData = function () {
                    var data = {
                        ...
                        SubscriberIdColumnName: $scope.scopeModel.subscriberColumnName
                    };
                    return data;
                };
