...
app.directive('retailMultinetCustomerConvertorEditor', ['UtilsService', 'VRUIUtilsService', 'Retail_BE_EntityTypeEnum', 'VRNotificationService',
    function (UtilsService, VRUIUtilsService, Retail_BE_EntityTypeEnum, VRNotificationService) {
        ...
        var directiveDefinitionObject = {
            ...
            controller: function ($scope, $element, $attrs) {
                var ctrl = this;
                var ctor = new retailMultiNetCustomerConvertorEditorCtor(ctrl, $scope, $attrs);
            ...
            templateUrl: "/Client/Modules/Retail_MultiNet/Directives/Customer/Templates/CustomerConvertorEditor.html"
        };

        function retailMultiNetCustomerConvertorEditorCtor(ctrl, $scope, $attrs) {
            ...
            function defineAPI() {
                ...
                api.load = function (payload) {
                    ...
                    if (payload != undefined) {
                        ...
                        $scope.scopeModel.isExcludedFromTaxColumnName = payload.IsExcludedFromTaxColumnName;
                    ...
                    function loadAccountInfoPartDefinitionSelector() {
                        ...
                        accountInfoDefinitionSelectorReadyDeferred.promise.then(function () {
                            var selectorPayload = {
                                filter: {
                                    AccountPartDefinitionIds: getAccountPartDefinitionIds('DAF99C84-8DC3-4C77-99CD-C0D631693D70')
                                },
                ...
                api.getData = function () {
                    var data = {
                        $type: "Retail.MultiNet.Business.Convertors.CustomerConvertor, Retail.MultiNet.Business",
                        Name: "MultiNet Customer Convertor",
                        ...
                        IsExcludedFromTaxColumnName: $scope.scopeModel.isExcludedFromTaxColumnName,
