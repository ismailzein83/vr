(function (appControllers) {
    ...
    function CustomCodePricingLogicEditor($scope, UtilsService, VRNotificationService, VRNavigationService) {
        ...
        function defineScope() {
            ...
            $scope.scopeModel.filterValueChanged = function (value) {
                ...
                for (var i = 0; i < $scope.scopeModel.chargeSettingsRecordTypeFields.length; i++) {
                    var chargeSettingsRecordField = $scope.scopeModel.chargeSettingsRecordTypeFields[i].Title.toLowerCase();
                ...
                for (var j = 0; j < $scope.scopeModel.targetRecordTypeFields.length; j++) {
                    var targetRecordField = $scope.scopeModel.targetRecordTypeFields[j].Title.toLowerCase();
        ...
        function sortByName(firstObject, secondObject) {
            var nameA = firstObject.Title.toLowerCase();
            var nameB = secondObject.Title.toLowerCase();
            if (nameA < nameB) {
                return -1;
            }
            if (nameA > nameB) {
