...
app.directive('retailZajilAccounttypePartDefinitionCompanyextendedinfo', [function () {
    return {
        ...
        templateUrl: '/Client/Modules/Retail_Zajil/Directives/MainExtensions/Account/Part/Definition/Templates/AccountTypePartCompanyExtendedInfoDefinitionTemplate.html'
    };
    ...
    function AccountTypeActivationPartDefinition($scope, ctrl, $attrs)
    {
        ...
        function defineAPI()
        {
            ...
            api.getData = function () {
                return {
                    $type: 'Retail.Zajil.MainExtensions.ZajilCompanyExtendedInfoDefinition, Retail.Zajil.MainExtensions'
                };
            };
