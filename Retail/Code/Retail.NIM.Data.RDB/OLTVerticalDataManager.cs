...
{
    public class OLTVerticalDataManager
    {
        public static string TABLE_NAME = "NIM_PSTN_OLTVertical";
        ...
        public void AddJoinOLTVerticalByOLT(RDBJoinContext joinContext, RDBJoinType joinType, string oltVerticalTableAlias, string originalTableAlias, string originalTableOLTCol, bool withNoLock)
        {
            joinContext.JoinOnEqualOtherTableColumn(joinType, TABLE_NAME, oltVerticalTableAlias, COL_OLT, originalTableAlias, originalTableOLTCol, withNoLock);
        }
    }
}