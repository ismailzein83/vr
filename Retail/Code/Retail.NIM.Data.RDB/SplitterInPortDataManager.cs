...
{
    public class SplitterInPortDataManager
    {
        public static string TABLE_NAME = "NIM_PSTN_SplitterInPort";
        ...
        static SplitterInPortDataManager()
        {
        ...
        public void AddJoinSplitterInPortBySplitter(RDBJoinContext joinContext, RDBJoinType joinType, string splitterOutPortTableAlias, string originalTableAlias,
