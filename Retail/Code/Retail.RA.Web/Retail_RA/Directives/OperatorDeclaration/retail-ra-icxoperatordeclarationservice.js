...
(function (app) {
    ...
    function operatorDirectionService(UtilsService, VRUIUtilsService, Retail_RA_OperatorDirectionServicesAPIService) {
        return {
            ...
            templateUrl: "/Client/Modules/Retail_RA/Directives/OperatorDeclaration/Templates/IcxOperationDirectionServicesTemplate.html"
        ...
        function OperatorDirectionServicesCtor($scope, ctrl, $attrs) {
            ...
            function defineAPI() {
                ...
                api.setData = function (Object) {
                    ...
                    Object.OperatorDeclarationServices = {
                        $type: "Retail.RA.Entities.IcxOperatorDeclarationServices,Retail.RA.Entities",
                        Services: {
                            $type: "Retail.RA.Entities.IcxOperatorDeclarationServicesCollection,Retail.RA.Entities",
                            $values: getServices()
                        }
                    };
                };
            ...
            function getServices() {
                ...
                for (var i = 0; i < $scope.scopeModel.operatorDeclarationServices.length; i++) {
                    ...
                    services.push({
                        $type: "Retail.RA.Entities.IcxOperatorDeclarationService,Retail.RA.Entities",
    ...
    app.directive('retailRaIcxoperatordeclarationservice', operatorDirectionService);
