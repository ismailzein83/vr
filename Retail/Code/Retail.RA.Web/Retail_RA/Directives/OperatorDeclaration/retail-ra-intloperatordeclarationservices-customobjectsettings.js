(function (app) {
    ...
    function operatorDirectionServicesType(UtilsService, VRUIUtilsService, VRNotificationService) {
        return {
            ...
            templateUrl: "/Client/Modules/Retail_RA/Directives/OperatorDeclaration/Templates/IntlOperatorDirectionServicesCustomObjectSettingsTemplate.html"
    ...
    app.directive('retailRaIntloperatordeclarationservicesCustomobjectsettings', operatorDirectionServicesType);
