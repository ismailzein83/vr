(function (app) {
    ...
    function OperatorDeclarationServiceVoice(UtilsService, VRUIUtilsService) {
        return {
            ...
            templateUrl: "/Client/Modules/Retail_RA/Directives/OperatorDeclaration/MainExtensions/Templates/IntlOperatorDeclarationServiceVoiceTemplate.html"
        };
        ...
        function OperatorDeclarationServiceVoiceCtor($scope, ctrl, $attrs) {
            ...
            function defineAPI() {
                ...
                api.getData = function () {
                    return {
                        $type: "Retail.RA.Business.IntlVoice,Retail.RA.Business",
    ...
    app.directive('retailRaIntloperatordeclarationserviceVoice', OperatorDeclarationServiceVoice);
