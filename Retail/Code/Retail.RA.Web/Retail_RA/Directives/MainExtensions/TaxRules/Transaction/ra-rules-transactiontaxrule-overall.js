...
(function (app) {
    ...
    function TaxruleOverall(UtilsService, VRUIUtilsService) {
        ...
        return {
            ...
            templateUrl: '/Client/Modules/Retail_RA/Directives/MainExtensions/TaxRules/Transaction/Templates/TransactionTaxRuleOverallTemplate.html'
        };
        function OverallTaxRuleSettings(ctrl, $scope, $attrs) {
            ...
            function defineAPI() {
                ...
                api.getData = function () {
                    var data = {
                        $type: "Retail.RA.Business.OverallTransactionTaxRuleSettings,Retail.RA.Business",
    ...
    app.directive('raRulesTransactiontaxruleOverall', TaxruleOverall);
})(app);