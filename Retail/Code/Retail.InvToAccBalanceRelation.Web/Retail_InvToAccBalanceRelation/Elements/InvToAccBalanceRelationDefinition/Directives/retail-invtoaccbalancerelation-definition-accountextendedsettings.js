...
app.directive("retailInvtoaccbalancerelationDefinitionAccountextendedsettings", ["UtilsService", "VRNotificationService", "VRUIUtilsService",
    function (UtilsService, VRNotificationService, VRUIUtilsService) {
        ...
        var directiveDefinitionObject = {
            ...
            templateUrl: "/Client/Modules/Retail_InvToAccBalanceRelation/Elements/InvToAccBalanceRelationDefinition/Directives/Templates/AccountInvToAccBalanceDefinitionExtendedSettings.html"
        ...
        function AccountInvToAccBalanceDefinitionExtendedSettings($scope, ctrl, $attrs) {
            ...
            function defineAPI() {
                ...
                api.getData = function () {
                    return {
                        $type: "Retail.InvToAccBalanceRelation.Business.AccountInvToAccBalanceRelationDefinitionExtendedSettings ,Retail.InvToAccBalanceRelation.Business",
