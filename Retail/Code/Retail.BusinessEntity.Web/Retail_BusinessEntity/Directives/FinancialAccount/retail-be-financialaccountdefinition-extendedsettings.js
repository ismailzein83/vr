(function (app) {
    ...
    FinancialAccountDefinitionExtendedSettingsDirective.$inject = ['Retail_BE_FinancialAccountDefinitionAPIService', 'UtilsService', 'VRUIUtilsService'];

    function FinancialAccountDefinitionExtendedSettingsDirective(Retail_BE_FinancialAccountDefinitionAPIService, UtilsService, VRUIUtilsService) {
        return {
            restrict: "E",
            scope: {
                onReady: "=",
            ...
            function defineAPI() {
                ...
                api.load = function (payload) {
                    ...
                    function getFinancialAccountDefinitionTemplateConfigs() {
                        return Retail_BE_FinancialAccountDefinitionAPIService.GetFinancialAccountDefinitionsConfigs().then(function (response) {
    ...
    app.directive('retailBeFinancialaccountdefinitionExtendedsettings', FinancialAccountDefinitionExtendedSettingsDirective);
