...
'use strict';
app.directive('retailBeIcxAccountSelector', ['UtilsService', 'VRUIUtilsService', 'Retail_BE_AccountBEAPIService'
function (UtilsService, VRUIUtilsService, Retail_BE_AccountBEAPIService) {
        ...
        function operatorCtor(ctrl, $scope, attrs) {
            ...
            function defineAPI() {
                ...
                api.load = function (payload) {
                    ...
                    getAccountsInfo(selectedIds).then(function (response) {
                        ...
                        var localOperator = getLocalOperatorInfo();
                        ctrl.datasource.push(item);
        ...
        function getAccountsInfo(accountBeDefinitionId, selectedIds) {
            return Retail_BE_AccountBEAPIService.GetAccountsInfo(accountBeDefinitionId, null, "");
        }

        function getLocalOperatorInfo()
        {
            //TODO: call the server to get the below info from Technical Settings of interconnect
            return {'AccountId': -999999, 'Name': 'Ogero'};
        };
