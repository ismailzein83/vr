    ...
    function ChargingpolicyDefinitionDirective(Retail_BE_ServiceTypeAPIService, UtilsService, VRUIUtilsService) {
        ...
        function getTamplate(attrs) {
            ...
            var template =
               ...
               + '</vr-row>'
            + '<vr-row>'
               + '<vr-directivewrapper directive="selectedTemplateConfig.Editor" on-ready="onDirectiveReady" normal-col-num="{{chargingpolicyCtrl.normalColNum}}" isrequired="chargingpolicyCtrl.isrequired" customvalidate="chargingpolicyCtrl.customvalidate"></vr-directivewrapper>'
             + '</vr-row>';
            return template;
