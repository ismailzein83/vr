(function (app) {
    ...
    function RecurringChargePeriodSelectorDirective(UtilsService, VRUIUtilsService, WhS_BE_RecurringChargeAPIService) {
        return {
            ...
            controller: function ($scope, $element, $attrs) {
                var ctrl = this;
                var ctor = new RecurringChargePeriodSelector($scope, ctrl, $attrs);
        ...
        function RecurringChargePeriodSelector($scope, ctrl, $attrs) {
                ...
                api.load = function (payload) {
                    ...
                    function loadDirective() {
                        ...
                        directiveReadyDeferred.promise.then(function () {
                            ...
                            var directivePayload = { context: getContext() };
                            if (recurringChargePeriod != undefined) {
                                directivePayload.extendedSettings = recurringChargePeriod;
                            }
    ...
    app.directive('retailBeRecurringchargeperiodSettings', RecurringChargePeriodSelectorDirective);
