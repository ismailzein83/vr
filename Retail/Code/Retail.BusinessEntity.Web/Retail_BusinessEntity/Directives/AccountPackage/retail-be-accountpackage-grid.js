...
app.directive('retailBeAccountpackageGrid', ['Retail_BE_AccountPackageAPIService', 'VRNotificationService', function (Retail_BE_AccountPackageAPIService, VRNotificationService)
{
    return {
        restrict: 'E',
        scope: {
