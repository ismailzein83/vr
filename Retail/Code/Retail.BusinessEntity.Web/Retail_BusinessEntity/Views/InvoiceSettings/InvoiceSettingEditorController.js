...
(function (appControllers) {
    ...
    invoiceSettingEditorController.$inject = ['$scope', 'VRNotificationService', 'VRNavigationService', 'UtilsService', 'VRUIUtilsService', 'Retail_BE_InvoiceSettingService'];

    function invoiceSettingEditorController($scope, VRNotificationService, VRNavigationService, UtilsService, VRUIUtilsService, Retail_BE_InvoiceSettingService) {
        ...
        function loadMailMsgTemplateSelector() {
            ...
            Retail_BE_InvoiceSettingService.getSubscriberInvoiceMailType().then(function (response) {
        ...
        function loadSerialNumberPattern() {
            ...
            serialNumberPatternReadyPromiseDeferred.promise.then(function () {
                var serialNumberPatternDirectivePayload = { invoiceTypeId: "384C819D-6E21-4E9A-9F08-11C7B81AD329" };
                if (invoiceSettingEntity != undefined)
    ...
    appControllers.controller('Retail_BE_InvoiceSettingEditorController', invoiceSettingEditorController);
})(appControllers);
