(function (appControllers) {
    ...
    function PricingPackageSettingsService(VRModalService) {
        ...
        function addPricingPackageSetting(excludedServiceTypeIds, onPricingPackageSettingsAdded,context) {
            ...
            VRModalService.showModal('/Client/Modules/Retail_BusinessEntity/Directives/Package/PackageRuntime/MainExtensions/PackageTypes/Templates/PricingPackageSettingsEditor.html', parameters, modalSettings);
        }
