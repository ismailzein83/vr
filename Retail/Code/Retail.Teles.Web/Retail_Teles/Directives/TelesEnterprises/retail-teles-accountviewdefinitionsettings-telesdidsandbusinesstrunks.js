...
app.directive('retailTelesAccountviewdefinitionsettingsTelesdidsandbusinesstrunks', ['UtilsService','VRUIUtilsService',
    function (UtilsService, VRUIUtilsService) {
        return {
            ...
            templateUrl: '/Client/Modules/Retail_Teles/Directives/TelesEnterprises/Templates/AccountTelesDIDsAndBusinessTrunksViewSettingsTemplate.html'
        };
        ...
        function AccountTelesDIDsAndBusinessTrunksViewSettingsCtor($scope, ctrl, $attrs) {
            ...
            function defineAPI() {
                ...
                api.getData = function () {
                    ...
                    return {
                        $type: 'Retail.Teles.Business.AccountTelesDIDsAndBusinessTrunksView, Retail.Teles.Business',
