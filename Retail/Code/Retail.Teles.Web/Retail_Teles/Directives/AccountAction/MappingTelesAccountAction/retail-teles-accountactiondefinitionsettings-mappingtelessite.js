...
app.directive('retailTelesAccountactiondefinitionsettingsMappingtelessite', ['UtilsService','VRUIUtilsService',
    function (UtilsService, VRUIUtilsService) {
        return {
            ...
            controller: function ($scope, $element, $attrs) {
                var ctrl = this;
                var ctor = new MappingTelesSiteActionSettingsCtor($scope, ctrl, $attrs);
                ctor.initializeController();
            },
            controllerAs: 'ctrl',
            bindToController: true,
            templateUrl: '/Client/Modules/Retail_Teles/Directives/AccountAction/MappingTelesAccountAction/Templates/MappingTelesSiteActionSettingsTemplate.html'
        };

        function MappingTelesSiteActionSettingsCtor($scope, ctrl, $attrs) {
