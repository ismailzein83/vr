...
app.directive('retailTelesAccountactiondefinitionsettingsMappingtelesuser', ['UtilsService','VRUIUtilsService',
    function (UtilsService, VRUIUtilsService) {
        return {
            ...
            controller: function ($scope, $element, $attrs) {
                var ctrl = this;
                var ctor = new MappingTelesUserActionSettingsCtor($scope, ctrl, $attrs);
                ctor.initializeController();
            },
            controllerAs: 'ctrl',
            bindToController: true,
            templateUrl: '/Client/Modules/Retail_Teles/Directives/AccountAction/MappingTelesAccountAction/Templates/MappingTelesUserActionSettingsTemplate.html'
        };

        function MappingTelesUserActionSettingsCtor($scope, ctrl, $attrs) {
            ...
            function defineAPI() {
                ...
                api.getData = function () {
                    return {
                        $type: 'Retail.Teles.Business.AccountBEActionTypes.MappingTelesUserActionSettings, Retail.Teles.Business',
