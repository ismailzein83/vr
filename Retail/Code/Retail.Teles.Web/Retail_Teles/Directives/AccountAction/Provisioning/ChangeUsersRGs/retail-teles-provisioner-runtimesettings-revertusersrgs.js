(function (app) {
    ...
    function ProvisionerRuntimesettingsDirective(UtilsService, VRUIUtilsService) {
        return {
            ...
            templateUrl: "/Client/Modules/Retail_Teles/Directives/AccountAction/Provisioning/ChangeUsersRGs/Templates/RevertUsersRGsProvisionerRuntimeSettingsTemplate.html"
        ...
        function ProvisionerRuntimesettings($scope, ctrl, $attrs) {
            ...
            function defineAPI() {
                ...
                function getData() {
                    var data = {
                        $type: "Retail.Teles.Business.RevertUsersRGsRuntimeSettings,Retail.Teles.Business",
                    };
                    return data;
                }
            }
    ...
    app.directive('retailTelesProvisionerRuntimesettingsRevertusersrgs', ProvisionerRuntimesettingsDirective);
