CREATE TABLE [RA_CDR].[BillingCDR_Main] (
...
CREATE NONCLUSTERED INDEX [IX_BillingCDR_Main_Operator]
    ON [RA_CDR].[BillingCDR_Main]([OperatorID] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_BillingCDR_Main_ID]
    ON [RA_CDR].[BillingCDR_Main]([CDRID] ASC);


GO
CREATE CLUSTERED INDEX [IX_BillingCDR_Main_AttemptTime]
    ON [RA_CDR].[BillingCDR_Main]([AttemptDateTime] ASC);
