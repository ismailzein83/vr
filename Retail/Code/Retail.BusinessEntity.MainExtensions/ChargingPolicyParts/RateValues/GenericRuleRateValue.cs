...
namespace Retail.BusinessEntity.MainExtensions.ChargingPolicyParts.RateValues
{
    public class GenericRuleRateValue : ChargingPolicyRateValue
    {
        ...
        {
            var ruleTree = Helper.GetRuleTree(context.PricingEntity, context.PricingEntityId, context.ServiceTypeId, ChargingPolicyPartType.RateValue, this.RateValueRules);
