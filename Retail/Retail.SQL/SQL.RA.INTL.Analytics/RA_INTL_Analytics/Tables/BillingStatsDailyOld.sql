CREATE TABLE [RA_INTL_Analytics].[BillingStatsDailyOld] (
    [ID]                         BIGINT          NOT NULL,
    ...
    [CurrencyID]                 INT             NULL,
    CONSTRAINT [IX_RA_INTL_BillingStatsDaily_IDOld] PRIMARY KEY NONCLUSTERED ([ID] ASC)
);


GO
CREATE CLUSTERED INDEX [IX_RA_INTL_BillingStatsDaily_BatchStartOld]
    ON [RA_INTL_Analytics].[BillingStatsDailyOld]([BatchStart] ASC);
