...
app.directive("npIvswitchSupplierRouteGrid", ["UtilsService", "VRNotificationService", "NP_IVSwitch_RouteTableAPIService", "NP_IVSwitch_RouteTableService", "VRUIUtilsService", "VRCommon_ObjectTrackingService", "NP_IVSwitch_EndPointStateEnum",
    function (UtilsService, VRNotificationService, NP_IVSwitch_RouteTableAPIService, NP_IVSwitch_RouteTableService, VRUIUtilsService, VRCommon_ObjectTrackingService, NP_IVSwitch_EndPointStateEnum) {
        ...
        function RouteTableGrid($scope, ctrl) {
            ...
            $scope.scopeModel.warning = undefined;
            ...
            function initializeController() {
                ...
                $scope.scopeModel.onPercentageValueChanged = function () {
                    ...
                    if (total != undefined) {
                        if (total < 100) {
                            $scope.scopeModel.warning = {
                                Message: "\xa0\xa0\xa0\xa0\xa0\xa0\xa0 * Sum of Percentages is less than 100"
                            };
                        }

                        if (total > 100) {
                            return "Sum of percentages must not be greater than 100 ";
                        }
            ...
            function defineAPI() {
                ...
                api.getData = function () {
                    ...
                    if ($scope.scopeModel.columns != null && $scope.scopeModel.columns.length > 0)
                        for (var i = 0; i < $scope.scopeModel.columns.length; i++) {
                            ...
                            var routeOption = {
                                RouteIds: column.routeDirectiveAPI.getSelectedIds(),
                ...
                function addColumnOnEdit(gridItem) {
                    ...
                    UtilsService.waitMultiplePromises([gridItem.routeReadyDeffered.promise, selectedSupplierDeffered.promise]).then(function () {
                        ...
                        if (gridItem.payload != undefined) {
                            directivePayload.selectedIds = gridItem.payload.RouteIds != 0 ? gridItem.payload.RouteIds : undefined;
