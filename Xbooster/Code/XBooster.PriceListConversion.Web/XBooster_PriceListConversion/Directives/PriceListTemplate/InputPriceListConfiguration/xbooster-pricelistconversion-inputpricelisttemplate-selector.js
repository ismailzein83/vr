(function (app) {
    ...
    InputpricelisttemplateSelector.$inject = ['XBooster_PriceListConversion_PriceListTemplateAPIService', 'UtilsService', 'VRUIUtilsService'];

    function InputpricelisttemplateSelector(XBooster_PriceListConversion_PriceListTemplateAPIService, UtilsService, VRUIUtilsService) {
        ...
        function InputpricelistTemplateSelector(ctrl, $scope, attrs) {
            ...
            function defineAPI() {
                ...
                api.load = function (payload) {
                    ...
                    return XBooster_PriceListConversion_PriceListTemplateAPIService.GetInputPriceListTemplates(UtilsService.serializetoJson(filter)).then(function (response) {
    ...
    app.directive('xboosterPricelistconversionInputpricelisttemplateSelector', InputpricelisttemplateSelector);
