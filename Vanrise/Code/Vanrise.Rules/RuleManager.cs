...
namespace Vanrise.Rules
{
        ...
        where Q : class
    {
        ...
        public bool TryAdd(T rule)
        {
            ...
            if (ValidateBeforeAdd(rule))
            {
                ...
                if (rule.HasAdditionalInformation)
                {
                    ...
                    {
                        rule.RuleId = ruleId;
                        rule.CreatedBy = loggedInUserId;
                        rule.LastModifiedBy = loggedInUserId;
                        return true;
                    }
                }
        ...
        {
            int ruleTypeId = GetRuleTypeId();
            var lastModifyBy = ContextFactory.GetContext().GetLoggedInUserId();
            ...
            if (ValidateBeforeUpdate(rule))
            {
                ...
                if (rule.HasAdditionalInformation)
                {
                    ...
                    if (ruleAdded)
                    {
                        ...
                        {
                            rule.LastModifiedBy = lastModifyBy;
                            return true;
                        }
                    }
                    else
               ...
               () =>
               {
                   ...
                   if (ruleEntities != null)
                   {
                       foreach (var ruleEntity in ruleEntities)
                       {
                           ...
                           rule.CreatedBy = ruleEntity.CreatedBy;
                           rule.LastModifiedTime = ruleEntity.LastModifiedTime;
                           rule.LastModifiedBy = ruleEntity.LastModifiedBy;
