...
namespace Vanrise.AccountBalance.Data.SQL
{
    public class BalanceHistoryDataManager : BaseSQLDataManager, IBalanceHistoryDataManager
    {
        ...
        public bool InsertBalanceHistoryFromLiveBalance(long closingPeriodID)
        {
            return (ExecuteNonQuerySP("[VR_AccountBalance].[sp_BalanceHistory_InsertFromLiveBalance]", closingPeriodID) > 0);
