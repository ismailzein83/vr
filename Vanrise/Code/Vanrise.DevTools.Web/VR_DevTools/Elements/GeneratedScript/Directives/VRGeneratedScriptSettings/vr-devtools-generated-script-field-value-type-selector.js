...
appControllers.directive('vrDevtoolsGeneratedScriptFieldValueTypeSelector', ['VRNotificationService', 'UtilsService', 'VRUIUtilsService', 'VR_Devtools_GeneratedScriptFieldValueTypeEnum',
    function (VRNotificationService, UtilsService, VRUIUtilsService, VR_Devtools_GeneratedScriptFieldValueTypeEnum) {
        'use strict';
        ...
        var directiveDefinitionObject = {
            ...
            template: function (element, attrs) {
                ...
                return getFieldValueTypeTemplate(attrs);
            }
        };

        function getFieldValueTypeTemplate(attrs) {


            var multipleselection = "";
            var label = "Field Value Type";
            if (attrs.ismultipleselection != undefined) {
        ...
        function TypeSelector(ctrl, $scope, attrs) {
            ...
            function defineAPI() {
                ...
                api.load = function (payload) { //payload is an object that has selectedids and filter
                    ...
                    ctrl.datasource = UtilsService.getArrayEnum(VR_Devtools_GeneratedScriptFieldValueTypeEnum);
