...
appControllers.directive('vrDevtoolsSchemaSelector', ['VRNotificationService', 'VR_Devtools_SchemaAPIService', 'UtilsService', 'VRUIUtilsService',
    function (VRNotificationService, VR_Devtools_SchemaAPIService, UtilsService, VRUIUtilsService) {
        'use strict';
        ...
        function SchemaSelector(ctrl, $scope, attrs) {
            ...
            function defineAPI() {
                ...
                api.load = function (payload) { //payload is an object that has selectedids and filter
                    ...
                    return VR_Devtools_SchemaAPIService.GetSchemasInfo(UtilsService.serializetoJson(filter)).then(function (response) {
                        if (response != null) {
