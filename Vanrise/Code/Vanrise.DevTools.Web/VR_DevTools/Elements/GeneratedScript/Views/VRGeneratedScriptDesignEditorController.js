(appControllers); (function (appControllers) {
    "use strict";
    generatedScriptDesignEditorController.$inject = ['$scope', 'VRNotificationService', 'VRNavigationService', 'UtilsService', 'VRUIUtilsService', 'VR_Devtools_GeneratedScriptService'];

    function generatedScriptDesignEditorController($scope, VRNotificationService, VRNavigationService, UtilsService, VRUIUtilsService, VR_Devtools_GeneratedScriptService) {
    ...
    appControllers.controller('VR_Devtools_GeneratedScriptDesignEditorController', generatedScriptDesignEditorController);
})(appControllers);