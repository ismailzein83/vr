(function (appControllers) {
    ...
    NumberingPlanPreviewController.$inject = ['$scope', 'BusinessProcess_BPTaskAPIService', 'Vr_NP_PreviewChangeTypeEnum', 'Vr_NP_PreviewGroupedBy', 'VRNotificationService', 'VRNavigationService', 'UtilsService', 'VRUIUtilsService'];

    function NumberingPlanPreviewController($scope, BusinessProcess_BPTaskAPIService, Vr_NP_PreviewChangeTypeEnum, Vr_NP_PreviewGroupedBy, VRNotificationService, VRNavigationService, UtilsService, VRUIUtilsService) {
        var bpTaskId;
        ...
        function executeTask(taskAction) {
            var executionInformation = {
                $type: "Vanrise.NumberingPlan.BP.Arguments.PreviewTaskExecutionInformation, Vanrise.NumberingPlan.BP.Arguments",
                Decision: taskAction
            };
        ...
        function loadViewChangeTypeSelector() {
            ...
            viewChangeTypeReadyPromiseDeferred.promise.then(function () {
                var viewChangeTypeSelectorPayload = {
                    selectedIds: Vr_NP_PreviewChangeTypeEnum.OnlyModifiedEntities.value
                };
        ...
        function loadGroupedBySelector() {
            ...
            groupedByReadyPromiseDeferred.promise.then(function () {
                var viewChangeTypeSelectorPayload = {
                    selectedIds: Vr_NP_PreviewGroupedBy.Countries.description
                };
    ...
    appControllers.controller('Vr_NP_NumberingPlanPreviewController', NumberingPlanPreviewController);
})(appControllers);
