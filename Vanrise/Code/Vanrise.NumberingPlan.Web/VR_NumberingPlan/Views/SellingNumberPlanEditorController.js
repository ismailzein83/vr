(function (appControllers) {
    ...
    sellingNumberPlanEditorController.$inject = ['$scope', 'Vr_NP_SellingNumberPlanAPIService', 'VRNotificationService', 'VRNavigationService', 'UtilsService'];

    function sellingNumberPlanEditorController($scope, Vr_NP_SellingNumberPlanAPIService, VRNotificationService, VRNavigationService, UtilsService) {
        ...
        function getSellingNumberPlan() {
            return Vr_NP_SellingNumberPlanAPIService.GetSellingNumberPlan(sellingNumberPlanId).then(function (sellingNumberPlan) {
        ...
        function insertsellingNumberPlan() {
            $scope.isGettingData = true;
            return Vr_NP_SellingNumberPlanAPIService.AddSellingNumberPlan(buildSellingNumberPlanObjFromScope())
        ...
        function updatesellingNumberPlan() {
            $scope.isGettingData = true;
            return Vr_NP_SellingNumberPlanAPIService.UpdateSellingNumberPlan(buildSellingNumberPlanObjFromScope())
            .then(function (response) {
    ...
    appControllers.controller('Vr_NP_SellingNumberPlanEditorController', sellingNumberPlanEditorController);
})(appControllers);
