...
app.directive('vrNpViewchangetypeSelector', ['Vr_NP_PreviewChangeTypeEnum', 'UtilsService', 'VRUIUtilsService',
    function (Vr_NP_PreviewChangeTypeEnum, UtilsService, VRUIUtilsService) {
    ...
    function ViewChangeTypeSelector(ctrl, $scope, attrs) {
        ...
        function defineAPI() {
            ...
            api.load = function (payload) {
                ...
                ctrl.datasource = UtilsService.getArrayEnum(Vr_NP_PreviewChangeTypeEnum);
