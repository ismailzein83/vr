    ...
    public class MenuManager
    {
        ...
        private MenuItem GetModuleMenu(Module module, List<Module> modules, List<View> views)
        {
            ...
            if (childViews.Count > 0)
            {
                ...
                {
                    if ((viewItem.RequiredPermissions == null || SecurityContext.Current.IsAllowed(viewItem.RequiredPermissions)) && (viewItem.ActionNames == null || SecurityContext.Current.IsAllowedBySystemActionNames(viewItem.ActionNames)))
                    {
