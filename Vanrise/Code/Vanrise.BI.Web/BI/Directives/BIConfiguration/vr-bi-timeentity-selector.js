'use strict';
app.directive('vrBiTimeentitySelector', ['VR_BI_BIConfigurationAPIService', 'UtilsService', 'VRUIUtilsService',
        ...
        function timeEntityCtor(ctrl, $scope, attrs) {
            ...
            function defineAPI() {
                ...
                api.load = function (payload) {
                    ...
                    return VR_BI_BIConfigurationAPIService.GetTimeEntitiesInfo().then(function (response) {
