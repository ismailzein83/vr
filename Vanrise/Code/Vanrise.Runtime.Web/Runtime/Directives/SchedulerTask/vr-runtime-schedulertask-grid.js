                ...
                for (var j = 0; j < $scope.schedulerTasks.length; j++) {
                    if ($scope.schedulerTasks[j].Entity.IsEnabled != status) {
                        ...
                        var Entity = {
                            ...
                            ActionTypeId: currentSchedulerTask.Entity.ActionTypeId,
                            TaskType: currentSchedulerTask.Entity.TaskType,
                            TriggerTypeId: currentSchedulerTask.Entity.TriggerTypeId,
                            TriggerInfo: currentSchedulerTask.Entity.TriggerInfo,
                            OwnerId: currentSchedulerTask.Entity.OwnerId,
                            ActionInfo: currentSchedulerTask.Entity.ActionInfo,
                            TaskSettings: currentSchedulerTask.Entity.TaskSettings,
                            IsEnabled: status,
