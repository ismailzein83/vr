...
namespace Vanrise.NumberingPlan.Data.SQL
{
    public class SaleCodeDataManager : Vanrise.Data.SQL.BaseSQLDataManager, ISaleCodeDataManager
    {
        ...
        public IEnumerable<SaleCode> GetFilteredSaleCodes(SaleCodeQuery query)
        {
            ...
            return GetItemsSP("VR_NumberingPlan.sp_SaleCode_GetFiltered", SaleCodeMapper, query.EffectiveOn, query.Code, query.SellingNumberPlanId, listOfZoneIds);
        }

        public IEnumerable<SaleCode> GetSaleCodesByZone(SaleCodeQueryByZone query)
        {
            return GetItemsSP("VR_NumberingPlan.sp_SaleCode_GetFilteredByZone", SaleCodeMapper, query.ZoneId, query.EffectiveOn);
        }

        public IEnumerable<SaleCode> GetAllSaleCodes()
        {
            return GetItemsSP("VR_NumberingPlan.sp_SaleCode_GetAll", SaleCodeMapper);
        }

        public List<SaleCode> GetSaleCodesByZoneID(long zoneID, DateTime effectiveDate)
        {
            return GetItemsSP("VR_NumberingPlan.sp_SaleCode_GetByZoneId", SaleCodeMapper, zoneID, effectiveDate);
        }
        ...
        public List<SaleCode> GetSaleCodesByCodeGroups(List<int> codeGroupsIds)
        {
            ...
            return GetItemsSP("VR_NumberingPlan.sp_SaleCode_GetByCodeGroupIds", SaleCodeMapper, codegroupslist);
        }


        public List<SaleCode> GetSaleCodesEffectiveByZoneID(long zoneID, DateTime effectiveDate)
        {
            return GetItemsSP("VR_NumberingPlan.sp_SaleCode_GetEffectiveByZoneId", SaleCodeMapper, zoneID, effectiveDate);
        }

        public List<SaleCode> GetSaleCodes(DateTime effectiveOn)
        {
            return GetItemsSP("[VR_NumberingPlan].[sp_SaleCode_GetByEffective]", SaleCodeMapper, effectiveOn);
        }

        public List<SaleCode> GetSaleCodesEffectiveAfter(int sellingNumberPlanId, DateTime effectiveOn)
        {
            return GetItemsSP("VR_NumberingPlan.sp_SaleCode_GetEffectiveAndPendingBySellingNumberPlan", SaleCodeMapper, sellingNumberPlanId, effectiveOn);
        }
        ...
        {
            return GetItemsSP("VR_NumberingPlan.sp_SaleCode_GetByCodePrefix", SaleCodeMapper, codePrefix, effectiveOn, isFuture, getChildCodes, getParentCodes);
        }

        public IEnumerable<CodePrefixInfo> GetDistinctCodeByPrefixes(int prefixLength, DateTime? effectiveOn, bool isFuture)
        {
            return GetItemsSP("VR_NumberingPlan.sp_SaleCode_GetDistinctCodePrefixes", CodePrefixMapper, prefixLength, effectiveOn, isFuture);
        }
        ...
        public IEnumerable<CodePrefixInfo> GetSpecificCodeByPrefixes(int prefixLength, IEnumerable<string> codePrefixes, DateTime? effectiveOn, bool isFuture)
        {
            ...
            return GetItemsSP("VR_NumberingPlan.sp_SaleCode_GetSpecificCodePrefixes", CodePrefixMapper, prefixLength, _codePrefixes, effectiveOn, isFuture);
        }

        public bool AreZonesUpdated(ref object lastReceivedDataInfo)
        {
            return IsDataUpdated("VR_NumberingPlan.SaleCode", ref lastReceivedDataInfo);
        }
        public List<SaleCode> GetSaleCodesByZoneName(int sellingNumberPlanId, string zoneName, DateTime effectiveDate)
        {
            return GetItemsSP("VR_NumberingPlan.sp_SaleCode_GetByZoneName", SaleCodeMapper, sellingNumberPlanId, zoneName, effectiveDate);
        }
        public List<SaleCode> GetSaleCodesEffectiveAfter(int sellingNumberPlanId, int countryId, DateTime minimumDate)
        {
            return GetItemsSP("VR_NumberingPlan.sp_SaleCode_GetByDate", SaleCodeMapper, sellingNumberPlanId, countryId, minimumDate);
        }
        public List<SaleCode> GetSaleCodesByCountry(int countryId, DateTime effectiveDate)
        {
            return GetItemsSP("VR_NumberingPlan.sp_SaleCode_GetByCountry", SaleCodeMapper, countryId, effectiveDate);
        }
        ...
        public List<SaleCode> GetSaleCodesByZoneIDs(List<long> zoneIds, DateTime effectiveDate)
        {
            ...
            return GetItemsSP("VR_NumberingPlan.sp_SaleCode_GetByZoneIds", SaleCodeMapper, allZoneIds, effectiveDate);
        }

        public bool AreSaleCodesUpdated(ref object updateHandle)
        {
            return base.IsDataUpdated("VR_NumberingPlan.SaleCode", ref updateHandle);
        }
