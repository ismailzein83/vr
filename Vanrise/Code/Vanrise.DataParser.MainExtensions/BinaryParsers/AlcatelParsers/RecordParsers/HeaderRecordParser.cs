...
namespace Vanrise.DataParser.MainExtensions.BinaryParsers.AlcatelParsers.RecordParsers
{
    public class HeaderRecordParser : BinaryRecordParserSettings
    {
        ...
        public override void Execute(IBinaryRecordParserContext context)
        {
            ...
            BinaryParserHelper.ReadBlockFromStream(context.RecordStream, HeaderByteLength, (header) =>
            {
                ...
                if (string.Compare(this.RecordStartingTag, headerTagHex, true) == 0)
                {
                    ...
                    {
                        BinaryParserHelper.ReadBlockFromStream(ms, tagToIgnoreBytesLength.Value, (content) =>
                        {
                        ...
                        BinaryParserHelper.ExecuteRecordParser(RecordParser, new MemoryStream(validBytes.ToArray()), context);
                    }
                    else
                    {
