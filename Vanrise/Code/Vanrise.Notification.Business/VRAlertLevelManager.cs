...
namespace Vanrise.Notification.Business
{
	public class VRAlertLevelManager : BaseBusinessEntityManager
	{
		...
		public IEnumerable<VRAlertLevel> GetBusinessEntityDefinitionAlertLevels(Guid businessEntityDefinitionId)
		{
			var allAlertLevels = GetCachedAlertLevels();

			if (allAlertLevels == null || allAlertLevels.Count() == 0)
				return null;

			return allAlertLevels.FindAllRecords(item => item.BusinessEntityDefinitionId == businessEntityDefinitionId);
		}
