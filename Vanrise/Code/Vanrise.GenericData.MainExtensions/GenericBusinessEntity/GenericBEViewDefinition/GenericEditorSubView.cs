...
{
    public class GenericEditorSubView : GenericBEViewDefinitionSettings
    {
        public override Guid ConfigId { get { return new Guid("A4C1333D-886B-4C94-BEFF-E1A32ADD69BE"); } }
        public override string RuntimeDirective { get { return "vr-genericdata-genericbe-genericeditorsubview-runtime"; } }
