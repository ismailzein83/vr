...
app.directive("vrIntegrationImportedbatchSearch", ['VR_Integration_MappingResultEnum', 'UtilsService', 'VRNotificationService', 'VRUIUtilsService', 'VRValidationService', 'VRDateTimeService', '$filter', 'UISettingsService',
    function (VR_Integration_MappingResultEnum, UtilsService, VRNotificationService, VRUIUtilsService, VRValidationService, VRDateTimeService, $filter, UISettingsService) {
        ...
        function LogSearch($scope, ctrl, $attrs) {
            ...
            var executionStatusSelectorAPI;
            var executionStatusSelectorReadyPromiseDeferred = UtilsService.createPromiseDeferred();
            ...
            function defineScope() {
                ...
                $scope.onExecutionStatusSelectorReady = function (api) {
                    executionStatusSelectorAPI = api;
                    executionStatusSelectorReadyPromiseDeferred.resolve();
                };
            ...
            function loadAllControls() {
                return UtilsService.waitMultipleAsyncOperations([loadDatasourceSelector, loadExecutionStatusSelector]).catch(function (error) {
            ...
            function getGridQuery() {
                var query = {
                    ...
                    Top: $scope.top,
                    ExecutionFlowsStatus: executionStatusSelectorAPI.getSelectedIds()
                };
                return query;
            ...
            function loadExecutionStatusSelector() {
                var executionStatusLoadPromiseDeferred = UtilsService.createPromiseDeferred();

                executionStatusSelectorReadyPromiseDeferred.promise.then(function () {
                    VRUIUtilsService.callDirectiveLoad(executionStatusSelectorAPI, undefined, executionStatusLoadPromiseDeferred);
                });
                return executionStatusLoadPromiseDeferred.promise;
            }
