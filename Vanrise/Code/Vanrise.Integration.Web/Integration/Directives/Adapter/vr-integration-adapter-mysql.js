...
app.directive("vrIntegrationAdapterMysql", ['UtilsService',
function (UtilsService) {
    ...
    var directiveDefinitionObject = {
        ...
        templateUrl: "/Client/Modules/Integration/Directives/Adapter/Templates/AdapterMySQLTemplate.html"
    };
    ...
    function DirectiveConstructor($scope, ctrl) {
        ...
        function defineAPI() {
            ...
            api.getData = function () {
                var obj = {
                    $type: "Vanrise.Integration.Adapters.MySQLReceiveAdapter.Arguments.MySQLAdapterArgument, Vanrise.Integration.Adapters.MySQLReceiveAdapter.Arguments",
