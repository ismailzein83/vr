...
app.directive("vrIntegrationAdapterPostgres", ['UtilsService',
function (UtilsService) {
    ...
    var directiveDefinitionObject = {
        ...
        templateUrl: "/Client/Modules/Integration/Directives/Adapter/Templates/AdapterPostgresTemplate.html"
    };
    ...
    function DirectiveConstructor($scope, ctrl) {
        ...
        function defineAPI() {
            ...
            api.getData = function () {
                var obj = {
                    $type: "Vanrise.Integration.Adapters.PostgresReceiveAdapter.Arguments.PostgresAdapterArgument, Vanrise.Integration.Adapters.PostgresReceiveAdapter.Arguments",
