...
app.directive("vrAccountbalanceAccountbalancesVieweditor", ["UtilsService", "VRNotificationService", "VRUIUtilsService",
    function (UtilsService, VRNotificationService, VRUIUtilsService) {
        ...
        var directiveDefinitionObject = {
            ...
            templateUrl: "/Client/Modules/VR_AccountBalance/Directives/AccountBalances/Templates/AccountBalancesViewEditor.html"
        };
        function ViewEditorCtor($scope, ctrl, $attrs) {
            ...
            function defineAPI() {
                ...
                api.getData = function () {
                    return {
                        $type: "Vanrise.AccountBalance.Entities.AccountBalancesViewSettings, Vanrise.AccountBalance.Entities",
