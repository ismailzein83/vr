...
app.directive("vrAccountbalanceAccountstatementVieweditor", ["UtilsService", "VRNotificationService", "VRUIUtilsService",
    function (UtilsService, VRNotificationService, VRUIUtilsService) {
        ...
        var directiveDefinitionObject = {
            ...
            templateUrl: "/Client/Modules/VR_AccountBalance/Directives/AccountStatement/Templates/AccountSatementViewEditor.html"
        };
        function ViewEditorCtor($scope, ctrl, $attrs) {
            ...
            function defineAPI() {
                ...
                api.getData = function () {
                    return {
                        $type: "Vanrise.AccountBalance.Entities.AccountStatementViewSettings, Vanrise.AccountBalance.Entities",
