(function (app) {
    ...
    AccountstatusSelector.$inject = ['UtilsService', 'VRUIUtilsService', 'VR_AccountBalance_AccountStatusEnum'];

    function AccountstatusSelector(UtilsService, VRUIUtilsService, VR_AccountBalance_AccountStatusEnum) {
        return {
            restrict: 'E',
            scope: {
                onReady: '=',
