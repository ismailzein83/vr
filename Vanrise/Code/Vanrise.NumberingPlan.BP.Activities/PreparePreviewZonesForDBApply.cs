...
namespace Vanrise.NumberingPlan.BP.Activities
{
    ...
    public sealed class PreparePreviewZonesForDBApply : DependentAsyncActivity<PreparePreviewZonesForApplyInput>
    {
        ...
        protected override void DoWork(PreparePreviewZonesForApplyInput inputArgument, AsyncActivityStatus previousActivityStatus, AsyncActivityHandle handle)
        {
        ...
        {
            return new PreparePreviewZonesForApplyInput()
            {
