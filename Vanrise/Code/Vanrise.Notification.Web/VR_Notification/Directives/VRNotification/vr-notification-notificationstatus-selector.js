...
app.directive('vrNotificationNotificationstatusSelector', ['UtilsService', 'VRUIUtilsService', 'VR_Notification_NotificationStatusEnum',
    function (UtilsService, VRUIUtilsService, VR_Notification_NotificationStatusEnum) {
        return {
            restrict: 'E',
            scope: {
                onReady: '=',
        ...
        function DIDCtor(ctrl, $scope, attrs) {
            ...
            function defineAPI() {
                ...
                api.load = function (payload) {
                    ...
                    var notificationStatuses = UtilsService.getArrayEnum(VR_Notification_NotificationStatusEnum);
                    if (notificationStatuses != undefined) {
                        for (var i = 0; i < notificationStatuses.length; i++) {
                            ctrl.datasource.push(notificationStatuses[i]);
                        }
