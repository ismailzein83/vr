(function (appControllers) {
    ...
    VRNotificationLogController.$inject = ['$scope', 'VRCommon_MasterLogAPIService', 'UtilsService', 'VRNavigationService', 'VRUIUtilsService', 'VRNotificationService', 'VRValidationService', 'VR_Notification_VRNotificationTypeAPIService', 'VR_Notification_VRNotificationsAPIService'];

    function VRNotificationLogController($scope, VRCommon_MasterLogAPIService, UtilsService, VRNavigationService, VRUIUtilsService, VRNotificationService, VRValidationService, VR_Notification_VRNotificationTypeAPIService, VR_Notification_VRNotificationsAPIService) {
        ...
        function defineScope() {
            ...
            $scope.scopeModel.exportClicked = function () {

                if ($scope.scopeModel.from == undefined) {
                    VRNotificationService.showWarning("'From' Date is required for Export action!");
                    return;
                }

                var exportExcelInput = {
                    NotificationTypeId: notificationTypeId,
                    Query: buildBodyDirectiveQuery(),
                    ExtendedQuery: searchDirectiveAPI.getData()
                };

                return VR_Notification_VRNotificationsAPIService.ExportVRNotifications(exportExcelInput).then(function (response) {
