...
namespace Vanrise.AccountManager.Data.SQL
{
    ...
    {}
        ...
        {
            int recordsEffected = ExecuteNonQuerySP("[VR_AccountManager].[sp_AccountManagerAssignment_Update]",accountManagerAssignment.AccountManagerAssignementId, accountManagerAssignment.AccountManagerAssignementDefinitionId, accountManagerAssignment.AccountManagerId, accountManagerAssignment.AccountId,accountManagerAssignment.Settings, accountManagerAssignment.BED, accountManagerAssignment.EED);
        ...
        Vanrise.AccountManager.Entities.AccountManagerAssignment AccountManagerAssignmentMapper(IDataReader reader)
        {
            ...
            {
                AccountManagerAssignementId = (long)reader["ID"],
                AccountManagerAssignementDefinitionId = (Guid)reader["AssignmentDefinitionID"],
                AccountManagerId = (long)reader["AccountManagerID"],
