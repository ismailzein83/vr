...
app.directive("vrDataparserDigitStringPackageFieldParserSettings", ["UtilsService", "VRNotificationService", "VRUIUtilsService",
function (UtilsService, VRNotificationService, VRUIUtilsService) {
    ...
    var directiveDefinitionObject = {
        ...
        controller: function ($scope, $element, $attrs) {
            var ctrl = this;
            var ctor = new digitStringPackageFieldParserEditor($scope, ctrl);
        ...
        templateUrl: "/Client/Modules/VR_DataParser/Elements/ParserType/Directives/MainExtensions/Binary/templates/DigitStringPackageFieldParser.html"


    };

    function digitStringPackageFieldParserEditor($scope, ctrl) {
        ...
        function defineAPI() {
            ...
            api.getData = function () {
				return {
					$type: "Vanrise.DataParser.MainExtensions.BinaryParsers.NokiaSiemensParsers.FieldParsers.PackageFieldParser.DigitStringPackageFieldParser,Vanrise.DataParser.MainExtensions",
