...
app.directive("vrDataparserDirectLengthPackageFieldParserSettings", ["UtilsService", "VRNotificationService", "VRUIUtilsService",
function (UtilsService, VRNotificationService, VRUIUtilsService) {
    ...
    var directiveDefinitionObject = {
        ...
        controller: function ($scope, $element, $attrs) {
            var ctrl = this;
            var ctor = new directLengthPackageFieldParserEditor($scope, ctrl);
        ...
        templateUrl: "/Client/Modules/VR_DataParser/Elements/ParserType/Directives/MainExtensions/Binary/templates/DirectLengthPackageFieldParser.html"


    };

    function directLengthPackageFieldParserEditor($scope, ctrl) {
        ...
        function defineAPI() {
            ...
            api.getData = function () {
				return {
					$type: "Vanrise.DataParser.MainExtensions.BinaryParsers.NokiaSiemensParsers.FieldParsers.PackageFieldParser.DirectLengthPackageFieldParser,Vanrise.DataParser.MainExtensions",
