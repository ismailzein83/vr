(function (app) {
    ...
    CompositeFieldsParserDirective.$inject = ['UtilsService', 'VRUIUtilsService', 'VR_DataParser_ParserTypeConfigsAPIService'];

    function CompositeFieldsParserDirective(UtilsService, VRUIUtilsService, VR_DataParser_ParserTypeConfigsAPIService) {
        return {
            restrict: "E",
            scope: {
                onReady: "=",
        ...
        function TagValueParserSelector($scope, ctrl, $attrs) {
            ...
            function defineAPI() {
                ...
                api.load = function (payload) {
                    ...
                    if (payload != undefined && payload.RecordParser != undefined) {
                    ...
                    function getTagValueParserConfigs() {
                        ...
                        return VR_DataParser_ParserTypeConfigsAPIService.GetCompositeFieldsReaderTemplateConfigs().then(function (response) {
                            if (response != null) {
    ...
    app.directive('vrDataparserCompositeFieldsParser', CompositeFieldsParserDirective);
