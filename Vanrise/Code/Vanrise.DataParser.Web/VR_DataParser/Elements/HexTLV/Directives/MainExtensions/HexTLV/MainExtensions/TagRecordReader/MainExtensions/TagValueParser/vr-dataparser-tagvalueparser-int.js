...
function (UtilsService, VRNotificationService, VRUIUtilsService) {
    ...
    var directiveDefinitionObject = {
        ...
        controller: function ($scope, $element, $attrs) {
            var ctrl = this;
            var ctor = new intParserEditor($scope, ctrl);
    ...
    function intParserEditor($scope, ctrl) {
        ...
        function defineAPI() {
            ...
            api.getData = function () {
                return {
                    $type: "Vanrise.DataParser.MainExtensions.HexTLV.TagValueParsers.IntParser ,Vanrise.DataParser.MainExtensions",
