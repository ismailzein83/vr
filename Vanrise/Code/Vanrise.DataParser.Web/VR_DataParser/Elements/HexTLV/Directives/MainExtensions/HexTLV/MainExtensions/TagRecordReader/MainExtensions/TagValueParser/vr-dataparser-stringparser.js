(function (app) {
            ...
            function defineAPI() {
                ...
                api.load = function (payload) {
                    ...
                    function getTagValueParserConfigs() {
                        ...
                        return VR_DataParser_ParserTypeConfigsAPIService.GetBaseStringParserTemplateConfigs().then(function (response) {
                            if (response != null) {
    ...
    app.directive('vrDataparserStringparser', TagValueParserDirective);
