    ...
    var directiveDefinitionObject = {
        ...
        template: function (element, attrs) {
            if (attrs.permissions === undefined || SecurityService.isAllowed(attrs.permissions)) {
                ...
                if (label == undefined)
                    label = '';
                return '<vr-label ng-if="withLable">' + label + '</vr-label><div><span ng-model="value" ng-change="notifyUserChange()" ng-click="value=!value" class="hand-cursor" style="font-weight: bold; font-size: 16px;" ng-style="value==true? {\'color\':\'#64BD63\'} : {\'color\':\'#d2d2d2\'}" >✔</span>'
