...
app.directive('vrWarning', ['SecurityService', function (SecurityService) {
    ...
    var directiveDefinitionObject = {
        ...
        template: function (element, attrs) {
            return '<span ng-if="value!=undefined" ng-mouseenter="adjustTooltipPosition($event)" bs-tooltip class="glyphicon glyphicon-exclamation-sign hand-cursor" style="color:#f0ad4e;top:2px" html="true" placement="bottom" trigger="hover" data-type="info" data-title="{{value}}"></span>';
        }
