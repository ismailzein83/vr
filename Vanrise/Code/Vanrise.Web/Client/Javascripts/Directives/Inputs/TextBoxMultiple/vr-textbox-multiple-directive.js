        ...
        return {
                ...
                return {
                    pre: function ($scope, iElem, iAttrs) {
                        ...
                        ctrl.getLabelText = function () {
                            if (ctrl.value == 0) {
                                if (ctrl.placelHolder == undefined || ctrl.placelHolder == '')
                                    return "Select";
                                else return ctrl.placelHolder;
                            }
            ...
            template: function (element, attrs) {
                ...
                var textboxTemplate = '<div ng-mouseenter="showtd=true" ng-mouseleave="showtd=false">'
                    ...
                    + ' aria-expanded="true"  >'
                    + '<span class="vanrise-inpute"  style="float: left; margin: 0px;overflow: hidden;text-overflow: ellipsis;white-space: nowrap;display: inline-block;width:calc(100% - 11px ); " ng-class="ctrl.value.length == 0?\'vr-select-watermark\':\'\'" ng-style="!ctrl.isHideRemoveIcon() ? {\'width\':\'calc(100% - 11px)\'}:{\'width\':\'100%\'} " > {{ctrl.getLabelText()}} </span>'
