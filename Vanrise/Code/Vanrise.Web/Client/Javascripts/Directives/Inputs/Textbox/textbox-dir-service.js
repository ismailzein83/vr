...
app.service('TextBoxService', ['BaseDirService', function (BaseDirService) {
    ...
    return ({
        dTemplate: "/Client/Javascripts/Directives/Inputs/Textbox/vr-textbox-standard.html",
    ...
    function getTemplateByType(type) {
        return "/Client/Javascripts/Directives/Inputs/Textbox/vr-textbox-" + type + ".html";
    }
