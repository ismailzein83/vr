		...
		return {
			...
			template: function (element, attrs) {
				...
				if (attrs.height != undefined)
				    heightStyle = "height:" + parseInt(attrs.height) + "px";
				...
				var textboxTemplate = '<div ng-mouseenter="showtd=true" ng-mouseleave="showtd=false" >'
					...
					+ '<textarea id="{{ctrl.textAreaGuid}}"' + trimExp + ' tabindex="{{ctrl.tabindex}}" readonly="ctrl.readOnly"  placeholder="{{ctrl.placelHolder}}" ng-readonly="ctrl.readOnly" id="mainInput"  ng-model="ctrl.value" ng-change="ctrl.notifyUserChange()" rows="{{ctrl.rows}}"  class="form-control vanrise-inpute" style="width: 100%; resize: none;' + heightStyle + ';" ></textarea>'
					+ '</vr-validator>'
