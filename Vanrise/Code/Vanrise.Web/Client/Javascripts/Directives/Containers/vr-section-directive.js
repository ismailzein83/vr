    ...
    var directiveDefinitionObject = {
        ...
        compile: function (tElement, tAttrs) {
            ...
            var newElement = '<div class="panel-primary panel-vr ' + classlevel + '" >'
                            + '<div class="panel-heading" ng-init="' + expandname + '=true"><label><span style="padding-right: 3px;" class="hand-cursor glyphicon " ng-show="' + collapsible + '" ng-click="' + expandname + '=!' + expandname + '" ng-class="' + expandname + '?\'glyphicon-collapse-up\':\'glyphicon-collapse-down\'" ></span>' + tAttrs.title + '</label></div>'
