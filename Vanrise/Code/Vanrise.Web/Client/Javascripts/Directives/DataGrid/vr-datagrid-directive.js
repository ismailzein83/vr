    ...
    function (UtilsService, SecurityService, DataRetrievalResultTypeEnum, $compile, VRModalService, DataGridRetrieveDataEventType, UISettingsService, VRLocalizationService, MobileService, VRDataGridService) {
        ...
        function DataGrid(ctrl, scope, attrs, elem) {
                    ...
                    if (col.isHidden != true) {
                        ...
                        if (col.fixedWidth != undefined) {
                            ...
                            if (col.type == "Number") {
                                ...
                                if (col.numberPrecision == "NoDecimal") { colFixWidth = 65; }
                                else if (col.numberPrecision == "LongPrecision") { colFixWidth = 65; }
                                else {
                                    colFixWidth = 65;
                                }
                            }
                            else {
                                if (col.type == "LongDatetime") { colFixWidth = 120; }
                                else if (col.type == "Datetime") { colFixWidth = 100; }
            ...
            function defineAPI() {
                ...
                gridApi.showLoader = function () {
                    if (ctrl.openedDataItem) {
                        ...
                        ctrl.openedDataItem.isLoadingRowFullScreen = true;
                ...
                gridApi.hideLoader = function () {
                    if (ctrl.openedDataItem) {
                        ...
                        ctrl.openedDataItem.isLoadingRowFullScreen = false;
                ...
                gridApi.switchSingleItemFullScreenModeOn = function () {
                    if (ctrl.datasource.length == 0)
                        return;

                    var dataItem = ctrl.datasource[0];
                    ctrl.switchFullScreenModeOn(dataItem);
                };
            ...
            function defineExpandableRow() {
                ...
                function prepareDataItemExpandableItemObject(dataItem) {
                    dataItem.expandableRowTemplate = expandableRowTemplate;
                    ctrl.openedDataItem = dataItem;
