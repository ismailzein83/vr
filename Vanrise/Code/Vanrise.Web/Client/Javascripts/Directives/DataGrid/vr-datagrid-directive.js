            ...
            function getCellTemplateWithFilter(template, colDef) {
                if (colDef.type == "Number") {
                    ...
                    if (colDef.type == "LongDatetime")
                        template = UtilsService.replaceAll(template, "#CELLFILTER#", " | vrtimeNoTimeZone | date:'yyyy-MM-dd HH:mm:ss'");
                    else if (colDef.type == "Datetime")
                        template = UtilsService.replaceAll(template, "#CELLFILTER#", " | vrtimeNoTimeZone | date:'yyyy-MM-dd HH:mm'");
                    else if (colDef.type == "Date")
                        template = UtilsService.replaceAll(template, "#CELLFILTER#", " | vrtimeNoTimeZone | date:'yyyy-MM-dd'");
                    else
