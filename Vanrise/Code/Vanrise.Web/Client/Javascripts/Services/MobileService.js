(function (app) {
    ...
    function MobileService( UtilsService) {
        ...
        function isMobileOS() {
            ...
            var isAndroid = isGoogle && navigator.userAgent.indexOf('Android');  // Careful - Firefox and Windows Mobile also have Android in user agent
            var androidDesktopMode = isAndroid && isGoogle && navigator.userAgent.indexOf('Linux') > -1;
            ...
            return check || androidDesktopMode;
        }
    ...
    app.service('MobileService', MobileService);
