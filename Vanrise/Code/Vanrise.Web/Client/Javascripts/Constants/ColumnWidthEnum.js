app.constant('ColumnWidthEnum', {
    ...
    OneThirdRow: { name: "OneThirdRow", value: 3, description: "One Third Row", numberOfColumns: 4 },
    TwoThirdRow: { name: "TwoThirdRow", value: 4, description: "Two Third Row", numberOfColumns: 8 }
});
