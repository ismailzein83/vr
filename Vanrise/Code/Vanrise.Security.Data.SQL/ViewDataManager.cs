    ...
    public class ViewDataManager : BaseSQLDataManager, IViewDataManager
    {
        ...
        public bool AddView(View view)
        {
            ...
            int recordesEffected = ExecuteNonQuerySP("sec.sp_View_Insert", view.ViewId, view.Name, view.Title, view.Url, view.ModuleId,
               serialziedAudience, serialziedContent, serializedSettings, view.Type, view.DevProjectId);
        ...
        public bool UpdateView(View view)
        {
            ...
            int recordesEffected = ExecuteNonQuerySP("sec.sp_View_Update", view.ViewId, view.Name, view.Title, view.Url, view.ModuleId,
                serialziedContent, serializedSettings, view.Type, view.DevProjectId);
            return (recordesEffected > 0);
        }
        ...
        public bool UpdateViewAudiences(Guid viewId, AudienceWrapper audience)
        {
            ...
            if (audience != null)
            {
                if ((audience.Groups != null && audience.Groups.Count > 0) || (audience.Users != null && audience.Users.Count > 0))
                    serialziedAudience = Common.Serializer.Serialize(audience, true);
            }
            int recordesEffected = ExecuteNonQuerySP("sec.sp_View_UpdateAudiences", viewId, serialziedAudience);
            return (recordesEffected > 0);
        }
