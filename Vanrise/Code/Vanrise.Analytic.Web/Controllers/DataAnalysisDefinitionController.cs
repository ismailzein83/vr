...
{
    [RoutePrefix(Constants.ROUTE_PREFIX + "DataAnalysisDefinition")]
    [JSONWithTypeAttribute]
    public class DataAnalysisDefinitionController : BaseAPIController
    {
        DataAnalysisDefinitionManager _manager = new DataAnalysisDefinitionManager();
