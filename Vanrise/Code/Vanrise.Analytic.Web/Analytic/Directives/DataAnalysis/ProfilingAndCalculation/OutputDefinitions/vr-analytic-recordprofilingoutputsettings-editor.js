...
app.directive('vrAnalyticRecordprofilingoutputsettingsEditor', ['UtilsService', 'VRUIUtilsService',
    function (UtilsService, VRUIUtilsService) {
        ...
        function RecordProfilingOutputSettingsEditor($scope, ctrl, $attrs) {
            ...
            var parametersDirectiveAPI;
            var parametersDirectiveReadyDeferred = UtilsService.createPromiseDeferred();
            ...
            function initializeController() {
                ...
                parametersDirectiveReadyDeferred.promise];
                ...
                $scope.scopeModel.onParametersDirectiveReady = function (api) {
                    parametersDirectiveAPI = api;
                    parametersDirectiveReadyDeferred.resolve();
                };
            ...
            function defineAPI() {
                ...
                api.load = function (payload) {
                    ...
                    if (payload != undefined) {
                        ...
                        if (payload.dataAnalysisItemDefinitionSettings != undefined) {
                            ...
                            daProfCalcParameters = payload.dataAnalysisItemDefinitionSettings.DAProfCalcParameters;
                        }
                    }
                    ...
                    //Loading Parameters Directive
                    var parametersDirectiveLoadPromise = getParametersDirectiveLoadPromise();
                    promises.push(parametersDirectiveLoadPromise);
                    ...
                    function getParametersDirectiveLoadPromise() {
                        var parametersDirectiveLoadDeferred = UtilsService.createPromiseDeferred();

                        parametersDirectiveReadyDeferred.promise.then(function () {
                            var parametersPayload = {
                                daProfCalcParameters: daProfCalcParameters
                            };

                            VRUIUtilsService.callDirectiveLoad(parametersDirectiveAPI, parametersPayload, parametersDirectiveLoadDeferred);
                        });

                        return parametersDirectiveLoadDeferred.promise;
                    }
                ...
                api.getData = function () {
                    var data = {
                        ...
                        DAProfCalcParameters: parametersDirectiveAPI != undefined ? parametersDirectiveAPI.getData() : undefined
                    };
