...
app.directive("vrAnalyticQuerydefinitionAutomatedreport", ["UtilsService", "VR_Analytic_AutomatedReportQueryDefinitionSettingsAPIService", "VRUIUtilsService",
function (UtilsService, VR_Analytic_AutomatedReportQueryDefinitionSettingsAPIService, VRUIUtilsService) {
    return {
        restrict: 'E',
        scope: {
            onReady: '=',
        ...
        function defineAPI() {
            ...
            api.load = function (payload) {
                ...
                function GetAutomatedReportTemplateConfigs() {
                    ...
                    return VR_Analytic_AutomatedReportQueryDefinitionSettingsAPIService.GetAutomatedReportTemplateConfigs().then(function (response) {
