(function (app) {
    ...
    RealTimeAnalyticReportDirective.$inject = ["UtilsService", 'VRUIUtilsService', 'Analytic_AnalyticService'];

    function RealTimeAnalyticReportDirective(UtilsService, VRUIUtilsService, Analytic_AnalyticService) {
        return {
            restrict: "E",
            scope: {
                onReady: "=",
            ...
            templateUrl: "/Client/Modules/Analytic/Directives/Definition/AnalyticReport/RealTime/Templates/RealTimeAnalyticReportTemplates.html"
        ...
        function RealTimeAnalyticReport($scope, ctrl, $attrs) {
            ...
            function initializeController() {
                ...
                $scope.scopeModel.addWidget = function () {
                    ...
                    Analytic_AnalyticService.addRealTimeWidget(onWidgetAdd, tableSelectorAPI.getSelectedIds());
                };
            ...
            function defineAPI() {
                ...
                function getData() {
                    ...
                    var settings = {
                        $type: "Vanrise.Analytic.Entities.RealTimeReportSettings, Vanrise.Analytic.Entities",
            ...
            function editWidget(dataItem) {
                ...
                Analytic_AnalyticService.editRealTimeWidget(dataItem.widgetSettings, onWidgetUpdated, tableSelectorAPI.getSelectedIds());
    ...
    app.directive('vrAnalyticAnalyticreportRealtimeDefinition', RealTimeAnalyticReportDirective);
})(app);