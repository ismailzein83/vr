...
app.directive('vrAnalyticOrdertypeSelective', ['VR_Analytic_OrderTypeEnum', 'UtilsService', 'VRUIUtilsService', function (VR_Analytic_OrderTypeEnum, UtilsService, VRUIUtilsService) {
    ...
    function OrderTypeSelector(ctrl, $scope, attrs) {
        ...
        function defineAPI() {
            ...
            api.load = function (payload) {
                ...
                var orderTypeEntity;
                var promises = [];
                $scope.scopeModel.datasource = UtilsService.getArrayEnum(VR_Analytic_OrderTypeEnum);
                ...
                function loadDirective() {
                    ...
                    directiveReadyDeferred.promise.then(function () {
                        ...
                        var directivePayload = { advancedOrderOptions: orderTypeEntity.AdvancedOrderOptions, tableIds: tableIds };
