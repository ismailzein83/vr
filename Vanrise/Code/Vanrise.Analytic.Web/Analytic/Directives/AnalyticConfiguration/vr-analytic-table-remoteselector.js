(function (app) {
    ...
    function AnalyticTableSelectorDirective(VR_Analytic_AnalyticTableAPIService, UtilsService, VRUIUtilsService) {
        return {
            ...
            controller: function ($scope, $element, $attrs) {
                ...
                var analyticTableRemoteSelector = new AnalyticTableRemoteSelector(ctrl, $scope, $attrs);
                analyticTableRemoteSelector.initializeController();
            },
            controllerAs: 'ctrl',
        ...
        function AnalyticTableRemoteSelector(ctrl, $scope, attrs) {
            ...
            function getDirectiveAPI() {
                ...
                api.load = function (payload) {
                    ...
                    return VR_Analytic_AnalyticTableAPIService.GetRemoteAnalyticTablesInfo(connectionId,UtilsService.serializetoJson(filter)).then(function (response) {
                        if (response) {
    ...
    app.directive('vrAnalyticTableRemoteselector', AnalyticTableSelectorDirective);
