"use strict";
app.directive("vrAnalyticDimensionmappingrulesGrid", ["UtilsService", "VRNotificationService", "VR_Analytic_DimensionMappingRulesService",
    function (UtilsService, VRNotificationService, VR_Analytic_DimensionMappingRulesService) {
        var directiveDefinitionObject = {
            ...
            templateUrl: "/Client/Modules/Analytic/Directives/MainExtensions/MeasureExternalSource/AnalyticMeasureExternalSource/Templates/AnalyticDimensionMappingRulesGridTemplate.html"
        };
        function RulesGrid($scope, ctrl, $attrs) {
            ...
            function initializeController() {
                ...
                ctrl.addRule = function () {
                    ...
                    VR_Analytic_DimensionMappingRulesService.addRule(onRuleAdded, { context: getContext(), tableId: tableId });
                };
