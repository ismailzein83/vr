(function (app) {
    ...
    function GenericBEDefinitionService(VRModalService, VRNotificationService, UtilsService, VRUIUtilsService) {
        ...
        var tabModalPath = "/Client/Modules/VR_GenericData/Directives/BusinessEntityDefinition/MainExtensions/GenericEditorDefinitionSetting/TabsContainer/Templates/GenericBETabContainerEditorController.html";
        var sectionModalPath = "/Client/Modules/VR_GenericData/Directives/BusinessEntityDefinition/MainExtensions/GenericEditorDefinitionSetting/SectionContainer/Templates/GenericBESectionContainerEditorController.html";
        var rowContainerModalPath = "/Client/Modules/VR_GenericData/Directives/BusinessEntityDefinition/MainExtensions/GenericEditorDefinitionSetting/RowsContainer/Templates/GenericBERowContainerEditor.html";
        //var BEFieldModalPath = "/Client/Modules/VR_GenericData/Directives/BusinessEntityDefinition/MainExtensions/GenericEditorDefinitionSetting/GenericFields/Templates/GenericBEGenericFieldEditor.html";
        ...
        return ({
            ...
            openGenericBEConditionalRuleContainerSettings: openGenericBEConditionalRuleContainerSettings,
            openGenericBESectionContainerEditor: openGenericBESectionContainerEditor,
        ...
        function openFieldTypeGenericEditorDesignModal(onFiledTypeSettingsChanged, fieldTypeEntity, context) {
            var parameters = {
            ...
            var settings = {};
            settings.onScopeReady = function (modalScope) {
                modalScope.onFiledTypeSettingsChanged = onFiledTypeSettingsChanged;
            };
        ...
        function openGenericBEConditionalRuleContainerSettings(onCRCSettingsChanged, crcEntityObject, context) {
            var parameters = {
                crcEntityObject: crcEntityObject,
                context: context
            };

            var settings = {};
            settings.onScopeReady = function (modalScope) {
                modalScope.onCRCSettingsChanged = onCRCSettingsChanged;
            };

            VRModalService.showModal("/Client/Modules/VR_GenericData/Directives/GenericBusinessEntity/Definition/Editor/Templates/CRCGenericDesignEditor.html", parameters, settings);
        }
        
        function openGenericBESectionContainerEditor(onSectionSettingsChanged, sectionEntityObject, context) {
            var parameters = {
                sectionEntityObject: sectionEntityObject,
                context: context
            };

            var settings = {};
            settings.onScopeReady = function (modalScope) {
                modalScope.onSectionSettingsChanged = onSectionSettingsChanged;
            };

            VRModalService.showModal("/Client/Modules/VR_GenericData/Directives/GenericBusinessEntity/Definition/Editor/Templates/SectionContainerGenericDesignEditor.html", parameters, settings);
        }
