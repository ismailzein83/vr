...
//					$scope.scopeModel.addedBusinessEntities = response.CountOfBEAdded;
//					$scope.scopeModel.existsBusinessEntities = response.CountOfBEExist;
...
//				return VR_GenericData_GenericBusinessEntityAPIService.DownloadGenericBusinessEntity(businessEntityDefinitionId).then(function (response) {
