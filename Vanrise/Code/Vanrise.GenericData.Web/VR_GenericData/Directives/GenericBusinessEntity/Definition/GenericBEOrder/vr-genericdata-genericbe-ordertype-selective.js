...
app.directive('vrGenericdataGenericbeOrdertypeSelective', ['VR_GenericData_OrderTypeEnum', 'UtilsService', 'VRUIUtilsService', function (VR_GenericData_OrderTypeEnum, UtilsService, VRUIUtilsService) {
    ...
    function OrderTypeSelector(ctrl, $scope, attrs) {
        ...
        function defineAPI() {
            ...
            api.load = function (payload) {
                ...
                $scope.scopeModel.datasource = UtilsService.getArrayEnum(VR_GenericData_OrderTypeEnum);
                ...
                function loadDirective() {
                    ...
                    directiveReadyDeferred.promise.then(function () {
                        ...
                        var directivePayload = { advancedOrderOptions: orderTypeEntity.advancedOrderOptions, context: context };
            ...
            api.getData = function () {
                return {
                    OrderType: $scope.scopeModel.selectedValue != undefined? $scope.scopeModel.selectedValue.value : undefined,
                    AdvancedOrderOptions: directiveAPI != undefined ? directiveAPI.getData() : undefined
                };
            };
