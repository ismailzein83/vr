(function (app) {
    ...
    function GenricdataBeSerialnumberEditor(VR_GenericData_GenericBESerialNumberService, VR_GenericData_GenericBESerialNumberAPIService, UtilsService, VRUIUtilsService) {
        return {
            ...
            templateUrl: "/Client/Modules/VR_GenericData/Directives/GenericBusinessEntity/Runtime/MainExtensions/OnBeforeInsertHandler/GenericBESN/Templates/SNEditorTemplate.html"
        };
