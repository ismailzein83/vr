(function (app) {
    ...
    dataRecordStorageEditor.$inject = ['UtilsService', 'VRUIUtilsService', 'VR_GenericData_DataRecordFieldAPIService', 'VR_GenericData_DataStoreAPIService','VR_GenericData_DataRecordStorageAPIService'];

    function dataRecordStorageEditor(UtilsService, VRUIUtilsService, VR_GenericData_DataRecordFieldAPIService, VR_GenericData_DataStoreAPIService, VR_GenericData_DataRecordStorageAPIService) {
        ...
        var directiveDefinitionObject = {
            ...
            controller: function ($scope, $element, $attrs) {
                var ctrl = this;
                var dataRecordStorageEditorDirective = new DataRecordStorageEditorDirective(ctrl, $scope, $attrs);
                dataRecordStorageEditorDirective.initializeController();
            },
            controllerAs: 'ctrl',
            ...
            templateUrl: '/Client/Modules/VR_GenericData/Directives/DataRecordStorage/Templates/DataRecordStorageEditorTemplate.html'
        };

        function DataRecordStorageEditorDirective(ctrl, $scope, attrs) {
            ...
            function initializeController() {
                ...
                $scope.scopeModel = {};
                $scope.scopeModel.hideName = false;
    ...
    app.directive('vrGenericdataDatarecordstorageEditor', dataRecordStorageEditor);
