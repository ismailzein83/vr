...
app.directive('vrGenericdataDatarecordstorageRemoteselector', ['UtilsService', 'VRUIUtilsService', 'VR_GenericData_DataRecordStorageAPIService',
    function (UtilsService, VRUIUtilsService, VR_GenericData_DataRecordStorageAPIService) {
        return {
            ...
            controller: function ($scope, $element, $attrs) {
                ...
                var ctor = new DataRecordStorageRemoteSelectorCtor(ctrl, $scope, $attrs);
        ...
        function DataRecordStorageRemoteSelectorCtor(ctrl, $scope, attrs) {
            ...
            function defineAPI() {
                ...
                api.load = function (payload) {
                    ...
                    return VR_GenericData_DataRecordStorageAPIService.GetRemoteDataRecordsStorageInfo(connectionId, UtilsService.serializetoJson(filter)).then(function (response) {
                        if (response != null) {
