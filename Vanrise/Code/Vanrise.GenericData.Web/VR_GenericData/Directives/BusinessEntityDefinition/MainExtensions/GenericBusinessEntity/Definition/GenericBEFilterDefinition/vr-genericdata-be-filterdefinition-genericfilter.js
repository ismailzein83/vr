(function (app) {
    ...
    function FilterDefinitionGenericFilterDirective(UtilsService, VRNotificationService, VRUIUtilsService) {
        return {
            ...
            templateUrl: '/Client/Modules/VR_GenericData/Directives/BusinessEntityDefinition/MainExtensions/GenericBusinessEntity/Definition/GenericBEFilterDefinition/Templates/GenericFilterDefinitionTemplate.html'
        };
