(function (appControllers) {
    ...
    SerialNumberPatternHelperEditorController.$inject = ['$scope', 'VRNavigationService', 'UtilsService', 'VRNotificationService'];

    function SerialNumberPatternHelperEditorController($scope, VRNavigationService, UtilsService, VRNotificationService) {
            ...
            function loadAllControls() {
                ...
                function loadStaticData() {
                    if (context != undefined) {
                        $scope.scopeModel.dataSource = context.getSerialNumberParts();
                    }
                }
    ...
    appControllers.controller('VR_GenericData_SerialNumberPatternHelperEditorController', SerialNumberPatternHelperEditorController);
