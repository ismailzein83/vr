(function (app) {
    ...
    function GenericBEStaticFilterDirective(UtilsService, VRNotificationService) {
        return {
            ...
            templateUrl: '/Client/Modules/VR_GenericData/Directives/BusinessEntityDefinition/MainExtensions/GenericBusinessEntity/Definition/GenericBEFilterDefinition/Templates/StaticFilterDefiitionTemplate.html'
        };
