(function (app) {
    ...
    function FilterDefinitionFilterGroupDirective(UtilsService, VRNotificationService, VRUIUtilsService) {
        return {
            ...
            templateUrl: '/Client/Modules/VR_GenericData/Directives/BusinessEntityDefinition/MainExtensions/GenericBusinessEntity/Definition/GenericBEFilterDefinition/Templates/FilterGroupFilterDefinitionTemplate.html'
        };
