(function (app) {
    ...
    function ListEditorDefinition(UtilsService, VRUIUtilsService, VRNotificationService) {
        return {
            ...
            templateUrl:"/Client/Modules/VR_GenericData/Directives/BusinessEntityDefinition/MainExtensions/GenericEditorDefinitionSetting/ListEditor/Templates/ListEditorDefinitionSettingTemplate.html"
        };
