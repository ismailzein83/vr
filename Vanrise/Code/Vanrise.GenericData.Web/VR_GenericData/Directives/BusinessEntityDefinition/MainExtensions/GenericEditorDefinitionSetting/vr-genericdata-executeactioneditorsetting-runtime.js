(function (app) {
    ...
    ExecuteActionEditorRuntimeDirective.$inject = ['UtilsService', 'BaseAPIService'];

    function ExecuteActionEditorRuntimeDirective(UtilsService, BaseAPIService, VRButtonTypeEnum) {
        return {
            restrict: 'E',
            scope: {
                onReady: '='
            ...
            templateUrl: '/Client/Modules/VR_GenericData/Directives/BusinessEntityDefinition/MainExtensions/GenericEditorDefinitionSetting/Templates/ExecuteActionEditorRuntimeSettingTemplate.html'
        };
