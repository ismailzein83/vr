...
app.directive("vrGenericdataSectionscontainereditorRuntime", ["UtilsService", "VRUIUtilsService",
    function (UtilsService, VRUIUtilsService) {
        ...
        var directiveDefinitionObject = {
            ...
            templateUrl: "/Client/Modules/VR_GenericData/Directives/BusinessEntityDefinition/MainExtensions/GenericEditorDefinitionSetting/SectionContainer/Templates/SectionsContainerRuntimeSettingTemplate.html"
        };
            ...
            function defineAPI() {
                ...
                api.load = function (payload) {
                    ...
                    if (definitionSettings != undefined) {
                        if (definitionSettings.SectionContainers != undefined) {
                            for (var i = 0; i < definitionSettings.SectionContainers.length; i++) {
                                var sectionContainer = definitionSettings.SectionContainers[i];
