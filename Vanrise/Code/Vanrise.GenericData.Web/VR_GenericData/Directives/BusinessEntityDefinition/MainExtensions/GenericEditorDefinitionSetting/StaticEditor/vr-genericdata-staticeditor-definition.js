(function (app) {
    ...
    function HistoryGenericBEDefinitionViewDirective(UtilsService, VRNotificationService) {
        return {
            ...
            templateUrl: '/Client/Modules/VR_GenericData/Directives/BusinessEntityDefinition/MainExtensions/GenericEditorDefinitionSetting/StaticEditor/Templates/GenericBEStaticEditorDefiitionTemplate.html'
        };
