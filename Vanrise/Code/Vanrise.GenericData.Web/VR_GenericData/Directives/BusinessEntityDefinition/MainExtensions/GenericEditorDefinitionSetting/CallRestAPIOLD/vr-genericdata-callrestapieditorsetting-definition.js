(function (app) {
    ...
    function CallRestAPIEditorDefinitionDirective(UtilsService, VRUIUtilsService, VR_GenericData_CallRestAPIHTTPMethodEnum) {
        return {
            ...
            templateUrl: '/Client/Modules/VR_GenericData/Directives/BusinessEntityDefinition/MainExtensions/GenericEditorDefinitionSetting/CallRestAPIOLD/Templates/CallRestAPIEditorDefinitionSettingTemplate.html'
        };
