(function (app) {
    ...
    function NumberRangeGenericBEDefinitionViewDirective(UtilsService, VRNotificationService) {
        return {
            ...
            templateUrl: '/Client/Modules/VR_GenericData/Directives/BusinessEntityDefinition/MainExtensions/GenericEditorDefinitionSetting/NumberRange/Templates/GenericBENumberRangeEditorDefinitionTemplate.html'
        };
