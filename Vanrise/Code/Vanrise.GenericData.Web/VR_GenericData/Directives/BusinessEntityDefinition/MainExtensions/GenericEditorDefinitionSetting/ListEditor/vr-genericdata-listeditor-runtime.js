(function (app) {
    ...
    function listEditorRuntime(UtilsService, VRUIUtilsService, VRNotificationService) {
        return {
            ...
            templateUrl: "/Client/Modules/VR_GenericData/Directives/BusinessEntityDefinition/MainExtensions/GenericEditorDefinitionSetting/ListEditor/Templates/ListEditorRuntimeSettingTemplate.html"
        };
