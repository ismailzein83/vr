(function (app) {
    ...
    function CallRestAPIEditorRuntimeDirective(UtilsService, BaseAPIService, VRButtonTypeEnum, VR_GenericData_CallRestAPIHTTPMethodEnum) {
        return {
            ...
            templateUrl: '/Client/Modules/VR_GenericData/Directives/BusinessEntityDefinition/MainExtensions/GenericEditorDefinitionSetting/Templates/CallRestAPIEditorRuntimeSettingTemplate.html'
        };
