(function (app) {
    ...
    function CallRestAPIEditorRuntimeDirective(UtilsService, BaseAPIService, VRButtonTypeEnum, VR_GenericData_CallRestAPIHTTPMethodEnum) {
        return {
            ...
            templateUrl: '/Client/Modules/VR_GenericData/Directives/BusinessEntityDefinition/MainExtensions/GenericEditorExecuteActionSetting/CallRestAPI/Templates/CallRestAPIExecuteActionRuntimeTemplate.html'
        };
    ...
    app.directive('vrGenericdataExecuteactioneditorsettingActionruntimeCallrestapiaction', CallRestAPIEditorRuntimeDirective);
