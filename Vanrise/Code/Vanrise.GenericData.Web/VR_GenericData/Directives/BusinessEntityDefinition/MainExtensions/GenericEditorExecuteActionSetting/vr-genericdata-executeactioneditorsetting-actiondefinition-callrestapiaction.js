(function (app) {
    ...
    function CallRestAPIActionDefinitionDirective(UtilsService, VRUIUtilsService, VR_GenericData_CallRestAPIHTTPMethodEnum) {
        return {
            ...
            templateUrl: '/Client/Modules/VR_GenericData/Directives/BusinessEntityDefinition/MainExtensions/GenericEditorExecuteActionSetting/Templates/CallRestAPIExecuteActionDefinitionTemplate.html'
        };
