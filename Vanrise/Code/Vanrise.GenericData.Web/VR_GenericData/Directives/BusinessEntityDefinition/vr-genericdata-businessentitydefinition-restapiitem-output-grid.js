...
app.directive('vrGenericdataBusinessentitydefinitionRestapiitemOutputGrid', ['UtilsService',
    function (UtilsService) {
        ...
        var directiveDefinitionObject = {
            ...
            controller: function ($scope, $element, $attrs) {
                var ctrl = this;
                var ctor = new RestAPIOutputItemGridCtor(ctrl, $scope);
                ctor.initializeController();
            },
            controllerAs: 'ctrl',
            bindToController: true,
            templateUrl: function (element, attrs) {
                return '/Client/Modules/VR_GenericData/Directives/BusinessEntityDefinition/Templates/BERestAPIOutputItemGridTemplate.html';
            }
        };

        function RestAPIOutputItemGridCtor(ctrl, $scope) {
