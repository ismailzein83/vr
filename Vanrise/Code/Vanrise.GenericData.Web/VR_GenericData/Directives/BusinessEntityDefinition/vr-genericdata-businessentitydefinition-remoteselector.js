...
app.directive('vrGenericdataBusinessentitydefinitionRemoteselector', ['UtilsService', 'VRUIUtilsService', 'VR_GenericData_BusinessEntityDefinitionAPIService',
    function (UtilsService, VRUIUtilsService, VR_GenericData_BusinessEntityDefinitionAPIService) {
        return {
            ...
            controller: function ($scope, $element, $attrs) {
                ...
                var ctor = new BEDefinitionSelectorCtor(ctrl, $scope, $attrs);
        ...
        function BEDefinitionSelectorCtor(ctrl, $scope, attrs) {
            ...
            function defineAPI() {
                ...
                api.load = function (payload) {
                    ...
                    return VR_GenericData_BusinessEntityDefinitionAPIService.GetRemoteBusinessEntityDefinitionsInfo(connectionId, UtilsService.serializetoJson(filter)).then(function (response) {
                        if (response != null) {
        ...
        function getTemplate(attrs) {
            ...
            var label = "Remote BE Definition";

            if (attrs.ismultipleselection != undefined) {
                label = "Remote BE Definitions";
