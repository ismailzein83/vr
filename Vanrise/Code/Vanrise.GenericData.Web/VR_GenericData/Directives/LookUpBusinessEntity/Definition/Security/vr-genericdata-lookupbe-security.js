(function (app) {
    ...
    GenericDataLookUpBESecurityController.$inject = ['UtilsService', 'VRNotificationService', 'VRUIUtilsService'];

    function GenericDataLookUpBESecurityController(UtilsService, VRNotificationService, VRUIUtilsService) {
        return {
            restrict: 'E',
            scope: {
                onReady: '='
            ...
            controller: function ($scope, $element, $attrs) {
                var ctrl = this;
                var ctor = new GenericDataLookUpBESecurity($scope, ctrl);
                ctor.initializeController();
            },
            controllerAs: 'ctrl',
            bindToController: true,
            templateUrl: '/Client/Modules/VR_GenericData/Directives/LookUpBusinessEntity/Definition/Security/Templates/LookUpBESecurityTemplate.html'
        };

        function GenericDataLookUpBESecurity($scope, ctrl) {
    ...
    app.directive('vrGenericdataLookupbeSecurity', GenericDataLookUpBESecurityController);
