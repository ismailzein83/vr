...
app.directive('vrGenericdataFieldtypeTextRuntimeeditor', ['UtilsService', 'VR_GenericData_FieldTextTextTypeEnum',
    function (UtilsService, VR_GenericData_FieldTextTextTypeEnum) {
        ...
        function textCtor(ctrl, $scope, $attrs) {
            ...
            function defineScopeForSingleMode() {
                ...
                $scope.scopeModel.onValueChanged = function (value) {
                    if (!triggerSearch)
                        return;

                    if ($scope.scopeModel.value == undefined || $scope.scopeModel.value.length < 2)
                        return;

                    if (searchManagementFunc == null || typeof (searchManagementFunc) != "function")
                        return;

                    searchManagementFunc();
                };
            }
            ...
            function setFieldValue(ctrl, fieldValue) {
                if (ctrl.selectionmode == "dynamic") {
