'use strict';
app.directive('vrGenericdataFieldtypeBusinessentityViewereditor', ['UtilsService',
    ...
    return {
        ...
        controller: function ($scope, $element, $attrs) {
            ...
            var ctor = new businessentityTypeViewerEditorCtor(ctrl, $scope);
    ...
    function businessentityTypeViewerEditorCtor(ctrl, $scope) {
