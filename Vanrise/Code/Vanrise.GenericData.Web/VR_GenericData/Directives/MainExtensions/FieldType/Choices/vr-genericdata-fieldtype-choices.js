        ...
        function choicesTypeCtor(ctrl, $scope) {
            ...
            function defineAPI() {
                ...
                api.load = function (payload) {
                    ...
                    var loadDataRecordFieldChoiceSelectorPromise = loadDataRecordFieldChoiceSelector();
                    promises.push(loadDataRecordFieldChoiceSelectorPromise);
                ...
                api.getData = function () {
                    var data = {
                        ...
                        Choices: choicesGridAPI != undefined ? choicesGridAPI.getData() : undefined,
