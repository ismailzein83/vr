'use strict';
app.directive('vrGenericdataFieldtypeAttachment', ['UtilsService',
        ...
        function attachmentTypeCtor(ctrl, $scope) {
            ...
            function defineAPI() {
                ...
                api.getData = function () {
                    return {
                        $type: "Vanrise.GenericData.MainExtensions.DataRecordFields.FieldAttachmentType,Vanrise.GenericData.MainExtensions",
