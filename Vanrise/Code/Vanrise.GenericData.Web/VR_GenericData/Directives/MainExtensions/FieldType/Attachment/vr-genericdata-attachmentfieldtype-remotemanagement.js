...
app.directive("vrGenericdataAttachmentfieldtypeRemotemanagement", ["UtilsService", "VRNotificationService", "VRUIUtilsService",
function (UtilsService, VRNotificationService, VRUIUtilsService) {
    ...
    var directiveDefinitionObject = {
        ...
        controller: function ($scope, $element, $attrs) {
            var ctrl = this;
            var attachmentfieldtype = new RemoteAttachmentFieldType($scope, ctrl, $attrs);
        ...
        templateUrl: '/Client/Modules/VR_GenericData/Directives/MainExtensions/FieldType/Attachment/Templates/AttachmentFieldTypeEntityRemoteManagementTemplate.html'
    };

    function RemoteAttachmentFieldType($scope, ctrl, $attrs) {
        ...
        function getAttachementFieldTypeData() {
            ...
            if ($scope.scopeModel.attachementFieldTypes != undefined && $scope.scopeModel.attachementFieldTypes.length > 0) {
