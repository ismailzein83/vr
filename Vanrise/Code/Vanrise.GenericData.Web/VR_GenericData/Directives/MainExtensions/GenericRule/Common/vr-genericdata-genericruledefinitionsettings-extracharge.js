(function (app) {
        ...
        function RuleDefinitionSettings($scope, ctrl, $attrs) {
            ...
            function getDirectiveAPI() {
                ...
                api.getData = function () {
                    return {
                        $type: 'Vanrise.GenericData.Pricing.ExtraChargeRuleDefinitionSettings, Vanrise.GenericData.Pricing',
                    };
                };
    ...
    app.directive('vrGenericdataGenericruledefinitionsettingsExtracharge', RuleDefinitionSettingsDirective);
