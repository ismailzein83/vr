(function (app) {
        ...
        function RuleDefinitionSettings($scope, ctrl, $attrs) {
            ...
            function getDirectiveAPI() {
                ...
                api.getData = function () {
                    return {
                        $type: 'Vanrise.GenericData.Pricing.RateTypeRuleDefinitionSettings, Vanrise.GenericData.Pricing',
                    };
                };
    ...
    app.directive('vrGenericdataGenericruledefinitionsettingsRatetype', RuleDefinitionSettingsDirective);
