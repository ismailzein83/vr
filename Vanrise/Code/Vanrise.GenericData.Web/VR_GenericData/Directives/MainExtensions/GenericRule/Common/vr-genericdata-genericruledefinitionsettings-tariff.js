(function (app) {
        ...
        function RuleDefinitionSettings($scope, ctrl, $attrs) {
            ...
            function getDirectiveAPI() {
                ...
                api.getData = function () {
                    return {
                        $type: 'Vanrise.GenericData.Pricing.TariffRuleDefinitionSettings, Vanrise.GenericData.Pricing',
                    };
                };
    ...
    app.directive('vrGenericdataGenericruledefinitionsettingsTariff', RuleDefinitionSettingsDirective);
