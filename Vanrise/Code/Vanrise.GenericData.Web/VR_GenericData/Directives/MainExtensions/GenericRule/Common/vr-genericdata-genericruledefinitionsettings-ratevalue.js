(function (app) {
        ...
        function RuleDefinitionSettings($scope, ctrl, $attrs) {
            ...
            function getDirectiveAPI() {
                ...
                api.getData = function () {
                    return {
                        $type: 'Vanrise.GenericData.Pricing.RateValueRuleDefinitionSettings, Vanrise.GenericData.Pricing',
                    };
                };
    ...
    app.directive('vrGenericdataGenericruledefinitionsettingsRatevalue', RuleDefinitionSettingsDirective);
