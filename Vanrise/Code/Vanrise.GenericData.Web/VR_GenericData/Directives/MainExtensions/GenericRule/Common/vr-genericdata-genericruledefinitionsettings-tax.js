(function (app) {
        ...
        function RuleDefinitionSettings($scope, ctrl, $attrs) {
            ...
            function getDirectiveAPI() {
                ...
                api.getData = function () {
                    return {
                        $type: 'Vanrise.GenericData.Pricing.TaxRuleDefinitionSettings, Vanrise.GenericData.Pricing',
                    };
                };
    ...
    app.directive('vrGenericdataGenericruledefinitionsettingsTax', RuleDefinitionSettingsDirective);
