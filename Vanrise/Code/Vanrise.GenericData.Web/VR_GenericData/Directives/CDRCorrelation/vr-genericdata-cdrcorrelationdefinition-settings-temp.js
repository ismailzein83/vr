(function (app) {
    ...
    function CDRCorrelationDefinitionSettings(UtilsService, VRUIUtilsService) {
        ...
        function CDRCorrelationDefinitionSettingsCtor(ctrl, $scope, attrs) {
            ...
            function initializeController() {
                ...
                //    if (inputDataRecordTypeSelectorAPI != undefined) {
                //        var promises = [];
                ...
                //    if (outputDataRecordTypeSelectorAPI != undefined) {
                //        var promises = [];
                ...
                api.load = function (payload) {
                    if (payload != undefined && payload.componentType != undefined) {
                        ...
                        if (settings != undefined) {
                            inputDataRecordTypeId = settings.InputDataRecordTypeId;
                            inputDataRecordStorageId = settings.InputDataRecordTypeId;
                            outputDataRecordTypeId = settings.OutputDataRecordTypeId;
                            outputDataRecordStorageId = settings.OutputDataRecordStorageId;
                            callingNumberFieldName = settings.CallingNumberFieldName;
                            calledNumberFieldName = settings.CalledNumberFieldName;
                            durationFieldName = settings.DurationFieldName;
                            datetimeFieldName = settings.DatetimeFieldName;
                            mergeDataTransformationDefinitionId = settings.MergeDataTransformationDefinitionId
                        }
                    }
    ...
    app.directive('vrGenericdataCdrcorrelationdefinitionSettingsTemp', CDRCorrelationDefinitionSettings);
