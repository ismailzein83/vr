    ...
    function (VRNotificationService, VRCommon_VRLocalizationTextResourceAPIService, VRCommon_VRLocalizationTextResourceService, VRUIUtilsService, UtilsService, VRLocalizationService) {
        ...
        function getTextResourceSelectorTemplate(attrs) {
			...
			if (attrs.hidelabel != undefined)
				hidelabel = " hidelabel ";
            return '<vr-common-vrlocalizationtextresource-selector on-ready="scopeModel.onTextResourceSelectorReady" ng-if="scopeModel.isLocalizationEnabled" normal-col-num="' + colnum + '" selectedvalues="scopeModel.selectedResourceKey" isrequired="ctrl.isrequired" customlabel="' + label + '"' + hidelabel + '"></vr-common-vrlocalizationtextresource-selector>';
        ...
        function VrLocalizationressourcekeySelector($scope, ctrl, $attrs) {
            ...
            function defineAPI() {
                ...
                api.getResourceKey = function () {
                    if (VRLocalizationService.isLocalizationEnabled()) {
                        return $scope.scopeModel.selectedResourceKey != undefined ? $scope.scopeModel.selectedResourceKey.ResourceKey : undefined;
                    }
                };
