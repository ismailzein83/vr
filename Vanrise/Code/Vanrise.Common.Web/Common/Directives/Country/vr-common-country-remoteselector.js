'use strict';
app.directive('vrCommonCountryRemoteselector', ['VRCommon_VRRestCountryAPIService', 'VRCommon_CountryService', 'UtilsService', 'VRUIUtilsService', function (VRCommon_VRRestCountryAPIService, VRCommon_CountryService, UtilsService, VRUIUtilsService) {
	...
	function countryCtor(ctrl, $scope, attrs) {
		...
		function defineAPI() {
			...
			api.load = function (payload) {
				...
				return GetRemoteCountriesInfo(attrs, ctrl, selectedIds, connectionId, filter);
			};
	...
	function GetRemoteCountriesInfo(attrs, ctrl, selectedIds, connectionId, filter) {
		return VRCommon_VRRestCountryAPIService.GetRemoteCountriesInfo(connectionId, UtilsService.serializetoJson(filter)).then(function (response) {
