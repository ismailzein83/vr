...
app.directive('vrCommonStatusdefinitionRemoteselector', ['VR_Common_StatusDefinitionAPIService', 'UtilsService', 'VRUIUtilsService',
    ...
    function (VR_Common_StatusDefinitionAPIService, UtilsService, VRUIUtilsService) {
        return {
            ...
            controller: function ($scope, $element, $attrs) {
                ...
                var remoteStatusDefinitionSelector = new RemoteStatusDefinitionSelector(ctrl, $scope, $attrs);
                remoteStatusDefinitionSelector.initializeController();
        ...
        function RemoteStatusDefinitionSelector(ctrl, $scope, attrs) {
            ...
            function defineAPI() {
                ...
                api.load = function (payload) {
                    ...
                    return VR_Common_StatusDefinitionAPIService.GetRemoteStatusDefinitionsInfo(connectionId, UtilsService.serializetoJson(filter)).then(function (response) {
