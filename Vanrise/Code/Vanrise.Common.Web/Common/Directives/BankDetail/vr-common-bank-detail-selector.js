            ...
            controller: function ($scope, $element, $attrs) {
                ...
                $scope.addNewBank = function () {
                    var onBankAdded = function (bankObj) {
                        var bankDetailsInfo =
                        {
                            BankDetailId: bankObj.BankDetailId,
                            ChannelName: bankObj.ChannelName == undefined ? bankObj.Bank : bankObj.ChannelName
                        };
                        ctrl.datasource.push(bankDetailsInfo);
                        if ($attrs.ismultipleselection != undefined)
                            ctrl.selectedvalues.push(bankDetailsInfo);
                        else
                            ctrl.selectedvalues = bankDetailsInfo;
                    };
