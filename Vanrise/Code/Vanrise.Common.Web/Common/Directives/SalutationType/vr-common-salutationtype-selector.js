...
app.directive('vrCommonSalutationtypeSelector', ['UtilsService', 'VRUIUtilsService', 'VRCommon_SalutationTypeEnum',
    function (UtilsService, VRUIUtilsService, VRCommon_SalutationTypeEnum) {
        return {
            restrict: 'E',
            scope: {
                onReady: '=',
            ...
            controller: function ($scope, $element, $attrs) {
                ...
                var ctor = new SalutationTypeCtor(ctrl, $scope, $attrs);
        ...
        function SalutationTypeCtor(ctrl, $scope, attrs) {
            ...
            function defineAPI() {
                ...
                api.load = function (payload) {
                    ...
                    var salutationTypes = UtilsService.getArrayEnum(VRCommon_SalutationTypeEnum);

                    if (salutationTypes != null) {
                        for (var i = 0; i < salutationTypes.length; i++) {
                            ctrl.datasource.push(salutationTypes[i]);
                        }
