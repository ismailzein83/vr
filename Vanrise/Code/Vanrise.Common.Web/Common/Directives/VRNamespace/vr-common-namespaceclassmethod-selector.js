(function (app) {
    ...
    MethodSelector.$inject = ['VRCommon_VRNamespaceAPIService', 'UtilsService', 'VRUIUtilsService'];

    function MethodSelector(VRCommon_VRNamespaceAPIService, UtilsService, VRUIUtilsService) {
        return {
            restrict: 'E',
            scope: {
                onReady: '=',
        ...
        function NamespaceCtor(ctrl, $scope, attrs) {
            ...
            function getDirectiveAPI() {
                ...
                api.load = function (payload) {
                    ...
                    return VRCommon_VRNamespaceAPIService.GetVRNamespaceClassMethodsInfo(vrNamespaceId, className).then(function (response) {
    ...
    app.directive('vrCommonNamespaceclassmethodSelector', MethodSelector);
