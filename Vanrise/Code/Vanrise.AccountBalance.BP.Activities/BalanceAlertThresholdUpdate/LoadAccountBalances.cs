...
namespace Vanrise.AccountBalance.BP.Activities
{
    ...
    public class LoadAccountBalancesInput
    {
        public BaseQueue<AccountBalanceBatch> OutputQueue { get; set; }
    }
    #endregion
    public sealed class LoadAccountBalances : BaseAsyncActivity<LoadAccountBalancesInput>
    {
        ...
        protected override void DoWork(LoadAccountBalancesInput inputArgument, AsyncActivityHandle handle)
        {
        ...
        protected override LoadAccountBalancesInput GetInputArgument(AsyncCodeActivityContext context)
        {
            return new LoadAccountBalancesInput()
            {
