...
{
    public enum NumberToTextCurrency { Syria, UAE, SaudiArabia, Tunisia, Gold, KD };

    public class NumberToTextCurrencyInfo
    {
        #region Constructors

        public NumberToTextCurrencyInfo(NumberToTextCurrency currency)
        {
            switch (currency)
            {
                case NumberToTextCurrency.Syria:
                    CurrencyCode = "SYP";
                ...
                case NumberToTextCurrency.SaudiArabia:
                    CurrencyCode = "SAR";
                    IsCurrencyNameFeminine = false;
                ...
                case NumberToTextCurrency.Tunisia:
                    CurrencyCode = "TND";
                    IsCurrencyNameFeminine = false;
                ...
                case NumberToTextCurrency.Gold:
                    CurrencyCode = "XAU";
                    IsCurrencyNameFeminine = false;
                ...
                case NumberToTextCurrency.KD:
                    ...
                    Arabic1199CurrencyName = "دينارا كويتياً";
                    Arabic1CurrencyPartName = "فلس";
                    Arabic2CurrencyPartName = "فلسان";
                    Arabic310CurrencyPartName = "فلوس";
                    Arabic1199CurrencyPartName = "فلساً";
                ...
                default: throw new NotSupportedException($"currency '{currency.ToString()}' is not supported");
            }
        }
