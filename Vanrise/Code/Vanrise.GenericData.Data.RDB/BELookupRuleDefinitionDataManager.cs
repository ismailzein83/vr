...
namespace Vanrise.GenericData.Data.RDB
{
    public class BELookupRuleDefinitionDataManager : IBELookupRuleDefinitionDataManager
    {
        ...
        {
            return RDBDataProviderFactory.CreateProvider("VR_GenericData_BELookupRuleDefinition", "ConfigurationDBConnStringKey", "ConfigurationDBConnStringKey");
        }
        #endregion
        ...
        public IEnumerable<BELookupRuleDefinition> GetBELookupRuleDefinitions()
        {
            ...
            selectQuery.SelectColumns().Columns(COL_ID, COL_Name, COL_Details);
