...
app.directive("vrInvoicetypeGridactionsettingsSetinvoicepaid", ["UtilsService", "VRNotificationService", "VRUIUtilsService",
    function (UtilsService, VRNotificationService, VRUIUtilsService) {
        ...
        var directiveDefinitionObject = {
            ...
            templateUrl: "/Client/Modules/VR_Invoice/Directives/InvoiceType/InvoiceActions/MainExtensions/Templates/SetInvoicePaidActionTemplate.html"
            ...
            function defineAPI() {
                ...
                api.load = function (payload) {
                    ...
                    if (invoiceActionEntity != undefined) {
                        $scope.scopeModel.isInvoicePaid = invoiceActionEntity.IsInvoicePaid;
                    }
                    var promises = [];
