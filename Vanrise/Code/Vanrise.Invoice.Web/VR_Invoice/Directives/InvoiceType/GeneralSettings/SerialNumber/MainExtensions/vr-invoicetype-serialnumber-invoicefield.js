...
app.directive("vrInvoicetypeSerialnumberInvoicefield", ["UtilsService", "VRNotificationService", "VRUIUtilsService","VR_Invoice_InvoiceFieldEnum",
    function (UtilsService, VRNotificationService, VRUIUtilsService, VR_Invoice_InvoiceFieldEnum) {
        ...
        var directiveDefinitionObject = {
            ...
            controller: function ($scope, $element, $attrs) {
                ...
                var ctor = new InvoiceFieldSerialNumberPart($scope, ctrl, $attrs);
            ...
            templateUrl: "/Client/Modules/VR_Invoice/Directives/InvoiceType/GeneralSettings/SerialNumber/MainExtensions/Templates/InvoiceFieldSerialNumberPartTemplate.html"

        };

        function InvoiceFieldSerialNumberPart($scope, ctrl, $attrs) {
            ...
            function defineAPI() {
                ...
                api.getData = function () {
                    return {
                        $type: "Vanrise.Invoice.MainExtensions.VRConcatenatedPart.SerialNumberParts.InvoiceFieldSerialNumberPart ,Vanrise.Invoice.MainExtensions",
