        ...
        function ActionSettings($scope, ctrl, $attrs) {
            ...
            function defineAPI() {
                ...
                api.load = function (payload) {
                    ...
                    var getAutomaticInvoiceGeneratorConfigsPromise = getAutomaticInvoiceActionSettingsConfigs();
                    promises.push(getAutomaticInvoiceGeneratorConfigsPromise);

                    function getAutomaticInvoiceActionSettingsConfigs() {
                        return VR_Invoice_InvoiceTypeConfigsAPIService.GetAutomaticInvoiceActionSettingsConfigs().then(function (response) {
                            if (response != null) {
