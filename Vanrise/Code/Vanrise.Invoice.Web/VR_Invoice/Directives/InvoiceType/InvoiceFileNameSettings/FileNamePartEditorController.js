(function (appControllers) {
    ...
    function fileNamePartEditorController($scope, VRNavigationService, UtilsService, VRNotificationService, VRUIUtilsService) {
        ...
        function defineScope() {
            ...
            $scope.scopeModel.save = function () {
                return (isEditMode) ? updateFileNamePart() : addeFileNamePart();
            };
            $scope.scopeModel.close = function () {
                $scope.modalContext.closeModal();
            };

            function builFileNamePartObjFromScope() {
                return {
            ...
            function addeFileNamePart() {
                var fileNamePartObj = builFileNamePartObjFromScope();
    ...
    appControllers.controller('VR_Invoice_FileNamePartEditorController', fileNamePartEditorController);
