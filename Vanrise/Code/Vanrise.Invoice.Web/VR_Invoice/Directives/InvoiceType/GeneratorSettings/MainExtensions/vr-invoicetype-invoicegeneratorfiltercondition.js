(function (app) {
    ...
    InvoiceFilterConditionDirective.$inject = ['UtilsService', 'VRUIUtilsService', 'VR_Invoice_InvoiceTypeConfigsAPIService'];

    function InvoiceFilterConditionDirective(UtilsService, VRUIUtilsService, VR_Invoice_InvoiceTypeConfigsAPIService) {
        return {
            restrict: "E",
            scope: {
                onReady: "=",
            ...
            function defineAPI() {
                ...
                api.load = function (payload) {
                    ...
                    function getInvoiceGeneratorTemplateConfigs() {
                        return VR_Invoice_InvoiceTypeConfigsAPIService.GetInvoiceGeneratorFilterConditionConfigs().then(function (response) {
                            if (response != null) {
    ...
    app.directive('vrInvoicetypeInvoicegeneratorfiltercondition', InvoiceFilterConditionDirective);
