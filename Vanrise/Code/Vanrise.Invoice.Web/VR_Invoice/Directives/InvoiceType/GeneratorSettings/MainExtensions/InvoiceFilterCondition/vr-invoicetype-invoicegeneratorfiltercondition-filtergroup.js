...
app.directive("vrInvoicetypeInvoicegeneratorfilterconditionFiltergroup", ["UtilsService", "VRNotificationService", "VRUIUtilsService",
    function (UtilsService, VRNotificationService, VRUIUtilsService) {
        ...
        var directiveDefinitionObject = {
            ...
            templateUrl: "/Client/Modules/VR_Invoice/Directives/InvoiceType/GeneratorSettings/MainExtensions/InvoiceFilterCondition/Templates/FilterGroupConditionTemplate.html"
        ...
        function FilterGroupCondition($scope, ctrl, $attrs) {
            ...
            function defineAPI() {
                ...
                api.getData = function () {
                    ...
                    return {
                        $type: "Vanrise.Invoice.MainExtensions.InvoiceGeneratorActionFilterGroupCondition ,Vanrise.Invoice.MainExtensions",
