(function (app) {
    ...
    function ParameterSettingsDirective(UtilsService, VRUIUtilsService, VR_Invoice_InvoiceTypeConfigsAPIService) {
        return {
            ...
            controller: function ($scope, $element, $attrs) {
                var ctrl = this;
                var ctor = new ParameterSettings($scope, ctrl, $attrs);
        ...
        function ParameterSettings($scope, ctrl, $attrs) {
            ...
            function defineAPI() {
                ...
                api.load = function (payload) {
                    ...
                    var getParameterSettingsConfigsPromise = getRDLCParameterSettingsTemplateConfigs();
    ...
    app.directive('vrInvoicetypeOpenrdlcreportParametersettings', ParameterSettingsDirective);
