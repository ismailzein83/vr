...
app.directive("vrInvoicetypeInvoicegridactions", ["UtilsService", "VRNotificationService", "VR_Invoice_InvoiceGridSettingService",
    function (UtilsService, VRNotificationService, VR_Invoice_InvoiceGridSettingService) {
        ...
        var directiveDefinitionObject = {
            ...
            templateUrl: "/Client/Modules/VR_Invoice/Directives/InvoiceType/InvoiceGridSettings/Templates/InvoiceGridActionsManagement.html"
        ...
        function InvoiceGridActions($scope, ctrl, $attrs) {
            ...
            function initializeController() {
                ...
                ctrl.addGridAction = function () {
                    ...
                    VR_Invoice_InvoiceGridSettingService.addGridAction(onGridActionAdded, getContext());
                };
            ...
            function editAction(actionObj) {
                ...
                VR_Invoice_InvoiceGridSettingService.editGridAction(actionObj.Entity, onGridActionUpdated, getContext());
            }
            function getContext()
            {
                return context;
