...
xcopy "C:\TFS\CarrierPortal\Code\PartnerPortal.Invoice.Web\PartnerPortal_Invoice" /S /E /R /y /v /i /z /Q "\\192.168.110.185\Fixes\WebSite\CarrierPortal.MultinetPortal\%YYYYMMDD%\Client\Modules\PartnerPortal_Invoice\"

xcopy "C:\TFS\CarrierPortal\Code\CP.MultiNet.Web\CP_MultiNet" /S /E /R /y /v /i /z /Q "\\192.168.110.185\Fixes\WebSite\CarrierPortal.MultinetPortal\%YYYYMMDD%\Client\Modules\CP_MultiNet\"

xcopy "C:\TFS\CarrierPortal\Code\CarrierPortal.Web\Web.config.MultinetPortal.exclude" /y /v /z /i /Q /R "\\192.168.110.185\Fixes\WebSite\CarrierPortal.MultinetPortal\%YYYYMMDD%\"
rename "\\192.168.110.185\Fixes\WebSite\CarrierPortal.MultinetPortal\%YYYYMMDD%\Web.config.MultinetPortal.exclude" "Web.Update.MultinetPortal.config"
...
xcopy "C:\TFS\CarrierPortal\Code\PartnerPortal.Invoice.Web\PartnerPortal_Invoice" /S /E /R /y /v /i /z /Q				"\\192.168.110.185\FixesFullVersion\WebSite\CarrierPortal.MultinetPortal\%YYYYMMDD%\Client\Modules\PartnerPortal_Invoice\"

xcopy "C:\TFS\CarrierPortal\Code\CP.MultiNet.Web\CP_MultiNet" /S /E /R /y /v /i /z /Q									"\\192.168.110.185\FixesFullVersion\WebSite\CarrierPortal.MultinetPortal\%YYYYMMDD%\Client\Modules\CP_MultiNet\"

xcopy "C:\TFS\CarrierPortal\Code\CarrierPortal.Web\Web.config.MultinetPortal.exclude" /y /v /z /i /Q /R					"\\192.168.110.185\FixesFullVersion\WebSite\CarrierPortal.MultinetPortal\%YYYYMMDD%\"
rename "\\192.168.110.185\FixesFullVersion\WebSite\CarrierPortal.MultinetPortal\%YYYYMMDD%\Web.config.MultinetPortal.exclude" "Web.Update.MultinetPortal.config"
