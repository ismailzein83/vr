...
xcopy "C:\TFS\TOneV2\Code\TOneV2\SQL.TOneConfiguration\VRJSON_PostScripts\VR_Address.json" 	/y /v /z /i /Q /R		"\\192.168.110.185\Fixes\WebSite\NetworkInventory\%YYYYMMDD%\DataBaseFirstDeploymentScripts\Configuration\"
