...
ECHO CloudXCataleya Create Standard DBs Structure files
::start /b /w /D"C:\TFS\Vanrise\Code\Vanrise.HelperTools\bin\Release" Vanrise.HelperTools.exe "DBs" "CloudXPointV2"