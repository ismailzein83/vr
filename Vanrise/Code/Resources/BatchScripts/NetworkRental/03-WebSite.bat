...
xcopy "C:\TFS\Vanrise\Code\Vanrise.ExcelConversion.Web\ExcelConversion" /S /E /R /y /v /i /z /Q						"\\192.168.110.185\Fixes\WebSite\NetworkRental\%YYYYMMDD%\Client\Modules\ExcelConversion\"
