...
xcopy "C:\TFS\Retail\Code\Retail.Runtime\App.config.exclude" /y /v /z /i /Q /R	"\\192.168.110.185\Fixes\WebSite\NetworkRental\Runtime\%YYYYMMDD%\"
...
rename			"\\192.168.110.185\Fixes\WebSite\NetworkRental\Runtime\%YYYYMMDD%\App.config.exclude" "NetworkRental.Runtime.exe.config"
