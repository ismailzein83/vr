...
xcopy "C:\TFS\TOneV2\Code\TOneV2\TOne.Web\Web.config.JAZZ.exclud" /y /v /z /i /Q /R				"\\192.168.110.185\Fixes\WebSite\TOneV2.Jazz\%YYYYMMDD%\Web.Update.Jazz.config*"
...
xcopy "C:\TFS\TOneV2\Code\TOneV2\TOne.WhS.Jazz.Web\bin\TOne.WhS.Jazz*" /S /E /R /y /v /i /z /Q	"\\192.168.110.185\Fixes\WebSite\TOneV2.Jazz\%YYYYMMDD%\Bin\"
