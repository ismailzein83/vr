...
xcopy "C:\TFS\Retail\Code\Retail.Web\Web.config.MultiNet.exclud" /y /v /z /i /Q /R		"\\192.168.110.185\Fixes\WebSite\Retail.MultiNet\%YYYYMMDD%\Web.Update.MultiNet.config*"
