...
xcopy "C:\TFS\Retail\Code\Retail.MultiNet.Business\bin\Release\Retail.MultiNet.Business.dll" 		/y /v /z /i /Q /R  		"\\192.168.110.185\Fixes\WebSite\Retail.MultiNet\%YYYYMMDD%\bin\"
xcopy "C:\TFS\Retail\Code\Retail.MultiNet.Entities\bin\Release\Retail.MultiNet.Entities.dll" 		/y /v /z /i /Q /R  		"\\192.168.110.185\Fixes\WebSite\Retail.MultiNet\%YYYYMMDD%\bin\"
xcopy "C:\TFS\Retail\Code\Retail.MultiNet.Web\bin\Retail.MultiNet.Web.dll"							/y /v /z /i /Q /R  		"\\192.168.110.185\Fixes\WebSite\Retail.MultiNet\%YYYYMMDD%\bin\"
