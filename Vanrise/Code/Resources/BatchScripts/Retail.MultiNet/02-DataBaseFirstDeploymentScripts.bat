...
xcopy "C:\TFS\TOneV2\Code\TOneV2\SQL.TOneConfiguration\DataAnalysis.Retail_Centrex.PostDeployment.sql" 	/y /v /z /i /Q /R  "\\192.168.110.185\Fixes\WebSite\Retail.MultiNet\%YYYYMMDD%\DataBaseFirstDeploymentScripts\Configuration\"
