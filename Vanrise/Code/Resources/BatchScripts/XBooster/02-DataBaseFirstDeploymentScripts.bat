...
xcopy "C:\TFS\TOneV2\Code\TOneV2\SQL.TOneConfiguration\VRJSON_PostScripts\VR_Security.json" /y /v /z /i /Q /R				"\\192.168.110.185\Fixes\WebSite\XBooster\%YYYYMMDD%\DataBaseFirstDeploymentScripts\Configuration\"
...
xcopy "C:\TFS\TOneV2\Code\TOneV2\SQL.TOneConfiguration\VRJSON_PostScripts\VR_Generic.json" /y /v /z /i /Q /R				"\\192.168.110.185\Fixes\WebSite\XBooster\%YYYYMMDD%\DataBaseFirstDeploymentScripts\Configuration\"
xcopy "C:\TFS\TOneV2\Code\TOneV2\SQL.TOneConfiguration\VRJSON_PostScripts\VR_Runtime.json" /y /v /z /i /Q /R				"\\192.168.110.185\Fixes\WebSite\XBooster\%YYYYMMDD%\DataBaseFirstDeploymentScripts\Configuration\"
xcopy "C:\TFS\TOneV2\Code\TOneV2\SQL.TOneConfiguration\VRJSON_PostScripts\VR_BusinessProcess.json" /y /v /z /i /Q /R		"\\192.168.110.185\Fixes\WebSite\XBooster\%YYYYMMDD%\DataBaseFirstDeploymentScripts\Configuration\"
xcopy "C:\TFS\TOneV2\Code\TOneV2\SQL.TOneConfiguration\VRJSON_PostScripts\VR_Rules.json" /y /v /z /i /Q /R				"\\192.168.110.185\Fixes\WebSite\XBooster\%YYYYMMDD%\DataBaseFirstDeploymentScripts\Configuration\"
xcopy "C:\TFS\TOneV2\Code\TOneV2\SQL.TOneConfiguration\VRJSON_PostScripts\VR_ExcelConversion.json" /y /v /z /i /Q /R		"\\192.168.110.185\Fixes\WebSite\XBooster\%YYYYMMDD%\DataBaseFirstDeploymentScripts\Configuration\"
