...
ECHO XBooster WebSite

xcopy "C:\Publish\XBooster" /S /E /R /y /v /i /z /Q "\\192.168.110.185\Fixes\WebSite\XBooster\%YYYYMMDD%\" /EXCLUDE:C:\TFS\Vanrise\Code\Resources\BatchScripts\XBooster\list-of-excluded-files.txt
xcopy "C:\TFS\Xbooster\Code\Xbooster.Web\Web.config.exclude" /y /v /z /i /Q /R "\\192.168.110.185\Fixes\WebSite\XBooster\%YYYYMMDD%\"
rename "\\192.168.110.185\Fixes\WebSite\XBooster\%YYYYMMDD%\Web.config.exclude" "Web.config"

xcopy "C:\TFS\Vanrise\Code\Resources\DLLs\Aspose.Cells.lic" /y /v /z /i /Q /R "\\192.168.110.185\Fixes\WebSite\XBooster\%YYYYMMDD%\Bin\"
xcopy "C:\TFS\Vanrise\Code\Vanrise.Web\Client" /S /E /R /y /v /i /z /Q "\\192.168.110.185\Fixes\WebSite\XBooster\%YYYYMMDD%\Client\"
xcopy "C:\TFS\Vanrise\Code\Vanrise.Security.Web\Security" /S /E /R /y /v /i /z /Q "\\192.168.110.185\Fixes\WebSite\XBooster\%YYYYMMDD%\Client\Modules\Security\"
xcopy "C:\TFS\Vanrise\Code\Vanrise.Common.Web\Common" /S /E /R /y /v /i /z /Q "\\192.168.110.185\Fixes\WebSite\XBooster\%YYYYMMDD%\Client\Modules\Common\"
