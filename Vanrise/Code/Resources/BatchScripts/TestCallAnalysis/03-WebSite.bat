...
xcopy "C:\TFS\Retail\Code\Retail.Web\Images\flat-tone-ra-logoonheader.png" /S /R /y /v /i /z /Q						"\\192.168.110.185\Fixes\WebSite\TestCallAnalysis\%YYYYMMDD%\Images\logoonheader.png*"
xcopy "C:\TFS\Retail\Code\Retail.Web\Images\flat-tone-ra-login.png" /S /R /y /v /i /z /Q							"\\192.168.110.185\Fixes\WebSite\TestCallAnalysis\%YYYYMMDD%\Images\login.png*"
xcopy "C:\TFS\Retail\Code\Retail.Web\Images\flat-tone-ra-iconheader.ico" /S /R /y /v /i /z /Q						"\\192.168.110.185\Fixes\WebSite\TestCallAnalysis\%YYYYMMDD%\Images\iconheader.ico*"
...
::default theme
xcopy "C:\TFS\Retail\Code\Retail.Web\Images\RA-logoonheader.png" /S /R /y /v /i /z /Q								"\\192.168.110.185\Fixes\WebSite\TestCallAnalysis\%YYYYMMDD%\Default-theme\Images\logoonheader.png*"
xcopy "C:\TFS\Retail\Code\Retail.Web\Images\RA-login.png" /S /R /y /v /i /z /Q										"\\192.168.110.185\Fixes\WebSite\TestCallAnalysis\%YYYYMMDD%\Default-theme\Images\login.png*"
xcopy "C:\TFS\Retail\Code\Retail.Web\Images\RA-iconheader.ico" /S /R /y /v /i /z /Q									"\\192.168.110.185\Fixes\WebSite\TestCallAnalysis\%YYYYMMDD%\Default-theme\Images\iconheader.ico*"
...
::flat theme
xcopy "C:\TFS\Retail\Code\Retail.Web\Images\flat-tone-ra-logoonheader.png" /S /R /y /v /i /z /Q						"\\192.168.110.185\Fixes\WebSite\TestCallAnalysis\%YYYYMMDD%\Flat-theme\Images\logoonheader.png*"
xcopy "C:\TFS\Retail\Code\Retail.Web\Images\flat-tone-ra-login.png" /S /R /y /v /i /z /Q							"\\192.168.110.185\Fixes\WebSite\TestCallAnalysis\%YYYYMMDD%\Flat-theme\Images\login.png*"
xcopy "C:\TFS\Retail\Code\Retail.Web\Images\flat-tone-ra-iconheader.ico" /S /R /y /v /i /z /Q						"\\192.168.110.185\Fixes\WebSite\TestCallAnalysis\%YYYYMMDD%\Flat-theme\Images\iconheader.ico*"
