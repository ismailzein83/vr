...
del /s /q /f																										"\\192.168.110.185\Fixes\WebSite\TestCallAnalysis\%YYYYMMDD%\Bin\Vanrise.AccountManager.*"
del /s /q /f																										"\\192.168.110.185\Fixes\WebSite\TestCallAnalysis\%YYYYMMDD%\Bin\Vanrise.AccountBalance.*"
del /s /q /f																										"\\192.168.110.185\Fixes\WebSite\TestCallAnalysis\%YYYYMMDD%\Bin\Vanrise.Invoice.*"
del /s /q /f																										"\\192.168.110.185\Fixes\WebSite\TestCallAnalysis\%YYYYMMDD%\Bin\Vanrise.InvToAccBalanceRelation.*"
del /s /q /f																										"\\192.168.110.185\Fixes\WebSite\TestCallAnalysis\%YYYYMMDD%\Bin\Vanrise.NumberingPlan.*"
