...
xcopy "C:\TFS\CDRAnalysis\CDRAnalysis.Web\Web.config.exclude" /y /v /z /i /Q /R "\\192.168.110.185\Fixes\WebSite\CDRAnalysis\%YYYYMMDD%\"
rename "\\192.168.110.185\Fixes\WebSite\CDRAnalysis\%YYYYMMDD%\Web.config.exclude" "Web.config"
