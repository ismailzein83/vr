...
xcopy "C:\TFS\TOneV2\Code\TOneV2\TOne.WhS.Invoice.Web\WhS_Invoice\Reports"	/S /E /R /y /v /i /z /Q "\\192.168.110.185\Fixes\WebSite\TOneV2\Runtime\%YYYYMMDD%\Modules\WhS_Invoice\Reports" /EXCLUDE:C:\TFS\Vanrise\Code\Resources\BatchScripts\TOneV2\runtime-list-of-excluded-files.txt
