...
xcopy "C:\TFS\Retail\Code\Retail.Runtime\bin\x64\Release" /y /v /z /i /Q /R									"\\192.168.110.185\Fixes\WebSite\TOne.SMS\Runtime\%YYYYMMDD%\" /EXCLUDE:C:\TFS\Vanrise\Code\Resources\BatchScripts\Common\RetailSource\runtime-list-of-excluded-files.txt
...
xcopy "C:\Publish\Retail\bin\Retail.Demo*" /S /E /R /y /v /i /z /Q											"\\192.168.110.185\Fixes\WebSite\TOne.SMS\Runtime\%YYYYMMDD%\"
xcopy "C:\Publish\Retail\bin\Retail.SMS*" /S /E /R /y /v /i /z /Q											"\\192.168.110.185\Fixes\WebSite\TOne.SMS\Runtime\%YYYYMMDD%\"
del /s /q /f																								"\\192.168.110.185\Fixes\WebSite\TOne.SMS\Runtime\%YYYYMMDD%\*.pdb"
del /s /q /f																								"\\192.168.110.185\Fixes\WebSite\TOne.SMS\Runtime\%YYYYMMDD%\Retail.*.Web.*"