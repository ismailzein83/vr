...
xcopy "C:\TFS\Retail\Code\Retail.Interconnect.Web\Retail_Interconnect\Reports"								/S /E /R /y /v /i /z /Q "\\192.168.110.185\Fixes\WebSite\Interconnect\Runtime\%YYYYMMDD%\Modules\Interconnect\Reports" /EXCLUDE:C:\TFS\Vanrise\Code\Resources\BatchScripts\Retail_Interconnect\runtime-list-of-excluded-files.txt
