...
xcopy "C:\TFS\TOneV2\Code\TOneV2\SQL.TOneConfiguration\VRJSON_PostScripts\Common\VR_GoogleAnalytics.json" /y /v /z /i /Q /R	"\\192.168.110.185\Fixes\WebSite\CloudXPointV2\%YYYYMMDD%\DataBaseFirstDeploymentScripts\Configuration\"
