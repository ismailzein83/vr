...
xcopy "C:\TFS\CarrierPortal\Code\CarrierPortal.Web\Web.config.SupplierPricelist.exclud" /y /v /z /i /Q /R	"\\192.168.110.185\Fixes\WebSite\CP.SupplierPricelist\%YYYYMMDD%\Web.Update.SupplierPricelist.config*"
