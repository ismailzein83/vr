...
xcopy "C:\Publish\Retail" /S /E /R /y /v /i /z /Q														"\\192.168.110.185\Fixes\WebSite\ISP\%YYYYMMDD%\" /EXCLUDE:C:\TFS\Vanrise\Code\Resources\BatchScripts\Common\RetailSource\list-of-excluded-files.txt
...
xcopy "C:\TFS\Vanrise\Code\Vanrise.Web\Client" /S /E /R /y /v /i /z /Q									"\\192.168.110.185\Fixes\WebSite\ISP\%YYYYMMDD%\Client\" /EXCLUDE:C:\TFS\Vanrise\Code\Resources\BatchScripts\Common\Client-list-of-excluded-files.txt
...
del /s /q /f																							"\\192.168.110.185\Fixes\WebSite\ISP\%YYYYMMDD%\Bin\*.pdb"
del /s /q /f																							"\\192.168.110.185\Fixes\WebSite\ISP\%YYYYMMDD%\Bin\*.config"