...
xcopy "C:\TFS\Vanrise\Code\Vanrise.Web\Client" /S /E /R /y /v /i /z /Q														"\\192.168.110.185\Fixes\WebSite\BIL\%YYYYMMDD%\Client\" /EXCLUDE:C:\TFS\Vanrise\Code\Resources\BatchScripts\SOM\Client-list-of-excluded-files.txt
