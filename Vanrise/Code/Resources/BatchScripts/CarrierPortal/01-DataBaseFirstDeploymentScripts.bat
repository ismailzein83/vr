...
xcopy "C:\TFS\TOneV2\Code\TOneV2\SQL.TOneConfiguration\Generic.PostDeployment.sql" /y /v /z /i /Q /R			"\\192.168.110.185\Fixes\WebSite\CarrierPortal\%YYYYMMDD%\DataBaseFirstDeploymentScripts\Configuration\"
...
xcopy "C:\TFS\TOneV2\Code\TOneV2\SQL.TOneConfiguration\Analytic.PostDeployment.sql" 		/y /v /z /i /Q /R	"\\192.168.110.185\Fixes\WebSite\CarrierPortal\%YYYYMMDD%\DataBaseFirstDeploymentScripts\Configuration\"
