...
xcopy "C:\TFS\TOneV2\Code\TOneV2\TOne.Web\Web.config.SMS.exclud" /y /v /z /i /Q /R								"\\192.168.110.185\Fixes\WebSite\TOneV2.SMS\%YYYYMMDD%\Web.config*"
...
xcopy "C:\Publish\TOneV2\bin\Vanrise.MobileNetwork*" /S /E /R /y /v /i /z /Q									"\\192.168.110.185\Fixes\WebSite\TOneV2.SMS\%YYYYMMDD%\Bin\"
