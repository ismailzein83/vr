...
-- =============================================
CREATE FUNCTION [dbo].[getExchangeRates](@From DateTime, @To Datetime) 
...
BEGIN
	with CTE AS (
		SELECT cr1.[CurrencyID]
		  ...
		  FROM dbo.[CurrencyExchangeRate] cr1
		  LEFT JOIN dbo.[CurrencyExchangeRate] cr2 ON	cr1.CurrencyID = cr2.CurrencyID 
