...
app.directive('vanriseToolsTableSelector', ['VRNotificationService', 'Vanrise_Tools_TableAPIService', 'UtilsService', 'VRUIUtilsService',
function (VRNotificationService, Vanrise_Tools_TableAPIService, UtilsService, VRUIUtilsService) {
    'use strict';
