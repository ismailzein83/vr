(function (appControllers) {
    ...
    GeneratedScriptSettingsDirective.$inject = ['UtilsService', 'VRUIUtilsService', 'VR_Tools_ColumnsAPIService'];

    function GeneratedScriptSettingsDirective(UtilsService, VRUIUtilsService, VR_Tools_ColumnsAPIService) {
        return {
            restrict: "E",
            scope: {
                onReady: "=",
            ...
            function defineAPI() {
                ...
                api.load = function (payload) {
                    ...
                    function getGeneratedScriptSettingsConfigs() {
                        return VR_Tools_ColumnsAPIService.GetGeneratedScriptItemTableSettingsConfigs().then(function (response) {
                            if (response != null) {
    ...
    appControllers.directive('vrToolsGeneratedScriptSettings', GeneratedScriptSettingsDirective);
