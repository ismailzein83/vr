...
appControllers.directive('vrToolsGeneratedScriptTypeSelector', ['VRNotificationService', 'UtilsService', 'VRUIUtilsService','VR_Tools_GeneratedScriptTypeEnum',
    function (VRNotificationService, UtilsService, VRUIUtilsService, VR_Tools_GeneratedScriptTypeEnum) {
    'use strict';
    ...
    function TypeSelector(ctrl, $scope, attrs) {
        ...
        function defineAPI() {
            ...
            api.load = function (payload) { //payload is an object that has selectedids and filter
                ...
                ctrl.datasource = UtilsService.getArrayEnum(VR_Tools_GeneratedScriptTypeEnum);
