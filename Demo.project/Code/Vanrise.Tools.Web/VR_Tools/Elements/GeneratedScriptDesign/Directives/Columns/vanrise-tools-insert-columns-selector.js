...
appControllers.directive('vanriseToolsInsertColumnsSelector', ['VRNotificationService', 'VR_Tools_ColumnsAPIService', 'UtilsService', 'VRUIUtilsService',
function (VRNotificationService, VR_Tools_ColumnsAPIService, UtilsService, VRUIUtilsService) {
    ...
    var directiveDefinitionObject = {
        ...
        controller: function ($scope, $element, $attrs) {
            ...
            var insertColumnsSelector = new InsertColumnsSelector(ctrl, $scope, $attrs);
            insertColumnsSelector.initializeController();
        },
        controllerAs: 'ctrl',
        bindToController: true,
        template: function (element, attrs) {

            return getInsertColumnsTemplate(attrs);
        }
    };

    function getInsertColumnsTemplate(attrs) {


        var multipleselection = "";
        var label = "Insert Columns";
        if (attrs.ismultipleselection != undefined) {
