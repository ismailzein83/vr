(appControllers); (function (appControllers) {
    "use strict";
    generatedScriptQueriesDisplayerController.$inject = ['$scope', 'VRNotificationService', 'VRNavigationService', 'UtilsService', 'VRUIUtilsService', 'VR_Tools_GeneratedScriptService'];

    function generatedScriptQueriesDisplayerController($scope, VRNotificationService, VRNavigationService, UtilsService, VRUIUtilsService, VR_Tools_GeneratedScriptService) {
    ...
    appControllers.controller('Vanrise_Tools_GeneratedScriptQueriesDisplayerController', generatedScriptQueriesDisplayerController);
})(appControllers);