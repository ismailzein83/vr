...
namespace Demo.Module.Business
{
    public class CodeGroupManager
    {
        ...
        {
            Vanrise.Entities.InsertOperationOutput<CodeGroupDetail> insertOperationOutput = new Vanrise.Entities.InsertOperationOutput<CodeGroupDetail>();
            ...
            ICodeGroupDataManager dataManager = DemoModuleDataManagerFactory.GetDataManager<ICodeGroupDataManager>();
        ...
        public Vanrise.Entities.UpdateOperationOutput<CodeGroupDetail> UpdateCodeGroup(CodeGroup codeGroup)
        {
            ...
            Vanrise.Entities.UpdateOperationOutput<CodeGroupDetail> updateOperationOutput = new Vanrise.Entities.UpdateOperationOutput<CodeGroupDetail>();
        ...
        {
            ICodeGroupDataManager _dataManager = DemoModuleDataManagerFactory.GetDataManager<ICodeGroupDataManager>();
