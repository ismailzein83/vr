...
namespace Demo.Module.Business
{
    public class PopManager
    {
        ...
        public Vanrise.Entities.InsertOperationOutput<Pop> AddPop(Pop pop)
        {
            ...
            IPopDataManager dataManager = DemoModuleDataManagerFactory.GetDataManager<IPopDataManager>();
        ...
        {
            IPopDataManager _dataManager = DemoModuleDataManagerFactory.GetDataManager<IPopDataManager>();
