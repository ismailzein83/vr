(function (appControllers) {
    ...
    function trafficMonitorController($scope, WhS_Analytics_GenericAnalyticDimensionEnum, WhS_Analytics_GenericAnalyticMeasureEnum, UtilsService, VRNotificationService, VRUIUtilsService) {
        ...
        function loadDimensions() {
            ...
            dimensions.push(WhS_Analytics_GenericAnalyticDimensionEnum.Operator.value); 
        ...
        function loadPayload() {
            ...
            payload.filters = [];
            payload.filters.push(WhS_Analytics_GenericAnalyticDimensionEnum.Operator.value);
    ...
    appControllers.controller('TrafficMonitorController', trafficMonitorController);
