(function (appControllers) {
    ...
    popEditorController.$inject = ['$scope', 'Demo_PopAPIService', 'UtilsService', 'VRNotificationService', 'VRNavigationService', 'VRUIUtilsService'];

    function popEditorController($scope, Demo_PopAPIService, UtilsService, VRNotificationService, VRNavigationService, VRUIUtilsService) {
        ...
        function getPop() {
            return Demo_PopAPIService.GetPop(popId).then(function (pop) {
                popEntity = pop;
            });
        }
        ...
        function insertPop() {
            ...
            return Demo_PopAPIService.AddPop(popObject)
        ...
        function updatePop() {
            ...
            var popObject = buildPopObjFromScope();
            Demo_PopAPIService.UpdatePop(popObject)
                .then(function (response) {
    ...
    appControllers.controller('Demo_PopEditorController', popEditorController);
})(appControllers);