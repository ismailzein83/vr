app.constant('Demo_ContactTypeEnum', {
    ...
    PricingContactPerson: { value: 4, label: "Pricing Contact Person", type: "text" },
    PricingEmail: { value: 5, label: "Pricing Email", type: "email" },
    AccountManagerContact: { value: 6, label: "Account Manager Contact", type: "text" },
    AccountManagerEmail: { value: 7, label: "Account Manager Email", type: "email"},
    SupportContactPerson: { value: 8, label: "Support Contact Person", type: "text" },
    SupportEmail: { value: 9, label: "Support Email ", type: "email" },
    TechnicalContactPerson: { value: 10, label:"Technical Contact Person" , type:"text"},
    TechnicalEmail: { value: 11, label: "Technical Email", type: "email" },
    CommercialContactPerson: { value: 12, label: "Commercial Contact Person", type: "text" },
