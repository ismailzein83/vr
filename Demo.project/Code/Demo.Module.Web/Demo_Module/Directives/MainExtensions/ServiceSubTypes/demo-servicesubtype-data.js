...
app.directive('demoServicesubtypeData', ['Demo_DataSubTypeEnum', 'UtilsService', 'VRUIUtilsService',
    function (Demo_DataSubTypeEnum, UtilsService, VRUIUtilsService) {
        ...
        function DirectiveConstructor(ctrl, $scope, attrs) {
            ...
            var selectorAPI;
            ctrl.datasource = UtilsService.getArrayEnum(Demo_DataSubTypeEnum);
