'use strict';
app.directive('cdrdirectionSelector', ['Demo_CDRDirectionEnum', 'UtilsService', 'VRUIUtilsService',
    function (Demo_CDRDirectionEnum, UtilsService, VRUIUtilsService) {
        ...
        function TypeSelector(ctrl, $scope, attrs) {
            ...
            var selectorAPI;
            ctrl.datasource = UtilsService.getArrayEnum(Demo_CDRDirectionEnum);
