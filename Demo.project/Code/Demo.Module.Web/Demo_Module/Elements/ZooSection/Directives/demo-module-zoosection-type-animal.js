(function (app) {
    ...
    ZooSectionTypeAnimalDirective.$inject = ['UtilsService', 'VRUIUtilsService', 'Demo_Module_ZooSectionAPIService'];

    function ZooSectionTypeAnimalDirective(UtilsService, VRUIUtilsService, Demo_Module_ZooSectionAPIService) {
        return {
            restrict: 'E',
            scope: {
                onReady: '=',
            ...
            controller: function ($scope, $element, $attrs) {
                var ctrl = this;
                var ctor = new ZooSectionTypeAnimal($scope, ctrl, $attrs);
        ...
        function ZooSectionTypeAnimal($scope, ctrl, $attrs) {
    ...
    app.directive('demoModuleZoosectionTypeAnimal', ZooSectionTypeAnimalDirective);
})(app);