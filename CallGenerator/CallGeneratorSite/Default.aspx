    ...
    <div class="row-fluid">
        <div class="span3 responsive" data-tablet="span6" data-desktop="span3">
            <div class="dashboard-stat blue">
                ...
                <div class="details">
                    <div class="number">
                        <asp:Label ID="lblTotalCalls" runat="server"></asp:Label>
                    </div>
                    <div class="desc">
                        ITPC
                    </div>
                </div>
                <a class="more" href="CDR.aspx">View more <i class="m-icon-swapright m-icon-white"></i>
                </a>
            </div>
        </div>
        <div class="span3 responsive" data-tablet="span6" data-desktop="span3">
            <div class="dashboard-stat green">
                ...
                <div class="details">
                    <div class="number"><asp:Label ID="lblCLIDel" runat="server"></asp:Label></div>
                    <div class="desc">Zain</div>
                </div>
                <a class="more" href="CDR.aspx">View more <i class="m-icon-swapright m-icon-white"></i>
                </a>
            </div>
        ...
        <div class="span3 responsive" data-tablet="span6  fix-offset" data-desktop="span3">
            <div class="dashboard-stat red">
                ...
                <div class="details">
                    <div class="number"><asp:Label ID="lblCLINonDel" runat="server"></asp:Label></div>
                    <div class="desc">Syria</div>
                </div>
                <a class="more" href="CDR.aspx">View more <i class="m-icon-swapright m-icon-white"></i>
                </a>
            </div>
        ...
        <div class="span3 responsive" data-tablet="span6" data-desktop="span3">
            <div class="dashboard-stat yellow">
                ...
                <div class="details">
                    <div class="number">00 Points</div>
