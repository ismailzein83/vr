...
<div class="header navbar navbar-inverse navbar-fixed-top">
	...
	<div class="navbar-inner">
		<div class="container-fluid">
			<!-- BEGIN LOGO -->
			<a class="brand" href="default.aspx" style="color:white">&nbsp;&nbsp;&nbsp;<i class="icon-home"></i>&nbsp;Call Generator
			...
			<ul class="nav pull-right">
                ...
                <a class="brand pull-right"  style="color:white"><asp:Label ID="LblDateNow" runat="server"></asp:Label>&nbsp;(GMT + 03:00)</a>
