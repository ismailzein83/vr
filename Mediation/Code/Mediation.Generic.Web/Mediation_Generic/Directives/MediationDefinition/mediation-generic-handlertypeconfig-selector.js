(function (app) {
    ...
    HandlerTypeSettingsDirective.$inject = ['Mediation_Generic_MediationDefinitionAPIService', 'UtilsService', 'VRUIUtilsService'];

    function HandlerTypeSettingsDirective(Mediation_Generic_MediationDefinitionAPIService, UtilsService, VRUIUtilsService) {
        ...
        function getDirectiveTemplate(attrs) {
            ...
            var label = attrs.label ? attrs.label : 'Handler Types';
            var ismultipleselection = '';
            if (attrs.ismultipleselection != undefined && attrs.ismultipleselection != null) {
                label = label == 'Handler Type' ? 'Handler Types' : label;
    ...
    app.directive('mediationGenericHandlertypeconfigSelector', HandlerTypeSettingsDirective);
