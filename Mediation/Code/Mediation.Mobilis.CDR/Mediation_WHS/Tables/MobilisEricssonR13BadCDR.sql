CREATE TABLE [Mediation_WHS].[MobilisEricssonR13BadCDR] (
    ...
    [IsInTrunkSwicth]              BIT              NULL,
    [IsOutTrunkSwitch]             BIT              NULL,
    [NormalizedCallingPartyNumber] VARCHAR (50)     NULL,
    [NormalizedCalledPartyNumber]  VARCHAR (50)     NULL,
