...
namespace Mediation.Generic.Data
{
    public interface IMediationRecordsDataManager : IDataManager, IBulkApplyDataManager<MediationRecord>
    {
        ...
        void GetMediationRecordsByStatus(Guid mediationDefinitionId, EventStatus status, long lastCommittedId, DateTime? sessionTimeout, Action<SessionIdentifier> onSessionIdLoaded);
