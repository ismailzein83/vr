...
public class BasePage : System.Web.UI.Page
{
    ...
    private static string defaultPage = "~/DefaultMobileOperator.aspx";
    ...
    public static int PortalType
    {
        get
        {
            if (HttpContext.Current.Session["PortalType"] is int)
                return (int)HttpContext.Current.Session["PortalType"];
            return 0;
        }
        set { HttpContext.Current.Session["PortalType"] = value; }
    }
