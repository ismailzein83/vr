...
public class WebUser
{
    ...
    private string previousPage = "DefaultMobileOperator.aspx";
    private string currentPage = "DefaultMobileOperator.aspx";
    ...
    public WebUser()
    {
        ...
        previousPage = "DefaultMobileOperator.aspx";
        currentPage = "DefaultMobileOperator.aspx";
    }
