...
public partial class EmailReceivers : BasePage
{
    ...
    {
        List<EmailTemplate> listEmailTemplates = Vanrise.Fzero.CDRAnalysis.EmailTemplate.GetEmailTemplates();
        ...
        List<EmailReceiverType> listEmailReceiverTypes = Vanrise.Fzero.CDRAnalysis.EmailReceiverType.GetEmailReceiverTypes();
    ...
    protected void gvEmailReceivers_ItemCommand(object sender, GridCommandEventArgs e)
    {
        ...
        {
            case "Remove":
                if (Vanrise.Fzero.CDRAnalysis.EmailReceiver.Delete(Id))
                {
                    gvEmailReceivers.Rebind();
                    ClearForm();
                    ClearSearchForm();
