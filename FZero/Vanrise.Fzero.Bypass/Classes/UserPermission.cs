...
namespace Vanrise.Fzero.Bypass
{
    public partial class UserPermission
    {
        public static bool DeleteByUserId(int userID)
        {
            ...
            {
                FileLogger.Write("Error in Vanrise.Fzero.Bypass.UserPermission.DeleteByUserId(" + userID.ToString() + ")", err);
            }
            return success;
        }
        ...
        public static bool Save(List<UserPermission> permissions){
            ...
            {
                FileLogger.Write("Error in Vanrise.Fzero.Bypass.UserPermission.Save()", err);
            }
            return success;
        }
    }
