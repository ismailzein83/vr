                        ...
                        <MasterTableView DataKeyNames="ID" ClientDataKeyNames="Id">
                            <Columns>
                                ...
                                <telerik:GridTemplateColumn ItemStyle-Width="30" HeaderText="Details">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="btnDetails" runat="server" CssClass="command btn-link" Visible='<%#((int)Eval("ReportingStatusID")== (int) Vanrise.Fzero.CDRAnalysis.Enums.ReportingStatuses.ToBeSent) %>'
                                ...
                                <telerik:GridTemplateColumn ItemStyle-Width="30" HeaderText="Delete">
                                    <ItemTemplate>
                                        ...
                                        <asp:LinkButton ID="btnDelete" runat="server" CssClass="command btn-link" Visible='<%#((int)Eval("ReportingStatusID")== (int) Vanrise.Fzero.CDRAnalysis.Enums.ReportingStatuses.ToBeSent) %>'
                                ...
                                <telerik:GridTemplateColumn ItemStyle-Width="30" HeaderText="Send">
                                    <ItemTemplate>
                                        ...
                                        <asp:LinkButton ID="btnSend" runat="server" CssClass="command btn-link" Visible='<%#((int)Eval("ReportingStatusID")== (int) Vanrise.Fzero.CDRAnalysis.Enums.ReportingStatuses.ToBeSent) && Eval("ReportDetails.Count").ToString()!= "0" %>'
