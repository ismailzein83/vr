...
public partial class SentEmails : BasePage
{
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        Vanrise.Fzero.CDRAnalysis.prGetEmails_Result.DeleteEmail(ListIds);
        gvEmails.Rebind();
    }
    ...
    {
        gvEmails.DataSource = Vanrise.Fzero.CDRAnalysis.prGetEmails_Result.GetAllEmails(txtEmail.Text, rdpFromDate.SelectedDate, rdpToDate.SelectedDate);
    }
