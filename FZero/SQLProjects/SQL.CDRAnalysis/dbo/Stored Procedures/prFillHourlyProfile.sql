...
-------------------------- Served Party Profile     ---------------------- 
 ...
 SELECT
    ...
    ,DATEADD(hour, DATEDIFF(hour, 0, connectdatetime), 0) FromDate
    ,DATEADD(hour, DATEDIFF(hour, 0, DATEADD(hour,1,connectdatetime)), 0) ToDate
  ...
  GROUP BY
    MSISDN
    ,DATEADD(hour, DATEDIFF(hour, 0, connectdatetime), 0)
    ,DATEADD(hour, DATEDIFF(hour, 0, DATEADD(hour,1,connectdatetime)), 0)
