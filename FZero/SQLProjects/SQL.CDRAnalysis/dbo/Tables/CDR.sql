CREATE TABLE [dbo].[CDR] (
    ...
    [Ignore]             INT             NULL,
    [IsNormalized]       BIT             NULL,
    CONSTRAINT [PK_CDRs] PRIMARY KEY CLUSTERED ([Id] ASC) WITH (FILLFACTOR = 80, STATISTICS_NORECOMPUTE = ON),
    CONSTRAINT [FK_CDR_Imports] FOREIGN KEY ([ImportID]) REFERENCES [dbo].[Imports] ([ID]),
    CONSTRAINT [FK_CDR_SwitchProfiles] FOREIGN KEY ([SourceID]) REFERENCES [dbo].[SwitchProfiles] ([Id])
);
