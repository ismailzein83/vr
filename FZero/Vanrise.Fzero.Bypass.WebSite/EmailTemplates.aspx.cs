...
public partial class EmailTemplates : BasePage
{
    ...
    {
        ((MasterPage)Master).PageHeaderTitle = Resources.Resources.EmailTemplates;
        lblSectionName.Text = Resources.Resources.EditEmailTemplate;
        ...
        gvEmailTemplates.Columns[0].HeaderText = Resources.Resources.Name;
        gvEmailTemplates.Columns[1].HeaderText = Resources.Resources.IsActive;
    ...
    {
        if (!CurrentUser.HasPermission(Enums.SystemPermissions.ViewEmailTemplates))
            PreviousPageRedirect();


        gvEmailTemplates.Columns[gvEmailTemplates.Columns.Count - 1].Visible = CurrentUser.HasPermission(Enums.SystemPermissions.EditEmailTemplate);
    }
    #endregion
