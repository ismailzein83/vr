                                                            ...
                                                            <fieldset style="float: left; border: 1px dotted #7B1126">
                                                                ...
                                                                <table cellpadding="2" cellspacing="2" style="width: 300px">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="caption">
                                                                            <asp:Label ID="lblIncludeInCompare" runat="server" Text="Include In Compare:"></asp:Label>
                                                                        </td>

                                                                        <td style="padding-right: 15px;" align="right">

                                                                            <asp:CheckBox ID="chkIncludeInCompareItemTemplate" runat="server" Checked='<%# Eval("IncludeInCompare") %>'
                                                        ...
                                                        <table cellpadding="2" cellspacing="2" style="width: 900px">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <asp:CheckBox ID="chkIncludeInCompare" runat="server"></asp:CheckBox>
