                                                        ...
                                                        <telerik:RadGrid ID="gvImportedCalls" runat="server"
                                                            ...
                                                            <MasterTableView>
                                                                <Columns>
                                                                    ...
                                                                    <telerik:GridBoundColumn DataField="Reference" UniqueName="Reference" />
                                                                    <telerik:GridBoundColumn DataField="Duration In Seconds" UniqueName="DurationInSeconds" />
                                                                    ...
                                                                    <telerik:GridBoundColumn DataField="Origination Network" UniqueName="OriginationNetwork" />
                                                                    <telerik:GridBoundColumn DataField="Carrier" UniqueName="Carrier" />
                                                                    <telerik:GridBoundColumn DataField="Attempt Date Time" UniqueName="AttemptDateTime" DataFormatString="{0:dd/MM/yyyy HH:mm:ss}" />
                                                                </Columns>
                                                            </MasterTableView>
                                                        </telerik:RadGrid>
