...
public partial class DefaultMobileOperator : BasePage
{
    #region Methods
    ...
    {
        ddlMobileOperators.Items.Add(new RadComboBoxItem(Resources.Resources.AllDashes, "0"));
        ...
        ddlMobileOperators.Items.FindItemByValue("1").Selected = true;
    }
    ...
    private void Populate()
    {
        ...
        {
            case 2:
                List<Vanrise.Fzero.Bypass.prGetTimeActiveonNetwork_Result> lstView_TimeActiveonNetwork = Vanrise.Fzero.Bypass.prGetTimeActiveonNetwork_Result.prGetTimeActiveonNetwork(0, (ddlMobileOperators.SelectedValue.ToInt() == 0 ? 1 : ddlMobileOperators.SelectedValue.ToInt()), fromDateTime, toDateTime);
    ...
    {
        Dashboard.GetDashboard(0, (ddlMobileOperators.SelectedValue.ToInt() == 0 ? 1 : ddlMobileOperators.SelectedValue.ToInt()), fromDateTime, toDateTime,true);
    ...
    protected void gvOnnetFraudGeneratedCalls_NeedDataSource(object source, Telerik.Web.UI.GridNeedDataSourceEventArgs e)
    {
        if (rtsMain.SelectedIndex == 3)
        {
            ...
            gvOnnetFraudGeneratedCalls.VirtualItemCount = Vanrise.Fzero.Bypass.GeneratedCall.GetFraudCases_LoadonDemand_Count(0, (ddlMobileOperators.SelectedValue.ToInt() == 0 ? 1 : ddlMobileOperators.SelectedValue.ToInt()), fromDateTime, toDateTime, 1, true, 0, gvOnnetFraudGeneratedCalls.CurrentPageIndex + 1, gvOnnetFraudGeneratedCalls.PageSize);
            gvOnnetFraudGeneratedCalls.DataSource = Vanrise.Fzero.Bypass.GeneratedCall.GetFraudCases_LoadonDemand(0, (ddlMobileOperators.SelectedValue.ToInt() == 0 ? 1 : ddlMobileOperators.SelectedValue.ToInt()), fromDateTime, toDateTime, 1, true, 0, gvOnnetFraudGeneratedCalls.CurrentPageIndex + 1, gvOnnetFraudGeneratedCalls.PageSize);
        }
    }
    ...
    protected void gvOfnetFraudGeneratedCalls_NeedDataSource(object source, Telerik.Web.UI.GridNeedDataSourceEventArgs e)
    {
        ...
        {
            int MobileOperator = CurrentUser.MobileOperatorID;
            gvOfnetFraudGeneratedCalls.VirtualItemCount = Vanrise.Fzero.Bypass.GeneratedCall.GetFraudCases_LoadonDemand_Count(0, (ddlMobileOperators.SelectedValue.ToInt() == 0 ? 1 : ddlMobileOperators.SelectedValue.ToInt()), fromDateTime, toDateTime, 2, true, 0, gvOfnetFraudGeneratedCalls.CurrentPageIndex + 1, gvOfnetFraudGeneratedCalls.PageSize);
            gvOfnetFraudGeneratedCalls.DataSource = Vanrise.Fzero.Bypass.GeneratedCall.GetFraudCases_LoadonDemand(0, (ddlMobileOperators.SelectedValue.ToInt() == 0 ? 1 : ddlMobileOperators.SelectedValue.ToInt()), fromDateTime, toDateTime, 2, true, 0, gvOfnetFraudGeneratedCalls.CurrentPageIndex + 1, gvOfnetFraudGeneratedCalls.PageSize);
        }
    }
    ...
    protected void gvAllGeneratedCalls_NeedDataSource(object source, Telerik.Web.UI.GridNeedDataSourceEventArgs e)
    {
        ...
        {
            gvAllGeneratedCalls.VirtualItemCount = Vanrise.Fzero.Bypass.GeneratedCall.GetAllCases_LoadonDemand_Count(0, (ddlMobileOperators.SelectedValue.ToInt() == 0 ? 1 : ddlMobileOperators.SelectedValue.ToInt()), fromDateTime, toDateTime,  true, 0, gvAllGeneratedCalls.CurrentPageIndex + 1, gvAllGeneratedCalls.PageSize);
            gvAllGeneratedCalls.DataSource = Vanrise.Fzero.Bypass.GeneratedCall.GetAllCases_LoadonDemand(0, (ddlMobileOperators.SelectedValue.ToInt() == 0 ? 1 : ddlMobileOperators.SelectedValue.ToInt()), fromDateTime, toDateTime,  true, 0, gvAllGeneratedCalls.CurrentPageIndex + 1, gvAllGeneratedCalls.PageSize);
        }
    }
    ...
    protected void ddlMobileOperators_SelectedIndexChanged(object sender, RadComboBoxSelectedIndexChangedEventArgs e)
    {
        Populate();
    }
