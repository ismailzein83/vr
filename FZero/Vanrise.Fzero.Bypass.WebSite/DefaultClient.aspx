<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DefaultClient.aspx.cs" Inherits="DefaultClient" %>
                                ...
                                <div class="span12">
                                    <div class="widget blue">
                                        ...
                                        <div class="widget-body" style="display: block;">
                                            ...
                                            <telerik:RadComboBox ID="ddlClients" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlClients_SelectedIndexChanged"></telerik:RadComboBox>
                        ...
                        <div class="widget blue">
                            ...
                            <div class="widget-body" style="display: block;">
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0" style="border-style: solid; border-width: 1px; border-right-color: #3D556C; border-bottom-color: #3D556C; border-left-color: #3D556C; border-top-color: #3D556C">
                                    ...
                                    <tr>
                                        <td style="vertical-align: top; width: 100%">
                                            <telerik:RadGrid AllowSorting="true" ID="gvClientSummary" runat="server" CellSpacing="0" BorderColor="White"
                                                AutoGenerateColumns="False" OnNeedDataSource="gvClientSummary_NeedDataSource" ClientSettings-Scrolling-AllowScroll="true" Height="120">
                                                ...
                                                <MasterTableView>
                                                    <Columns>
                                                        <telerik:GridBoundColumn DataField="FullName" UniqueName="FullName" HeaderText="Network" HeaderStyle-Width="80" />
                                                        <telerik:GridBoundColumn DataField="Attempts" UniqueName="Attempts" HeaderText="Attempts" DataFormatString="{0:#,##0}" />
                                                        <telerik:GridBoundColumn DataField="Bypass" UniqueName="Bypass" HeaderText="Bypass" DataFormatString="{0:#,##0}" />
                                                        <telerik:GridBoundColumn DataField="DistinctCLI" UniqueName="DistinctCLI" HeaderText="Distinct" DataFormatString="{0:#,##0}" />
                                                    </Columns>
                                                </MasterTableView>
                                            </telerik:RadGrid>
                                        </td>
