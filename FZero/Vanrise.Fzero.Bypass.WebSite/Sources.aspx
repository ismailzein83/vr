                            ...
                            <td>
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td></td>
                                        <td>
                                            <telerik:RadComboBox ID="ddlGMTs" runat="server"></telerik:RadComboBox>
                                            <asp:RequiredFieldValidator CssClass="error" ID="rfvMobileNumber" runat="server" ControlToValidate="ddlGMTs" ErrorMessage="GMT should not be empty " ValidationGroup="Save"></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <asp:RequiredFieldValidator CssClass="error" ID="rfvTypes" runat="server" ControlToValidate="ddlTypes" ErrorMessage="Type should not be empty " ValidationGroup="Save"></asp:RequiredFieldValidator>
