...
{
    public class AddPublicDIManager
    {
        ...
        public void PostToOM(Guid requestId)
        {
            ...
            esq = new EntitySchemaQuery(BPM_UserConnection.EntitySchemaManager, "StAddPublicDI");
            ...
            if (entities.Count > 0)
            {
                ...
                {
                    output = client.Post<SOMRequestInput<AddPublicDIInput>, SOMRequestOutput>("api/DynamicBusinessProcess_BP/AddContractToPublicDirectoryInquiry/StartProcess", somRequestInput);
                }
