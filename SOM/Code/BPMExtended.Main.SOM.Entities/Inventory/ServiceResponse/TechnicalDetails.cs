...
namespace BPMExtended.Main.SOMAPI
{
    ...
    public class TechnicalDetails
    {
        ...
        public string MDFPortStatus { get; set; }
        public string DPPort { get; set; }
        public string DPPortStatus { get; set; }

        public string MUXPortName { get; set; }
        public string MUXPortStatus { get; set; }

        public string TransmitterStatus { get; set; }
        public string TransmitterModule { get; set; }

        public string ReceiverStatus { get; set; }
        public string ReceiverPortStatus { get; set; }
        public string TransmitterPortStatus { get; set; }
