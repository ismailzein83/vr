...
namespace CP.SupplierPricelist.Data
{
    public interface IPriceListDataManager : IDataManager
    {
        ...
        Vanrise.Entities.BigResult<Entities.PriceList> GetPriceListsFilteredFromTemp(Vanrise.Entities.DataRetrievalInput<Entities.PriceListQuery> input , int userId);
