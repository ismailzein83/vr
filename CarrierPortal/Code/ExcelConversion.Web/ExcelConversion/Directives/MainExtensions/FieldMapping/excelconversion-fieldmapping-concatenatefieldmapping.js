(function (app) {
            ...
            function defineAPI() {
                ...
                api.load = function (payload) {
                    ...
                    function getFieldMappingTemplateConfigs() {
                        return ExcelConversion_ExcelAPIService.GetConcatenatedPartTemplateConfigs().then(function (response) {
    ...
    app.directive('excelconversionFieldmappingConcatenatefieldmapping', concatenatedpartSelective);
