...
CREATE PROCEDURE [dbo].[FillFactCallsHourly]
...
select 
 ...
 group by  DATEADD(hour, DATEDIFF(hour, 0, connectdatetime), 0)


/*

FillFactCallsHourly @FromDate ='03/14/2015',@ToDate ='03/15/2015' ,@periodId=1
select  * from Fact_Calls
