...
namespace Vanrise.Fzero.FraudAnalysis.Entities
{
    public class NumberProfile
    {
         ...
         public int?      Diff_Dest_net { get; set; }
         public int?      Diff_Sources_net { get; set; }
         public int?      Total_BTS_In { get; set; }
         public int?      Total_BTS_Out { get; set; }
         public int?      Count_Out_SMS { get; set; }
         public int?      Count_In_SMS { get; set; }
