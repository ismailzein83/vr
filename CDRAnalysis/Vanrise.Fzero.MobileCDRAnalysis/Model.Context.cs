...
namespace Vanrise.Fzero.MobileCDRAnalysis
{
    ...
    public partial class Entities : DbContext
    {
        ...
        public virtual int sp_GetSuspiciousNumbers(Nullable<System.DateTime> fromDate, Nullable<System.DateTime> toDate, Nullable<int> strategyId, string suspectionList, Nullable<int> minimumOccurance)
        {
            var fromDateParameter = fromDate.HasValue ?
                new ObjectParameter("fromDate", fromDate) :
                new ObjectParameter("fromDate", typeof(System.DateTime));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_GetSuspiciousNumbers", fromDateParameter, toDateParameter, strategyIdParameter, suspectionListParameter, minimumOccuranceParameter);
        }
    }
}
