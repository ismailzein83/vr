...
namespace Vanrise.Fzero.MobileCDRAnalysis
{
    public partial class User
    {
        ...
        public static List<User> GetAllUsers()
        {
            ...
            {
                FileLogger.Write("Error in Vanrise.Fzero.MobileCDRAnalysis.User.GetAllUsers()", err);
            }
        ...
        public static User GetUser(string username, string password)
        {
            ...
            {
                FileLogger.Write("Error in Vanrise.Fzero.MobileCDRAnalysis.User.GetUser(" + username + ")", err);
            }
            return null;
        }
        ...
        public static User Load(int ID)
        {
            ...
            {
                FileLogger.Write("Error in Vanrise.Fzero.MobileCDRAnalysis.User.Load(" + ID.ToString() + ")", err);
            }
            return user;
        }
        ...
        public static int Save(User user)
        {
            ...
            {
                FileLogger.Write("Error in Vanrise.Fzero.MobileCDRAnalysis.User.Save(" + user.ID.ToString() + ")", err);
            }
            return id;
        }
        ...
        public static bool Delete(User user)
        {
            ...
            {
                FileLogger.Write("Error in Vanrise.Fzero.MobileCDRAnalysis.User.Delete(" + user.ID.ToString() + ")", err);
            }
            return success;
        }
        ...
        public static bool SaveLastLoginTime(User user)
        {
            ...
            {
                FileLogger.Write("Error in Vanrise.Fzero.MobileCDRAnalysis.User.SaveLastLoginTime(" + user.ID.ToString() + ")", err);
            }
            return success;
        }
        ...
        public static bool IsUserNameExists(string userName)
        {
            ...
            {
                FileLogger.Write("Error in Vanrise.Fzero.MobileCDRAnalysis.User.IsUsernameExists(" + userName + ")", err);
            }
            return exists;
        }
        ...
        public static string GetUserName(int ID)
        {
            ...
            {
                FileLogger.Write("Error in Vanrise.Fzero.MobileCDRAnalysis.User.GetUserName()", err);
            }
            return UserName;
        }
        ...
        public static bool ResetPassword(int userId, string password)
        {
            ...
            {
                FileLogger.Write("Error in Vanrise.Fzero.MobileCDRAnalysis.User.ResetPassword(" + userId.ToString() + ")", err);
            }
            return success;
        ...
        public static bool TruePassword(int userId, string password)
        {
            ...
            {
                FileLogger.Write("Error in Vanrise.Fzero.MobileCDRAnalysis.User.TruePassword(" + userId.ToString() + ")", err);
            }
            return success;
