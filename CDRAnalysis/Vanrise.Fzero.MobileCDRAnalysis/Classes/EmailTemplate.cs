...
namespace Vanrise.Fzero.MobileCDRAnalysis
{
    public partial class EmailTemplate
    {
        public static EmailTemplate Load(int ID)
        {
            ...
            {
                FileLogger.Write("Error in Vanrise.Fzero.MobileCDRAnalysis.EmailTemplate.Load(" + ID.ToString() + ")", err);
            }
        ...
        public static List<EmailTemplate> GetEmailTemplates(string name, bool? isActive)
        {
            ...
            {
                FileLogger.Write("Error in Vanrise.Fzero.MobileCDRAnalysis.EmailTemplate.GetEmailTemplates(" + name + ", " + isActive.ToString() + ")", err);
            }
        ...
        public static List<EmailTemplate> GetEmailTemplates()
        {
            ...
            {
                FileLogger.Write("Error in Vanrise.Fzero.MobileCDRAnalysis.EmailTemplate.GetEmailTemplates()", err);
            }
        ...
        public static bool Save(EmailTemplate EmailTemplate)
        {
            ...
            {
                FileLogger.Write("Error in Vanrise.Fzero.MobileCDRAnalysis.EmailTemplate.Save(" + EmailTemplate.ID.ToString() + ")", err);
            }
            return success;
        }
    }
