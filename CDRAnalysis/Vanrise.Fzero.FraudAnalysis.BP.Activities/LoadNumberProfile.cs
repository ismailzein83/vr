...
namespace Vanrise.Fzero.FraudAnalysis.BP.Activities
{
    ...
    public class LoadNumberProfiles : BaseAsyncActivity<LoadNumberProfilesInput>
    {
        ...
        [RequiredArgument]
        public  InArgument<BaseQueue<NumberProfileBatch>> OutputQueue { get; set; }
        ...
        protected override void DoWork(LoadNumberProfilesInput inputArgument, AsyncActivityHandle handle)
        {
           ...
           //new NumberProfileDataManager().LoadNumberProfile(DateTime.Now.AddHours(-1), DateTime.Now, BatchSize, null);
