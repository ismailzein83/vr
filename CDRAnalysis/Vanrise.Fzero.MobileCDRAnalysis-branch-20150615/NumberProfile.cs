...
namespace Vanrise.Fzero.MobileCDRAnalysis
{
    ...
    public partial class NumberProfile
    {
        ...
        public Nullable<decimal> Count_Out_Calls { get; set; }
        public Nullable<decimal> Diff_Output_Numb { get; set; }
        public Nullable<decimal> Count_Out_Inter { get; set; }
        public Nullable<decimal> Count_In_Inter { get; set; }
        public Nullable<decimal> InCalls_Vs_OutCalls { get; set; }
        public Nullable<decimal> DiffDest_Vs_OutCalls { get; set; }
        public Nullable<decimal> OutInter_Vs_OutCalls { get; set; }
