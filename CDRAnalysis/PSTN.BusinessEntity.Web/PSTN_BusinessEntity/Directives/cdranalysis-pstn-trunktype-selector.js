'use strict';
app.directive('cdranalysisPstnTrunktypeSelector', ['TrunkTypeEnum' ,'UtilsService', 'VRUIUtilsService',
    function (TrunkTypeEnum, UtilsService, VRUIUtilsService) {
        ...
        function TypeSelector(ctrl, $scope, attrs) {
            ...
            var selectorAPI;
            ctrl.datasource = UtilsService.getArrayEnum(TrunkTypeEnum);
