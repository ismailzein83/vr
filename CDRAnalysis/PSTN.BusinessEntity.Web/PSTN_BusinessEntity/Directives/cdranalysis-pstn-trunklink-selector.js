'use strict';
app.directive('cdranalysisPstnTrunklinkSelector', ['LinkedToTrunkEnum', 'UtilsService', 'VRUIUtilsService',
    function (LinkedToTrunkEnum, UtilsService, VRUIUtilsService) {
        ...
        var directiveDefinitionObject = {
            ...
            controller: function ($scope, $element, $attrs) {
                ...
                var selector = new LinkSelector(ctrl, $scope, $attrs);
        ...
        function getTypeTemplate(attrs) {
            ...
            var label = "Linked-To Trunk";
            if (attrs.ismultipleselection != undefined) {
                label = "Linked-To Trunks";
        ...
        function LinkSelector(ctrl, $scope, attrs) {

            var selectorAPI;
            ctrl.datasource = UtilsService.getArrayEnum(LinkedToTrunkEnum);
