BPTaskTestEditorController.$inject = ['$scope', 'VRNavigationService', 'VRNotificationService', 'BusinessProcess_BPTaskAPIService'];

function BPTaskTestEditorController($scope, VRNavigationService, VRNotificationService, BusinessProcess_BPTaskAPIService) {
    var bpTaskId;
...
appControllers.controller('BusinessProcess_BPTaskTestEditorController', BPTaskTestEditorController);
