(function (appControllers) {
    ...
    GetBusinessEntityEditorController.$inject = ['$scope', 'VRNavigationService', 'VRNotificationService', 'UtilsService', 'VRUIUtilsService'];

    function GetBusinessEntityEditorController($scope, VRNavigationService, VRNotificationService, UtilsService, VRUIUtilsService) {
        ...
        function loadAllControls() {
            var promises = [];
            function setTitle() {
                $scope.title = "Edit Get Business Object";
            }
            ...
            function loadBusinessEntityDefinitionSelector() {
                ...
                beDefinitionSelectorPromiseDeferred.promise.then(function () {
                    var payloadSelector = {
                        filter: {
                            Filters: [{
                                $type: "Vanrise.GenericData.Business.WorkflowGetBEActivityFilter, Vanrise.GenericData.Business"
                            }]
                        },
    ...
    appControllers.controller('BusinessProcess_VR_WorkflowActivityGetBusinessEntityController', GetBusinessEntityEditorController);
})(appControllers);