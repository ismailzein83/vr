    ...
    function (BusinessProcess_BPDefinitionAPIService, UtilsService, VRUIUtilsService) {
        ...
        function getBPDefinitionTemplate(attrs) {
            ...
            return '<div>'
                ...
                + ' label="' + label + '" ' + addCliked + ' datasource="ctrl.datasource" selectedvalues="ctrl.selectedvalues" vr-disabled="ctrl.isdisabled" onselectionchanged="ctrl.onselectionchanged" entityName="BPDefinition" onselectitem="ctrl.onselectitem" ondeselectitem="ctrl.ondeselectitem"></vr-select>'
                + '</div>'
        }
