...
namespace Vanrise.BusinessProcess.Web.Controllers
{
    ...
    public class VRWorkflowController : BaseAPIController
    {
        ...
        [HttpPost]
        [Route("TryCompileWorkflowClassMembers")]
        public VRWorkflowClassMembersCompilationOutput TryCompileWorkflowClassMembers(VRWorkflow vrWorkflow)
        {
            return _manager.TryCompileWorkflowClassMembers(vrWorkflow);
        }
