...
--
CREATE PROCEDURE [dbo].[bp_UpdateRoutesFromRouteBlocks_New]
	@Check char(1) = 'Y',
	@RouteBuildProcess char(1) = 'N'
AS
...
--Select 	GETDATE(),' Supplier Zone Blocks: All Customers '
--If @RouteBuildProcess='Y'
--	UPDATE [RouteOption] SET State = 0
...
Select 	GETDATE(),' Supplier Zone Blocks: Specific Customers '
...
Select 	GETDATE(),' Block Route Options matching other criteria On code and subcode'
...
Select 	GETDATE(),' Block Route Options matching other criteria On code only'
