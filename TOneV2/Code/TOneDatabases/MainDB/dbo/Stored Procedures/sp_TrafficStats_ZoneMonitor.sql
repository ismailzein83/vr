            ...
            (
                ...
                SELECT
                       ...
                       ---- ASR
                        ...
                        and @SupplierID IS null and Sum(DeliveredAttempts) > 0  )   
                        THEN
                        ...
                        --CCR
                        CASE WHEN ((@ShowSupplier='N' or @ShowE1 != 'N' OR @GroupByGateWay !='N') and @SupplierID IS null)   THEN
                       ...
                       Case when (Sum(Attempts)-SUM(Case When Supplierid is null then 1 Else 0 End))>0
                        ...
                        ----ABR
                            CASE WHEN ((@ShowSupplier='N' or @ShowE1 != 'N' OR @GroupByGateWay !='N')  and @SupplierID IS null and Sum(Attempts)>0)    THEN
                        ...
                        --NER
                        CASE WHEN (@ShowSupplier='N' or @ShowE1 != 'N' OR @GroupByGateWay !='N')  
                        and (Sum(Attempts)-SUM(Case When Supplierid is null then 1 Else 0 End))>0 
