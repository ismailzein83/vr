...
Declare @Traffic TABLE (ZoneID int, Attempts int, DurationsInMinutes NUMERIC(19,6), SuccessfulAttempts NUMERIC(19,6) ,ASR numeric(13,5), ACD numeric(13,5), DeliveredASR numeric(13,5), AveragePDD numeric(13,5))
SET NOCOUNT ON 	
...
DECLARE @Result TABLE (
		ZoneID int,Attempts int, AttemptPercentage DECIMAL(13,5), DurationsInMinutes  NUMERIC(19,6), SuccessfulAttempts NUMERIC(19,6),ASR numeric(13,5), ACD numeric(13,5), DeliveredASR numeric(13,5), AveragePDD numeric(13,5),
		NumberOfCalls int,Cost_Nets float, Sale_Nets float,Profit NUMERIC(19,6),AverageSaleRate NUMERIC(13,5),AverageCostRate NUMERIC(13,5),Percentage numeric (13,5) , PricedDuration  DECIMAL(13,5)
		)
begin
...
INSERT INTO @Result(ZoneID ,Attempts, DurationsInMinutes,SuccessfulAttempts, ASR, ACD, DeliveredASR, AveragePDD, NumberOfCalls, Cost_Nets, Sale_Nets, Profit, AverageSaleRate,AverageCostRate,Percentage, PricedDuration)
	SELECT 
