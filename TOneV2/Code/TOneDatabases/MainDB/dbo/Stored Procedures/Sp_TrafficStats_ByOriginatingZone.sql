...
AS
    ...
    Declare @Results TABLE (Originating int, Attempts bigint, SuccessfulAttempts bigint, DeliveredAttempts bigint, DurationsInMinutes numeric(13,5), ASR numeric(13,5), ACD numeric(13,5),DeliveredASR numeric(13,5), AveragePDD numeric(13,5), MaxDuration numeric(13,5), LastAttempt datetime,OurZone int,Percentage numeric(13,5))
    ...
    IF @CustomerID IS NULL AND @SupplierID IS NULL
        BEGIN
        INSERT INTO @Results  
                (Originating , Attempts, SuccessfulAttempts, DeliveredAttempts, DurationsInMinutes, ASR, ACD, DeliveredASR, AveragePDD, MaxDuration, LastAttempt,OurZone ,Percentage)
