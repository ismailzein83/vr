...
-- =============================================
CREATE PROCEDURE [LCR].[sp_ZoneRate_ApplyEffectiveRates]
AS
BEGIN
	...
	UPDATE zr
	SET NormalRate = (r.Rate/ C.LastRate) +
	...
	LEFT JOIN Commission Co WITH(NOLOCK) ON P.SupplierID = Co.SupplierID	AND P.CustomerID = Co.CustomerID AND r.ZoneID = Co.ZoneID and r.Rate between co.FromRate and co.ToRate	
