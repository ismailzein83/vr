(function (appControllers) {
    ...
    function rpRouteManagementController($scope, UtilsService, VRUIUtilsService, VRNotificationService, WhS_Routing_RoutingProductFilterEnum, WhS_Routing_RouteFilterEnum, VRCommon_EntityFilterEffectiveModeEnum, WhS_Routing_RoutingDatabaseTypeEnum) {
                    ...
                    return {
                        ...
                        getChildNode: function () {
                            ...
                            return {
                                ...
                                getChildNode: function () {
                                    var loadStaticDataPromise = UtilsService.waitMultipleAsyncOperations([loadRoutingDatabaseSelector, loadStaticData, loadRoutingProductFilters, loadSingleRoutingProductSelector, loadMultipleRoutingProductSelector, loadSaleZoneSection, loadRouteStatusSelector]);
                                    return {
                                        promises: [loadCustomerSelector()],
                                        getChildeNode: function () {
                                            return {
                ...
                if (filterSettingsData != undefined) {
                    ...
                    if (filterSettingsData.SellingNumberPlanId != undefined) {
                        if (payload == undefined)
                            payload = {};
                        payload.filter = { SellingNumberPlanId: filterSettingsData.SellingNumberPlanId };
                    }
                }
        ...
        var onSellingNumberPlanSelectionchanged = function (selectedSellingNumberPlan) {

            if (!enableSNPSelctionChanged) {
                enableSNPSelctionChanged = true;
                return;
            }
            ...
            if (sellingNumberPlanId != undefined)
                customerSelectorPayload = { filter: { SellingNumberPlanId: sellingNumberPlanId } };

            var setLoader = function (value) {
                $scope.isLoadingCustomerSelector = value;
            };
            VRUIUtilsService.callDirectiveLoadOrResolvePromise($scope, customerSelectorAPI, customerSelectorPayload, setLoader, undefined);
        };
