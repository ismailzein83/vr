app.constant('WhS_Routing_OrderTypeEnum', {
    Percentage: { value: 0, description: "Percentage Order", hasCheckValidation: true, from: 2, showPercentageColumn: true, showPercentageSettings: true },
    Sequential: { value: 1, description: "Sequential Order", hasCheckValidation: false, from: 2, showPercentageColumn: false, showPercentageSettings: true },
