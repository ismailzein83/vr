'use strict';
app.directive('vrWhsRoutingRouterulesettingsExcluded', ['UtilsService', 'VRUIUtilsService',
    function (UtilsService, VRUIUtilsService) {
        ...
        var directiveDefinitionObject = {
            ...
            templateUrl: function (element, attrs) {
                return '/Client/Modules/WhS_Routing/Directives/Extensions/RouteRuleSettings/Option/Templates/ExcludedOptionDirective.html';
            }
        ...
        function selectiveOptionCtor(ctrl, $scope) {
            ...
            function defineAPI() {
                ...
                api.getData = function () {
                    return {
                        $type: "TOne.WhS.Routing.Business.RouteRules.OptionSettingsGroups.ExcludedOptions, TOne.WhS.Routing.Business",
                        Options: getOptions()
                    };
