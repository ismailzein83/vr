...
app.directive('whsRoutingActiondefinitionBlockoriginationnumber', ['UtilsService', 'VRUIUtilsService', function (UtilsService, VRUIUtilsService) {
    return {
        restrict: "E",
        scope: {
            onReady: "=",
        ...
        templateUrl: "/Client/Modules/WhS_Routing/Directives/Extensions/Actions/BlockOriginationNumber/Templates/BlockOriginationNumberActionDefinition.html"
    };
    ...
    function BlockOriginationNumberActionDefinition($scope, ctrl, $attrs) {
        ...
        function defineAPI() {
            ...
            api.getData = function () {
                return {
                    $type: 'TOne.WhS.Routing.MainExtensions.VRActions.BlockOriginationNumberDefinitionSettings, TOne.WhS.Routing.MainExtensions',
