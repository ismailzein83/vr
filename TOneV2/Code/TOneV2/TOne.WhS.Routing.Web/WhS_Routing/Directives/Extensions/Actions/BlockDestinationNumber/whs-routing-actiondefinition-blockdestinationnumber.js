...
app.directive('whsRoutingActiondefinitionBlockdestinationnumber', ['UtilsService', 'VRUIUtilsService', function (UtilsService, VRUIUtilsService) {
    return {
        restrict: "E",
        scope: {
            onReady: "=",
        ...
        templateUrl: "/Client/Modules/WhS_Routing/Directives/Extensions/Actions/BlockDestinationNumber/Templates/BlockDestinationNumberActionDefinition.html"
    };
    ...
    function BlockDestinationNumberActionDefinition($scope, ctrl, $attrs) {
        ...
        function defineAPI() {
            ...
            api.getData = function () {
                return {
                    $type: 'TOne.WhS.Routing.MainExtensions.VRActions.BlockDestinationNumberDefinitionSettings, TOne.WhS.Routing.MainExtensions',
