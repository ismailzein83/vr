    ...
    public class DailySummaryReportGenerator : IReportGenerator
    {
        public Dictionary<string, System.Collections.IEnumerable> GenerateDataSources(ReportParameters parameters)
        {
            ...
            foreach (var analyticRecord in result.Data)
            {
                ...
                dailySummary.SaleNetFormatted = dailySummary.SaleNet == 0 ? "" : (dailySummary.SaleNet.HasValue) ?ReportHelpers.FormatNumberDigitRate(dailySummary.SaleNet) : "0.00";
                ...
                dailySummary.CostNetFormatted = (dailySummary.CostNet.HasValue)? ReportHelpers.FormatNumberDigitRate(dailySummary.CostNet): "0.00";
