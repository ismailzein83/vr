    ...
    public partial class CarrierProfie : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                List<CarrierProfileReport> carrierProfile1 = manager.GetCarrierProfileMTDAndMTA(DateTime.Parse("2012-06-01 00:00:00"), DateTime.Parse("2015-06-01 00:00:00"), "C060", false , "USD");
