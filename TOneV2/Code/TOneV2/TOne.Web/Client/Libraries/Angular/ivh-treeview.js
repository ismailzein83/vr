...
angular.module('ivh.treeview').provider('ivhTreeviewOptions', function() {
  ...
  var options = {
     ...
     */
    twistieExpandedTpl: '<span class="glyphicon glyphicon-minus hand-cursor" style="font-size:9px;top: -2px;"></span>',

    /**
     * Template for collapsed twisties
     */
    twistieCollapsedTpl: '<span class="glyphicon glyphicon-plus hand-cursor" style="font-size:9px;top: -2px;"></span>',
