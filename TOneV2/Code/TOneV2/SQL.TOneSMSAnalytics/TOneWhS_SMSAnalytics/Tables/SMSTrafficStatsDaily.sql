CREATE TABLE [TOneWhS_SMSAnalytics].[SMSTrafficStatsDaily] (
    [Id]                           BIGINT           NULL,
    ...
    [Type]                         INT              NULL,
    CONSTRAINT [IX_SMSTrafficStatsDaily_Id] UNIQUE NONCLUSTERED ([Id] ASC)
);


GO
CREATE CLUSTERED INDEX [IX_SMSTrafficStatsDaily_BatchStart]
    ON [TOneWhS_SMSAnalytics].[SMSTrafficStatsDaily]([BatchStart] ASC);
