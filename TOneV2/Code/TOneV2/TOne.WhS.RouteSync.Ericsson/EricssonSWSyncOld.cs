...
//        private List<BRWithRouteCaseOptions> GetRouteCaseOptionsX(Route route, int codeGroupId, string routeCodeGroup, RuleTree ruleTree)
//        {
...
//                    var firstSupplierId = route.Options.First().SupplierId;
...
//                                    continue;
//                                if (trunk.IsSwitch && branchRoute.OverflowOnFirstOptionOnly && (!option.SupplierId.Equals(firstSupplierId) || trunkGroup.IsBackup))
//                                    continue;
...
//                                ReevaluatePercentageDistribution(optionRouteCaseOptions, option.Percentage.Value);
...
//                                        if (trunk.IsSwitch && !branchRoute.IncludeTrunkAsSwitch)
//                                            continue;
//                                        if (trunk.IsSwitch && branchRoute.OverflowOnFirstOptionOnly && (!option.SupplierId.Equals(firstSupplierId) || backupTrunkGroup.IsBackup))
//                                            continue;
...
//                routeCaseOptionsWithBranchRoutes = BranchRouteSettings.GetMergedBranchRoutesWithRouteCaseOptionsList(new GetMergedBranchRoutesWithRouteCaseOptionsContext() { RouteCaseOptions = new List<RouteCaseOption>() { Helper.GetBlockedRouteCaseOption() } });
...
//            var routeCaseOptionsWithBranchRoutes = BranchRouteSettings.GetMergedBranchRoutesWithRouteCaseOptionsList(new GetMergedBranchRoutesWithRouteCaseOptionsContext() { RouteCaseOptions = routeCaseOptions });
//            if (routeCaseOptionsWithBranchRoutes == null || routeCaseOptionsWithBranchRoutes.Count == 0)
//                routeCaseOptionsWithBranchRoutes = BranchRouteSettings.GetMergedBranchRoutesWithRouteCaseOptionsList(new GetMergedBranchRoutesWithRouteCaseOptionsContext() { RouteCaseOptions = new List<RouteCaseOption>() { Helper.GetBlockedRouteCaseOption() } });
...
//            var branchRouteWithRouteCaseOptionsList = Helper.DeserializeBRWithRouteCaseOptionsList(routeCase.RouteCaseAsString);
//            //var options = Helper.DeserializeRouteCaseOptions(routeCase.RouteCaseOptionsAsString);
//            var options = branchRouteWithRouteCaseOptionsList.First().RouteCaseOptions;
...
//            var routeCase = routeCases.FindRecord(item => item.RCNumber == route.RCNumber);
//            var deserializedRouteCase = Helper.DeserializeBRWithRouteCaseOptionsList(routeCase.RouteCaseAsString);
//            //var options = Helper.DeserializeRouteCaseOptions(routeCase.RouteCaseOptionsAsString);
//            var options = deserializedRouteCase.First().RouteCaseOptions;
