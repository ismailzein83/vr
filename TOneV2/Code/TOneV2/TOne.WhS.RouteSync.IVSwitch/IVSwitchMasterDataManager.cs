...
namespace TOne.WhS.RouteSync.IVSwitch
{
    public class IVSwitchMasterDataManager : BasePostgresDataManager
    {
        ...
        private string GetCustomerQuery(List<int> stateIds)
        {
            ...
            string query = $@"SELECT distinct u.type_id,u2.group_id,u2.account_id,u.table_name,al.route_table_id,al.tariff_id,al.user_id from user_types u
                        ...
                        where route_table_id is not null and tariff_id is not null {stateCondition}";
            return query;
        }
        ...
        public List<AccessListTable> GetAccessListTables(List<int> stateIds)
        {
            string query = GetCustomerQuery(stateIds);
