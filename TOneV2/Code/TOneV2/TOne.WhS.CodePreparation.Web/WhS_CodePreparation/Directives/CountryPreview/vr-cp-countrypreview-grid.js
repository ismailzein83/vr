...
app.directive("vrCpCountrypreviewGrid", ["WhS_CP_CodePreparationPreviewAPIService", "VRUIUtilsService", "VRNotificationService",
function (WhS_CP_CodePreparationPreviewAPIService, VRUIUtilsService, VRNotificationService) {
    ...
    var directiveDefinitionObject = {
        ...
        templateUrl: "/Client/Modules/WhS_CodePreparation/Directives/CountryPreview/Templates/CodePreparationCountryPreviewGridTemplate.html"
    ...
    function CountryPreviewGrid($scope, ctrl, $attrs) {
        ...
        function initializeController() {
            ...
            $scope.dataRetrievalFunction = function (dataRetrievalInput, onResponseReady) {
                return WhS_CP_CodePreparationPreviewAPIService.GetFilteredCountryPreview(dataRetrievalInput)
        ...
        function getDirectiveTabs() {
            ...
            var directiveTab = {
                title: "Zones",
                directive: "vr-cp-zonepreview-grid",
