...
app.directive('vrCpViewchangetypeSelector', ['WhS_CP_PreviewChangeTypeEnum', 'UtilsService', 'VRUIUtilsService',
    function (WhS_CP_PreviewChangeTypeEnum, UtilsService, VRUIUtilsService) {
    ...
    function ViewChangeTypeSelector(ctrl, $scope, attrs) {
        ...
        function defineAPI() {
            ...
            api.load = function (payload) {
                ...
                ctrl.datasource = UtilsService.getArrayEnum(WhS_CP_PreviewChangeTypeEnum);
