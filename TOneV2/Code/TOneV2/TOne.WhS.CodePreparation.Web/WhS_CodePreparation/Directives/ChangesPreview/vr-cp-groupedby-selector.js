...
app.directive('vrCpGroupedbySelector', ['WhS_CP_PreviewGroupedBy', 'UtilsService', 'VRUIUtilsService',
    function (WhS_CP_PreviewGroupedBy, UtilsService, VRUIUtilsService) {
    ...
    function GroupBySelector(ctrl, $scope, attrs) {
        ...
        function defineAPI() {
            ...
            api.load = function (payload) {
                ...
                ctrl.datasource = UtilsService.getArrayEnum(WhS_CP_PreviewGroupedBy);
