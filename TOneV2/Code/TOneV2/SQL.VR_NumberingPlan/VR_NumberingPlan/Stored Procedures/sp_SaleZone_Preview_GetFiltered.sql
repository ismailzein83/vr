...
CREATE PROCEDURE  [VR_NumberingPlan].[sp_SaleZone_Preview_GetFiltered]
...
BEGIN
	...
	join VR_NumberingPlan.SaleCode_Preview as C  WITH(NOLOCK) on Z.ZoneName = C.ZoneName OR Z.ZoneName = C.RecentZoneName
