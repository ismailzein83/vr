...
create PROCEDURE  [VR_NumberingPlan].[sp_SaleCode_Preview_GetFiltered]
...
BEGIN
	...
	from VR_NumberingPlan.SaleCode_Preview as C WITH(NOLOCK) 
	Join VR_NumberingPlan.SaleZone_Preview as Z  WITH(NOLOCK) on C.ZoneName = Z.ZoneName AND Z.ProcessInstanceID= C.ProcessInstanceID
