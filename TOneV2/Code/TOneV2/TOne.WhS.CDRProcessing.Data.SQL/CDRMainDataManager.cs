...
namespace TOne.WhS.CDRProcessing.Data.SQL
{
    public class CDRMainDataManager : BaseSQLDataManager, ICDRMainDataManager
    {
        ...
        readonly string[] columns = { "ID", "CustomerID", "SupplierID", "Attempt", "DurationInSeconds", "Alert", "Connect", "Disconnect", "PortOut", "PortIn", "SaleCode", "SaleZoneID", "SupplierCode", "SupplierZoneID", "CDPN", "CGPN", "CostRateValue", "CostTotalNet", "CostCurrencyID", "SaleRateValue", "SaleTotalNet", "SaleCurrencyID", "ReleaseCode", "ReleaseSource" };
