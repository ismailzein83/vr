...
{
    class ChangedSaleRateDataManager : IChangedSaleRateDataManager
    {
        #region RDB
        static string TABLE_NAME = "TOneWhS_BE_CP_SaleRate_Changed";
        const string COL_ID = "ID";
        const string COL_ProcessInstanceID = "ProcessInstanceID";
        const string COL_EED = "EED";


        static ChangedSaleRateDataManager()
        {
            ...
            RDBSchemaManager.Current.RegisterDefaultTableDefinition(TABLE_NAME, new RDBTableDefinition
            {
                ...
                DBTableName = "CP_SaleRate_Changed",
                Columns = columns
            });
        }
        ...
        #region IChangedSaleRateDataManager
