...
{
    public class ChangedSaleZoneRoutingProductsDataManager : IChangedSaleZoneRoutingProductsDataManager
    {
        #region RDB
        ...
        static ChangedSaleZoneRoutingProductsDataManager()
        {
            ...
            RDBSchemaManager.Current.RegisterDefaultTableDefinition(TABLE_NAME, new RDBTableDefinition
            {
                ...
                DBTableName = "CP_SaleZoneRoutingProducts_Changed",
                Columns = columns
            });
        }
        ...
        #region IChangedSaleZoneRoutingProductsDataManager
