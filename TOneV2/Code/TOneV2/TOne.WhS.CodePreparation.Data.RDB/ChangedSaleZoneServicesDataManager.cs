...
{
    public class ChangedSaleZoneServicesDataManager : IChangedSaleZoneServicesDataManager //this datamanager is used in activities in ApplyEntityiesToDBProcess.xaml but was not tested because [TOneWhS_BE].[SaleEntityService] table is not used anymore
    {
        #region RDB
        static string TABLE_NAME = "TOneWhS_BE_CP_SaleZoneServices_Changed";
        const string COL_ID = "ID";
        internal const string COL_ProcessInstanceID = "ProcessInstanceID";
        const string COL_EED = "EED";


        static ChangedSaleZoneServicesDataManager()
        {
            ...
            RDBSchemaManager.Current.RegisterDefaultTableDefinition(TABLE_NAME, new RDBTableDefinition
            {
                ...
                DBTableName = "CP_SaleZoneServices_Changed",
                Columns = columns
            });
        }
        ...
        #region IChangedSaleZoneServicesDataManager
        ...
        public void ApplyChangedZonesServicesToDB(object preparedObject)
        {
        ...
        public void WriteRecordToStream(ChangedZoneServices record, object dbApplyStream)
        {
            RDBBulkInsertQueryContext bulkInsertContext = dbApplyStream.CastWithValidate<RDBBulkInsertQueryContext>("dbApplyStream");
