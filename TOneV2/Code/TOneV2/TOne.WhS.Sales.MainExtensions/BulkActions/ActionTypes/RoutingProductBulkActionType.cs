...
namespace TOne.WhS.Sales.MainExtensions
{
	public class RoutingProductBulkActionType : BulkActionType
	{
		...
		{
			if (currentZoneRP != null && ownerType == SalePriceListOwnerType.SellingProduct && currentZoneRP.Source != SaleEntityZoneRoutingProductSource.ProductZone)
				return false;
			if (currentZoneRP != null && ownerType == SalePriceListOwnerType.Customer && currentZoneRP.Source != SaleEntityZoneRoutingProductSource.CustomerZone)
				return false;
