(function (appControllers) {
    ...
    SellingNumberPlanManagementController.$inject = ['$scope', 'WhS_BE_SellingNumberPlanService'];

    function SellingNumberPlanManagementController($scope, WhS_BE_SellingNumberPlanService) {
        var gridAPI;
        var filter = {};
