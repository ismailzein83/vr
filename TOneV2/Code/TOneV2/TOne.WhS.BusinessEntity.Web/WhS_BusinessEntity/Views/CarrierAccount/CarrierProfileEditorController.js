(function (appControllers) {
    ...
    function carrierProfileEditorController($scope, WhS_BE_CarrierProfileAPIService, WhS_BE_TechnicalSettingsAPIService, UtilsService, VRNotificationService, VRNavigationService, WhS_BE_ContactTypeEnum, VRUIUtilsService) {
        ...
        function loadAllControls() {
            return UtilsService.waitMultipleAsyncOperations([setTitle, loadCountryCitySection, loadStaticSection, loadContacts, loadCurrencySelector, loadTaxes, loadDocuments, loadInvoiceSettingSelector, loadCompanySettingSelector])
               .catch(function (error) {
                   VRNotificationService.notifyExceptionWithClose(error, $scope);
               })
              .finally(function () {
