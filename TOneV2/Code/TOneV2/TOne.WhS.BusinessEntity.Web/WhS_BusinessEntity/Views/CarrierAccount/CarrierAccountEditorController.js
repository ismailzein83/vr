    ...
    function carrierAccountEditorController($scope, WhS_BE_CarrierAccountAPIService, WhS_BE_CarrierProfileAPIService, UtilsService, VRNotificationService, VRNavigationService, WhS_BE_CarrierAccountTypeEnum, VRUIUtilsService, WhS_BE_CarrierAccountActivationStatusEnum, WhS_BE_CustomerCountryAPIService, WhS_BE_SellingProductAPIService, WhS_BE_RoutingStatusEnum, WhS_BE_SaleAreaSettingsContextEnum, VRDateTimeService) {
        ...
        function defineScope() {
            ...
            $scope.scopeModel.onPassThroughCustomerRateEvaluatorSelectorReady = function (api) {
                ...
                var setLoader = function (value) {
                    $scope.scopeModel.isLoadingPassThroughCustomerRateEvaluatorSelector = value;
                };
        ...
        function loadStaticData() {
            ...
            if (carrierAccountEntity != undefined) {
                ...
                if (carrierAccountEntity.SupplierSettings != undefined) {
                ...
                if (carrierAccountEntity.CustomerSettings != undefined) {
                    ...
                    $scope.scopeModel.isPassThrough = carrierAccountEntity.CustomerSettings.PassThroughCustomerRateEvaluator != undefined;
                }
            }
        }
        ...
        function loadCustomerSettingsTab() {
            ...
            if (carrierAccountEntity != undefined && carrierAccountEntity.CustomerSettings != undefined && carrierAccountEntity.CustomerSettings.PassThroughCustomerRateEvaluator) {
                passThroughCustomerRateEvaluatorDirectiveReadyDeferred = UtilsService.createPromiseDeferred();
                var loadPassThroughCustomerRateEvaluatorSelectorPromise = loadPassThroughCustomerRateEvaluatorSelector();
                promises.push(loadPassThroughCustomerRateEvaluatorSelectorPromise);
            }
        ...
        function loadPassThroughCustomerRateEvaluatorSelector() {
            var passThroughCustomerRateEvaluatorLoadDeferred = UtilsService.createPromiseDeferred();

            passThroughCustomerRateEvaluatorDirectiveReadyDeferred.promise.then(function () {
                passThroughCustomerRateEvaluatorDirectiveReadyDeferred = undefined;

                var passThroughCustomerRateEvaluatorPayload = {
                    passThroughCustomerRateEvaluator: carrierAccountEntity.CustomerSettings.PassThroughCustomerRateEvaluator
                };
                VRUIUtilsService.callDirectiveLoad(passThroughCustomerRateEvaluatorDirectiveAPI, passThroughCustomerRateEvaluatorPayload, passThroughCustomerRateEvaluatorLoadDeferred);
            });

            return passThroughCustomerRateEvaluatorLoadDeferred.promise;
        }
        ...
        function buildCarrierAccountObjFromScope() {
            var obj = {
                ...
                SupplierSettings: {
                    ...
                    BPBusinessRuleSetId: bpBusinessRuleSetDirectiveAPI != undefined ? bpBusinessRuleSetDirectiveAPI.getSelectedIds() : null,
                    AutoImportSettings: {
                        IsAutoImportActive: $scope.scopeModel.isAutoImportActive,
