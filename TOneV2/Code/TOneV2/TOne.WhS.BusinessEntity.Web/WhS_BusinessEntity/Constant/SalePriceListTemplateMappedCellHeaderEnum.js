app.constant('WhS_BE_SalePricelistTemplateMappedCellHeaderEnum', {
    CompanyName: { value: 0, description: "Company Name" },
    CustomerName: { value: 1, description: "Customer Name" },
