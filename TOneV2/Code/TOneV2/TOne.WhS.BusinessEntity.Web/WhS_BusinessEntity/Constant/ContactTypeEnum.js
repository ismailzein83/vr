app.constant('WhS_BE_ContactTypeEnum', {
    BillingContactPerson: { value: 1, label: "Billing Contact" , type:"text"},
    BillingEmail: { value: 2, label: "Billing Email", type: "email" },

    PricingContactPerson: { value: 4, label: "Pricing Contact", type: "text" },
    ...
    SupportContactPerson: { value: 8, label: "Support Contact", type: "text" },
    SupportEmail: { value: 9, label: "Support Email ", type: "email" },

    TechnicalContactPerson: { value: 10, label: "Technical Contact", type: "text" },
    TechnicalEmail: { value: 11, label: "Technical Email", type: "email" },

    CommercialContactPerson: { value: 12, label: "Commercial Contact", type: "text" },
