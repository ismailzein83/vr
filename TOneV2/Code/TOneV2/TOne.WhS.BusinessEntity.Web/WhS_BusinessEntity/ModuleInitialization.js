app.run(['WhS_BE_CodeGroupService', 'VRCommon_SaleZoneService', 'WhS_BE_SupplierRateService', 'WhS_BE_SupplierCodeService', function (WhS_BE_CodeGroupService, VRCommon_SaleZoneService, WhS_BE_SupplierRateService, WhS_BE_SupplierCodeService) {
