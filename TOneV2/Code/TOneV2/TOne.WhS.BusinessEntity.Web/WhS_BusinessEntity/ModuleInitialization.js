app.run(['WhS_BE_SalePriceListTemplateService', 'WhS_BE_SwitchConnectivityService', 'WhS_BE_SwitchService', 'WhS_BE_CarrierAccountService', 'WhS_BE_CodeGroupService', 'WhS_BE_SaleZoneService', 'WhS_BE_SupplierRateService', 'WhS_BE_SupplierCodeService', 'WhS_BE_SupplierZoneService_Service', 'WhS_BE_CustomerSellingProductService',
function (WhS_BE_SalePriceListTemplateService, WhS_BE_SwitchConnectivityService, WhS_BE_SwitchService, WhS_BE_CarrierAccountService, WhS_BE_CodeGroupService, WhS_BE_SaleZoneService, WhS_BE_SupplierRateService, WhS_BE_SupplierCodeService, WhS_BE_SupplierZoneService_Service, WhS_BE_CustomerSellingProductService) {
