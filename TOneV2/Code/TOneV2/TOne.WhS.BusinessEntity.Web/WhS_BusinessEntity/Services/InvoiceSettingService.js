(function (appControllers) {
    ...
    function InvoiceSettingService(UtilsService, VRModalService) {
        ...
        function addInvoiceSetting(onInvoiceSettingsAdded) {
            ...
            VRModalService.showModal('/Client/Modules/WhS_BusinessEntity/Views/InvoiceSettings/Templates/InvoiceSettingEditor.html', modalParameters, modalSettings);
        }
    ...
    appControllers.service('WhS_BE_InvoiceSettingService', InvoiceSettingService);
