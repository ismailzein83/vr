...
app.directive("vrWhsBeSalepricelistGrid", ["UtilsService", "VRNotificationService", "WhS_BE_SalePricelistAPIService", "FileAPIService"
    ...
    function (utilsService, vrNotificationService, whSBeSalePricelistApiService, fileApiService, whSBeSalePriceListOwnerTypeEnum, WhS_BE_SalePriceListChangeService) {
        ...
        function SalePriceListGrid($scope, ctrl, $attrs) {
            ...
            function PreviewPriceList(priceListObj, shouldOpenEmailPage) {
                ...
                WhS_BE_SalePriceListChangeService.previewPriceList(priceListObj.Entity.PriceListId, onSalePriceListPreviewClosed, shouldOpenEmailPage);
            }
