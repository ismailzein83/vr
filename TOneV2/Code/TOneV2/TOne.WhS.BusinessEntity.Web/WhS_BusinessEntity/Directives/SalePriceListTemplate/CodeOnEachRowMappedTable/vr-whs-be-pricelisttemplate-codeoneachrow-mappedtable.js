...
app.directive('vrWhsBePricelisttemplateCodeoneachrowMappedtable', ['WhS_BE_SalePriceListTemplateAPIService', 'UtilsService', 'VRUIUtilsService', function (WhS_BE_SalePriceListTemplateAPIService, UtilsService, VRUIUtilsService) {
    return {
        restrict: "E",
        scope: {
            onReady: "=",
        ...
        templateUrl: '/Client/Modules/WhS_BusinessEntity/Directives/SalePriceListTemplate/CodeOnEachRowMappedTable/Templates/CodeOnEachRowMappedTableTemplate.html'
    };
    ...
    function CodeOnEachRowMappedTableTemplate($scope, ctrl, $attrs) {
        ...
        function defineAPI() {
            ...
            api.getData = function getData() {
                ...
                var codeOnEachRow = {
                    $type: 'TOne.WhS.BusinessEntity.MainExtensions.CodeOnEachRowMappedTable, TOne.WhS.BusinessEntity.MainExtensions',
