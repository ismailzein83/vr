...
app.directive("vrWhsBePricelisttemplateCodesbyzoneMappedcolumnsGrid", ["VRUIUtilsService", "UtilsService", "VRNotificationService", "WhS_BE_SalePriceListTemplateAPIService",
function (VRUIUtilsService, UtilsService, VRNotificationService, WhS_BE_SalePriceListTemplateAPIService) {
    ...
    var directiveDefinitionObject = {
        ...
        templateUrl: "/Client/Modules/WhS_BusinessEntity/Directives/SalePriceListTemplate/MappedColumns/Templates/CodesByZoneMappedColumnsGridTemplate.html"
    ...
    function SalePriceListGrid($scope, ctrl, $attrs) {
        ...
        function getMappedTable() {
            ...
            for (var i = 0; i < $scope.mappedCols.length; i++) {
                ...
                var mappedColumn = {
                    $type: "TOne.WhS.BusinessEntity.MainExtensions.CodesByZoneMappedColumn, TOne.WhS.BusinessEntity.MainExtensions"
                };
