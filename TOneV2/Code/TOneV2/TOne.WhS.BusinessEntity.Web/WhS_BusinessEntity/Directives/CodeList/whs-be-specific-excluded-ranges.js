...
app.directive('whsBeSpecificExcludedRanges', ['UtilsService', 'VRUIUtilsService',
    function (UtilsService, VRUIUtilsService) {
        ...
        var directiveDefinitionObject = {
            ...
            templateUrl: function (element, attrs) {
                return "/Client/Modules/WhS_BusinessEntity/Directives/CodeList/templates/SpecificExcludedRangeTemplate.html";
            }
        };
        ...
        function ExcludedRangesCtor(ctrl, $scope) {
            ...
            function defineAPI() {
                ...
                api.getData = function () {
                    return {
                        $type: "TOne.WhS.BusinessEntity.MainExtensions.CodeList.ExcludedRanges, TOne.WhS.BusinessEntity.MainExtensions",
