...
app.directive('whsBeSpecificExcludedCodes', ['UtilsService', 'VRUIUtilsService',
    function (UtilsService, VRUIUtilsService) {
        ...
        var directiveDefinitionObject = {
            ...
            templateUrl: function (element, attrs) {
                return "/Client/Modules/WhS_BusinessEntity/Directives/CodeList/templates/SpecificExcludedCodeTemplate.html";
            }
        };
        ...
        function ExcludedCodesCtor(ctrl, $scope) {
            ...
            function defineAPI() {
                ...
                api.getData = function () {
                    return {
                        $type: "TOne.WhS.BusinessEntity.MainExtensions.CodeList.ExcludedCodes,TOne.WhS.BusinessEntity.MainExtensions",
