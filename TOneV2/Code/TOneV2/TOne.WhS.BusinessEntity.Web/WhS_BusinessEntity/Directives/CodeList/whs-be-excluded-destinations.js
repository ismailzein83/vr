(function (app) {
    ...
    ExludedDestination.$inject = ['UtilsService', 'VRUIUtilsService', 'whs_BE_BusinessEntityConfigurationAPIService'];
    function ExludedDestination(UtilsService, VRUIUtilsService, whs_BE_BusinessEntityConfigurationAPIService) {
        return {
            restrict: "E",
            scope: {
                onReady: "=",
            ...
            function defineAPI() {
                ...
                api.load = function (payload) {
                    ...
                    function getTagValueParserConfigs() {
                        ...
                        return whs_BE_BusinessEntityConfigurationAPIService.GetExcludedDestinationsTemplates().then(function (response) {
                            if (response != null) {
        ...
        function getTamplate(attrs) {
            ...
            var template =
                '<vr-row>'
                    ...
                    + '</vr-columns>'
                + '</vr-row>'
                + '<vr-row><vr-directivewrapper ng-if="scopeModel.selectedTemplateConfig != undefined" directive="scopeModel.selectedTemplateConfig.Editor"'
                ...
                + '</vr-directivewrapper></vr-row>';
            return template;
        }
    }

    app.directive('whsBeExcludedDestinations', ExludedDestination);
