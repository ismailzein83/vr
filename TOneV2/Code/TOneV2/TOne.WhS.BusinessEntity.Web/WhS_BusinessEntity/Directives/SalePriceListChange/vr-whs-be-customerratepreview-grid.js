...
//app.directive('vrWhsSalesCustomerratepreviewGrid', ['WhS_Sales_RatePlanPreviewAPIService', 'UtilsService', 'VRUIUtilsService', 'VRNotificationService', 'WhS_BE_RateChangeTypeEnum', function (WhS_Sales_RatePlanPreviewAPIService, UtilsService, VRUIUtilsService, VRNotificationService, WhS_BE_RateChangeTypeEnum) {
//    return {
//        restrict: 'E',
//        scope: {
//            onReady: '=',
...
//        templateUrl: '/Client/Modules/WhS_Sales/Directives/Preview/Templates/CustomerRatePreviewGrid.html'
//    };
...
//                return WhS_Sales_RatePlanPreviewAPIService.GetFilteredCustomerRatePreviews(dataRetrievalInput).then(function (response) {
...
//            var rateChangeType = UtilsService.getEnum(WhS_BE_RateChangeTypeEnum, 'value', dataItem.Entity.Change);
