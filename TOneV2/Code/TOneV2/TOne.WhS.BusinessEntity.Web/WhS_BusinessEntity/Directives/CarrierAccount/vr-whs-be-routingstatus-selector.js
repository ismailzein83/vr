'use strict';
app.directive('vrWhsBeRoutingstatusSelector', ['UtilsService', '$compile', 'VRUIUtilsService', 'WhS_BE_RoutingStatusEnum',
    function (UtilsService, $compile, VRUIUtilsService, WhS_BE_RoutingStatusEnum) {
        ...
        function directiveCtor(ctrl, $scope, $attrs) {
            ctrl.datasource = UtilsService.getArrayEnum(WhS_BE_RoutingStatusEnum);
