'use strict';
app.directive('vrWhsBeSupplierzonegroupSelective', ['UtilsService', '$compile', 'WhS_BE_PricingRuleAPIService', 'VRUIUtilsService',
function (UtilsService, $compile, WhS_BE_PricingRuleAPIService, VRUIUtilsService) {
    ...
    var directiveDefinitionObject = {
        ...
        templateUrl: "/Client/Modules/WhS_BusinessEntity/Directives/MainExtensions/SupplierZoneGroup/Templates/SelectiveSupplierZonesDirectiveTemplate.html"
            ...
            api.load = function (payload) {
                ...
                function loadSupplierZoneDirectives() {
                    ...
                    if (payload != undefined) {
                        ...
                        for (var i = 0; i < payload.supplierZoneGroupSettings.SuppliersWithZones.length; i++) {
                            var filterItem = {
                                payload: payload.supplierZoneGroupSettings.SuppliersWithZones[i],
