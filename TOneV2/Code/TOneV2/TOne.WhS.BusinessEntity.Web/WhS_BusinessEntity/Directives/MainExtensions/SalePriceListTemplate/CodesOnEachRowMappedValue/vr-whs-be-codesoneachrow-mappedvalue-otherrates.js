...
app.directive('vrWhsBeCodesoneachrowMappedvalueOtherrates', ['UtilsService', 'VRUIUtilsService', function (UtilsService, VRUIUtilsService) {
    return {
        restrict: "E",
        scope: {
            onReady: "=",
        ...
        controllerAs: "codesOnEachRowOtherRatesMappedValueCtrl",
    ...
    function BasicSettingsOtherRatesMappedValue($scope, ctrl, $attrs) {
        ...
        function defineAPI() {
            ...
            api.getData = function getData() {
                return {
                    $type: 'TOne.WhS.BusinessEntity.MainExtensions.CodeOnEachRowOtherRatesMappedValue, TOne.WhS.BusinessEntity.MainExtensions',
