...
app.directive('vrWhsSalesDefaultService', ['WhS_Sales_RatePlanAPIService', 'WhS_Sales_RatePlanUtilsService', 'WhS_BE_SalePriceListOwnerTypeEnum', 'UtilsService', 'VRUIUtilsService', 'VRNotificationService', 'VRDateTimeService',
    function (WhS_Sales_RatePlanAPIService, WhS_Sales_RatePlanUtilsService, WhS_BE_SalePriceListOwnerTypeEnum, UtilsService, VRUIUtilsService, VRNotificationService, VRDateTimeService) {
        return {
            restrict: 'E',
            scope: {
                onReady: '='
