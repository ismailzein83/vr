...
app.directive('vrWhsSalesZoneService', ['WhS_Sales_RatePlanAPIService', 'WhS_Sales_RatePlanUtilsService', 'UtilsService', 'VRUIUtilsService', 'VRNotificationService', 'VRDateTimeService',
    function (WhS_Sales_RatePlanAPIService, WhS_Sales_RatePlanUtilsService, UtilsService, VRUIUtilsService, VRNotificationService, VRDateTimeService) {
        return {
            restrict: 'E',
            scope: {
                onReady: '='
        ...
        function ZoneService(ctrl, $scope) {
            ...
            function getNewServiceBED() {
                ...
                var zoneBED = VRDateTimeService.getNowDateTime();
