...
app.directive('vrWhsSalesSoldcountryGrid', ['WhS_Sales_RatePlanAPIService', 'WhS_Sales_RatePlanUtilsService', 'UtilsService', 'VRNotificationService', 'VRValidationService', 'VRDateTimeService',
    function (WhS_Sales_RatePlanAPIService, WhS_Sales_RatePlanUtilsService, UtilsService, VRNotificationService, VRValidationService, VRDateTimeService) {
        return {
            restrict: 'E',
            scope: {
                onReady: '=',
            ...
            function initializeController() {
                ...
                $scope.scopeModel.search = function () {
                    if (gridQuery != undefined)
                        gridQuery.CountryName = $scope.scopeModel.countryName;
