...
app.directive('vrWhsSalesBulkactionZonefilter', ['WhS_BE_SalePriceListOwnerTypeEnum', 'WhS_Sales_SpecificApplicableZoneEntityTypeEnum', 'VRCommon_EntityFilterEffectiveModeEnum', 'UtilsService', 'VRUIUtilsService', 'VRNotificationService', function (WhS_BE_SalePriceListOwnerTypeEnum, WhS_Sales_SpecificApplicableZoneEntityTypeEnum, VRCommon_EntityFilterEffectiveModeEnum, UtilsService, VRUIUtilsService, VRNotificationService) {
    return {
        restrict: "E",
        scope: {
            onReady: "=",
