...
app.directive('vrWhsSalesBulkactionTypeDefaultroutingproduct', ['WhS_Sales_RatePlanAPIService', 'WhS_Sales_BulkActionUtilsService', 'WhS_BE_SalePriceListOwnerTypeEnum', 'UtilsService', 'VRUIUtilsService', 'VRNotificationService', function (WhS_Sales_RatePlanAPIService, WhS_Sales_BulkActionUtilsService, WhS_BE_SalePriceListOwnerTypeEnum, UtilsService, VRUIUtilsService, VRNotificationService) {
    return {
        restrict: "E",
        scope: {
            onReady: "=",
