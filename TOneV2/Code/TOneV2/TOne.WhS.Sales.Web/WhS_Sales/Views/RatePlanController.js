                ...
                confirmationPromise.then(function (isConfirmed) {
                    if (!isConfirmed)
                        ...
                        deleteDraftPromise.then(function () {
                            ...
                            else currencySelectorAPI.selectedCurrency(sellingProductCurrencyId);
