...
namespace TOne.WhS.CodePreparation.BP.Activities
{
    ...
    {
        public BaseQueue<IEnumerable<ChangedZoneServices>> InputQueue { get; set; }
        public BaseQueue<Object> OutputQueue { get; set; }
    }
    public sealed class PrepareChangedZonesServicesForApply : DependentAsyncActivity<PrepareChangedZonesServicesForApplyInput>
    {
        [RequiredArgument]
        public InArgument<BaseQueue<IEnumerable<ChangedZoneServices>>> InputQueue { get; set; }
        [RequiredArgument]
