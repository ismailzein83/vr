...
as (select * from (values
--//////////////////////////////////////////////////////////////////////////////////////////////////
('95aba81f-01bb-40b5-8194-5f67718f6c04','Scheduler Service','Scheduler Service','#/view/Runtime/Views/SchedulerTaskManagement','b7d68911-9501-48f4-a3ed-8af7cdbb1a2b',NULL,NULL,NULL,'{"$type":"Vanrise.Runtime.Business.SchedulerServiceViewSettings, Vanrise.Runtime.Business","ViewTitleResourceKey":"Common.SchedulerService","ViewNameResourceKey":"Common.SchedulerService"}','372ed3cb-4b7b-4464-9abf-59cd7b08bd23',10),
('c65ed28a-36d0-4047-bec5-030d35b02308','My Scheduler Service','Scheduler Service','#/viewwithparams/Runtime/Views/SchedulerTaskManagement/{"myTasks":"1"}','50624672-cd25-44fd-8580-0e3ac8e34c71',NULL,NULL,NULL,'{"$type":"Vanrise.Runtime.Business.UserSchedulerServiceViewSettings, Vanrise.Runtime.Business","ViewTitleResourceKey":"Common.MySchedulerService","ViewNameResourceKey":"Common.MySchedulerService"}','372ed3cb-4b7b-4464-9abf-59cd7b08bd23',125),
