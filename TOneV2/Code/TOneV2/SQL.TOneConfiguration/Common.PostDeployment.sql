...
('VRCommon/StatusDefinition/GetFilteredStatusDefinitions','VRCommon_StatusDefinition: View'),('VRCommon/StatusDefinition/AddStatusDefinition','VRCommon_StatusDefinition: Add'),('VRCommon/StatusDefinition/UpdateStatusDefinition','VRCommon_StatusDefinition: Edit'),('VRCommon/StatusDefinition/GetStatusDefinition',null),('VRCommon/StatusDefinition/GetStatusDefinitionsInfo',null),

('VRCommon/VRComponentType/GetFilteredVRComponentTypes','VRCommon_VRComponentType: View'),('VRCommon/VRComponentType/GetVRComponentType',null),('VRCommon/VRComponentType/AddVRComponentType','VRCommon_VRComponentType: Add'),('VRCommon/VRComponentType/UpdateVRComponentType','VRCommon_VRComponentType: Edit'),('VRCommon/VRComponentType/GetVRComponentTypeExtensionConfigs',null),('VRCommon/VRComponentType/GetVRComponentTypeExtensionConfigById',null)
--\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
