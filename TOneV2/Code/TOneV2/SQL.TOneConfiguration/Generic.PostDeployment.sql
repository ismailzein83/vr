...
(3,'DateTime','{"DataRecordFieldTypeConfigId":"3","Name":"DateTime","Title":"DateTime","Editor":"vr-genericdata-fieldtype-datetime","RuntimeEditor":"vr-genericdata-fieldtype-datetime-runtimeeditor","FilterEditor":"vr-genericdata-fieldtype-datetime-filtereditor","RuleFilterEditor":"vr-genericdata-fieldtype-datetime-rulefiltereditor"}'),
(4,'Choices','{"DataRecordFieldTypeConfigId":"4","Name":"Choices","Title":"Choices","Editor":"vr-genericdata-fieldtype-choices","RuntimeEditor":"vr-genericdata-fieldtype-choices-runtimeeditor","FilterEditor":"vr-genericdata-fieldtype-choices-filtereditor","RuleFilterEditor":"vr-genericdata-fieldtype-choices-rulefiltereditor"}'),
(5,'Boolean','{"DataRecordFieldTypeConfigId":"5","Name":"Boolean","Title":"Boolean","Editor":"vr-genericdata-fieldtype-boolean","RuntimeEditor":"vr-genericdata-fieldtype-boolean-runtimeeditor","FilterEditor":"vr-genericdata-fieldtype-boolean-filtereditor","RuleFilterEditor":"vr-genericdata-fieldtype-boolean-rulefiltereditor"}'),
(6,'Business Entity','{"DataRecordFieldTypeConfigId":"6","Name":"Business Entity","Title":"Business Entity","Editor":"vr-genericdata-fieldtype-businessentity","RuntimeEditor":"vr-genericdata-fieldtype-businessentity-runtimeeditor","FilterEditor":"vr-genericdata-fieldtype-businessentity-filtereditor","RuleFilterEditor":"vr-genericdata-fieldtype-businessentity-rulefiltereditor"}'),
(7,'Array','{"DataRecordFieldTypeConfigId":"7","Name":"Array","Title":"Array","Editor":"vr-genericdata-fieldtype-array","RuntimeEditor":"vr-genericdata-fieldtype-array-runtimeeditor", "FilterEditor": "vr-genericdata-fieldtype-array-filtereditor"}')
--\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
)c([ID],[Name],[Details]))
...
(17,'WHS_BE_SupplierZone','Supplier Zone','{"SelectorUIControl":"vr-whs-be-supplierzone-selector","GroupSelectorUIControl":"vr-whs-be-supplierzonegroup","ManagerFQTN":"TOne.WhS.BusinessEntity.Business.SupplierZoneManager, TOne.WhS.BusinessEntity.Business","IdType":"System.Int64"}'),
(19,'WHS_BE_SellingNumberPlan','Selling Number Plan','{"SelectorUIControl":"vr-whs-be-sellingnumberplan-selector","GroupSelectorUIControl":"","ManagerFQTN":"TOne.WhS.BusinessEntity.Business.SellingNumberPlanManager, TOne.WhS.BusinessEntity.Business","IdType":"System.Int32"}'),
...
(22,'WhS_BE_SwitchConnectivity','Switch Connectivity','{"SelectorUIControl":"vr-whs-be-switchconnectivity-selector","GroupSelectorUIControl":"","ManagerFQTN":"TOne.WhS.BusinessEntity.Business.SwitchConnectivityManager,TOne.WhS.BusinessEntity.Business","IdType":"System.Int32"}'),
(23,'WhS_BE_Switch','Switch','{"SelectorUIControl":"vr-whs-be-switch-selector","GroupSelectorUIControl":"","ManagerFQTN":"TOne.WhS.BusinessEntity.Business.SwitchManager,TOne.WhS.BusinessEntity.Business","IdType":"System.Int32"}'),
(24,'WhS_BE_SwitchReleaseCode','Switch Release Code','{"$type":"Vanrise.GenericData.Entities.GenericBEDefinitionSettings, Vanrise.GenericData.Entities","DefinitionEditor":"/Client/Modules/VR_GenericData/Views/GenericBusinessEntity/Definition/GenericBEEditorDefintion.html","SelectorUIControl":"vr-genericdata-genericbusinessentity-selector","ManagerFQTN":"Vanrise.GenericData.Business.GenericBusinessEntityManager, Vanrise.GenericData.Business","IdType":"System.Int64","DataRecordTypeId":47,"FieldPath":"ReleaseCode","EditorDesign":{"$type":"Vanrise.GenericData.Entities.GenericEditor, Vanrise.GenericData.Entities","Sections":{"$type":"System.Collections.Generic.List`1[[Vanrise.GenericData.Entities.GenericEditorSection, Vanrise.GenericData.Entities]], mscorlib","$values":[{"$type":"Vanrise.GenericData.Entities.GenericEditorSection, Vanrise.GenericData.Entities","SectionTitle":"Definition","Rows":{"$type":"System.Collections.Generic.List`1[[Vanrise.GenericData.Entities.GenericEditorRow, Vanrise.GenericData.Entities]], mscorlib","$values":[{"$type":"Vanrise.GenericData.Entities.GenericEditorRow, Vanrise.GenericData.Entities","Fields":{"$type":"System.Collections.Generic.List`1[[Vanrise.GenericData.Entities.GenericEditorField, Vanrise.GenericData.Entities]], mscorlib","$values":[{"$type":"Vanrise.GenericData.Entities.GenericEditorField, Vanrise.GenericData.Entities","IsRequired":true,"FieldPath":"SwitchId","FieldTitle":"SwitchId"},{"$type":"Vanrise.GenericData.Entities.GenericEditorField, Vanrise.GenericData.Entities","IsRequired":false,"FieldPath":"ReleaseCode","FieldTitle":"ReleaseCode"},{"$type":"Vanrise.GenericData.Entities.GenericEditorField, Vanrise.GenericData.Entities","IsRequired":false,"FieldPath":"Description","FieldTitle":"Description"},{"$type":"Vanrise.GenericData.Entities.GenericEditorField, Vanrise.GenericData.Entities","IsRequired":false,"FieldPath":"IsDelivered","FieldTitle":"IsDelivered"}]}}]}}]}},"ManagementDesign":{"$type":"Vanrise.GenericData.Entities.GenericManagement, Vanrise.GenericData.Entities","GridDesign":{"$type":"Vanrise.GenericData.Entities.GenericGrid, Vanrise.GenericData.Entities","Columns":{"$type":"System.Collections.Generic.List`1[[Vanrise.GenericData.Entities.GenericGridField, Vanrise.GenericData.Entities]], mscorlib","$values":[{"$type":"Vanrise.GenericData.Entities.GenericGridField, Vanrise.GenericData.Entities","FieldPath":"SwitchId","FieldTitle":"Switch"},{"$type":"Vanrise.GenericData.Entities.GenericGridField, Vanrise.GenericData.Entities","FieldPath":"ReleaseCode","FieldTitle":"Release Code"},{"$type":"Vanrise.GenericData.Entities.GenericGridField, Vanrise.GenericData.Entities","FieldPath":"Description","FieldTitle":"Description"},{"$type":"Vanrise.GenericData.Entities.GenericGridField, Vanrise.GenericData.Entities","FieldPath":"IsDelivered","FieldTitle":"Delivered"}]}},"FilterDesign":{"$type":"Vanrise.GenericData.Entities.GenericFilter, Vanrise.GenericData.Entities","Fields":{"$type":"System.Collections.Generic.List`1[[Vanrise.GenericData.Entities.GenericFilterField, Vanrise.GenericData.Entities]], mscorlib","$values":[{"$type":"Vanrise.GenericData.Entities.GenericFilterField, Vanrise.GenericData.Entities","IsRequired":false,"FieldPath":"SwitchId","FieldTitle":"Switch"},{"$type":"Vanrise.GenericData.Entities.GenericFilterField, Vanrise.GenericData.Entities","IsRequired":false,"FieldPath":"ReleaseCode","FieldTitle":"Release Code"},{"$type":"Vanrise.GenericData.Entities.GenericFilterField, Vanrise.GenericData.Entities","IsRequired":false,"FieldPath":"Description","FieldTitle":"Description"}]}}}}')
--\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
