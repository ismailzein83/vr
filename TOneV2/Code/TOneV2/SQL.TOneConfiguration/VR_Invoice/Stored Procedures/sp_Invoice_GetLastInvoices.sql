...
AS
BEGIN
	SELECT top(@LastInvoices)	ID,InvoiceTypeID,PartnerID,SerialNumber,FromDate,ToDate,IssueDate,DueDate,Details,PaidDate,IsAutomatic,UserId,Settings,CreatedTime,LockDate,Notes, SourceId,InvoiceSettingId,SentDate
