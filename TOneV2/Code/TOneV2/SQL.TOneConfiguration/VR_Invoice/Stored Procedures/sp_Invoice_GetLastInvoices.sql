...
AS
BEGIN
	SELECT top(@LastInvoices)	ID,InvoiceTypeID,PartnerID,SettlementInvoiceId,SerialNumber,FromDate,ToDate,IssueDate,DueDate,Details,PaidDate,IsAutomatic,UserId,Settings,CreatedTime,LockDate,Notes, SourceId,InvoiceSettingId,SentDate
