...
AS
BEGIN
	SELECT top(@LastInvoices)	ID,InvoiceTypeID,PartnerID,SerialNumber,FromDate,ToDate,IssueDate,DueDate,Details,PaidDate,IsAutomatic,UserId,CreatedTime,LockDate,Notes,TimeZoneId,TimeZoneOffset, SourceId
