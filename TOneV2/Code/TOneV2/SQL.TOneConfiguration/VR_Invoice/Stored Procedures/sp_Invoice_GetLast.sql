...
AS
BEGIN
	SELECT top(1)	ID,InvoiceTypeID,PartnerID,SerialNumber,FromDate,ToDate,IssueDate,DueDate,Details,PaidDate,UserId,IsAutomatic,CreatedTime,Settings,LockDate,Notes, SourceId
