...
AS
BEGIN
	SELECT	ID,InvoiceTypeID,PartnerID,SerialNumber,FromDate,ToDate,IssueDate,DueDate,Details,PaidDate,UserId,CreatedTime,LockDate,IsAutomatic,Notes,Settings, SourceId,InvoiceSettingId,SentDate
