...
BEGIN
	...
	INSERT INTO [genericdata].[BusinessEntityStatusHistory] (BusinessEntityDefinitionId, BusinessEntityId,FieldName, StatusId, PreviousStatusID, StatusChangedDate, IsDeleted,MoreInfo,PreviousMoreInfo)
