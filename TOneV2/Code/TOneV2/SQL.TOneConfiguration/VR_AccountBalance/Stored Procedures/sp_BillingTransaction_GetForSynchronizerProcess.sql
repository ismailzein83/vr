...
BEGIN
	SET NOCOUNT ON;
		...
		SELECT	bt.[ID],bt.AccountID,bt.AccountTypeID, bt.TransactionTypeID,bt.Amount,bt.CurrencyId,bt.TransactionTime,bt.Notes,bt.Reference,bt.IsBalanceUpdated,bt.ClosingPeriodId, bt.SourceID, bt.Settings, bt.IsDeleted, bt.IsSubtractedFromBalance, bt.PaymentToInvoiceID
