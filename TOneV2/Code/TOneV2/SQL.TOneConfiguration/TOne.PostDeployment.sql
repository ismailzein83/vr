...
--//////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  (14,'{"$type":"Vanrise.BusinessProcess.Entities.BPBusinessRuleActionSettings, Vanrise.BusinessProcess.Entities","Action":{"$type":"Vanrise.BusinessProcess.StopExecutionAction, Vanrise.BusinessProcess","BPBusinessRuleActionTypeId":1}}'),
...
--//////////////////////////////////////////////////////////////////////////////////////////////////
 (1,'ValidateCodesZones',3,'{"$type":"Vanrise.BusinessProcess.Entities.BPBusinessRuleSettings, Vanrise.BusinessProcess.Entities","Description":"Code Group Rule","Condition": {"$type":"TOne.WhS.SupplierPriceList.Business.CodeGroupCondition, TOne.WhS.SupplierPriceList.Business"},"ActionTypes":[1,2]}'),
  ...
  (17,'CP_ValidateCodesZones',7,'{"$type":"Vanrise.BusinessProcess.Entities.BPBusinessRuleSettings, Vanrise.BusinessProcess.Entities","Description":"Invalid Status Rule","Condition":{"$type":"TOne.WhS.CodePreparation.Business.InvalidStatusCondition, TOne.WhS.CodePreparation.Business"},"ActionTypes":[1]}'), 
  ...
  (26,'CP_ValidateAfterProcessing',7,'{"$type":"Vanrise.BusinessProcess.Entities.BPBusinessRuleSettings, Vanrise.BusinessProcess.Entities","Description":"Can not close pending effective code  Rule","Condition":{"$type":"TOne.WhS.CodePreparation.Business.ClosePendingEffectiveCodeCondition, TOne.WhS.CodePreparation.Business"},"ActionTypes":[1]}'),
  (27,'CP_ValidateAfterProcessing',7,'{"$type":"Vanrise.BusinessProcess.Entities.BPBusinessRuleSettings, Vanrise.BusinessProcess.Entities","Description":"Add or Move Code To a Pending Zone Rule","Condition":{"$type":"TOne.WhS.CodePreparation.Business.AddMoveCodeToPendingClosedZoneCondition, TOne.WhS.CodePreparation.Business"},"ActionTypes":[1]}'),
  ...
  (29,'CP_ValidateAfterProcessing',7,'{"$type":"Vanrise.BusinessProcess.Entities.BPBusinessRuleSettings, Vanrise.BusinessProcess.Entities","Description":" Move Code To a Pending Effective Zone Rule","Condition":{"$type":"TOne.WhS.CodePreparation.Business.MoveCodeToPendingEffectiveZoneCondition, TOne.WhS.CodePreparation.Business"},"ActionTypes":[1]}'),
  (30,'CP_ValidateAfterProcessing',7,'{"$type":"Vanrise.BusinessProcess.Entities.BPBusinessRuleSettings, Vanrise.BusinessProcess.Entities","Description":"Close Code Not Exist And Effective Rule","Condition":{"$type":"TOne.WhS.CodePreparation.Business.CloseCodeNotExistAndEffectiveCondition, TOne.WhS.CodePreparation.Business"},"ActionTypes":[1]}'),
