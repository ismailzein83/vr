...
--//////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  (15,'{"$type":"Vanrise.BusinessProcess.Entities.BPBusinessRuleActionSettings, Vanrise.BusinessProcess.Entities","Action":{"$type":"Vanrise.BusinessProcess.StopExecutionAction, Vanrise.BusinessProcess","BPBusinessRuleActionTypeId":1}}'),
  ...
  (23,'{"$type":"Vanrise.BusinessProcess.Entities.BPBusinessRuleActionSettings, Vanrise.BusinessProcess.Entities","Action":{"$type":"Vanrise.BusinessProcess.InformationAction, Vanrise.BusinessProcess","BPBusinessRuleActionTypeId":4}}'),
  ...
  (25,'{"$type":"Vanrise.BusinessProcess.Entities.BPBusinessRuleActionSettings, Vanrise.BusinessProcess.Entities","Action":{"$type":"Vanrise.BusinessProcess.StopExecutionAction, Vanrise.BusinessProcess","BPBusinessRuleActionTypeId":1}}'),
...
(1,'ValidateCodesZones',3,'{"$type":"Vanrise.BusinessProcess.Entities.BPBusinessRuleSettings, Vanrise.BusinessProcess.Entities","Description":"Code Group Rule","Condition": {"$type":"TOne.WhS.SupplierPriceList.Business.CodeGroupCondition, TOne.WhS.SupplierPriceList.Business"},"ActionTypes":[1,2]}'),
  ...
  (14,'ValidateAfterProcessing',3,'{"$type":"Vanrise.BusinessProcess.Entities.BPBusinessRuleSettings, Vanrise.BusinessProcess.Entities","Description":"Rate Increased Rule","Condition": {"$type":"TOne.WhS.SupplierPriceList.Business.RateIncreasedCondition, TOne.WhS.SupplierPriceList.Business"},"ActionTypes":[3]}'),
  (15,'CP_ValidateCodesZones',7,'{"$type": "Vanrise.BusinessProcess.Entities.BPBusinessRuleSettings, Vanrise.BusinessProcess.Entities","Description": "Missing Zone Rule","Condition": {"$type": "TOne.WhS.CodePreparation.Business.MissingZoneCondition, TOne.WhS.CodePreparation.Business"},"ActionTypes": [1]}'), 
  (16,'CP_ValidateCodesZones',7,'{"$type":"Vanrise.BusinessProcess.Entities.BPBusinessRuleSettings, Vanrise.BusinessProcess.Entities","Description":"Missing Code Rule","Condition":{"$type":"TOne.WhS.CodePreparation.Business.MissingCodeCondition, TOne.WhS.CodePreparation.Business"},"ActionTypes":[1]}'), 
  (17,'CP_ValidateCodesZones',7,'{"$type":"Vanrise.BusinessProcess.Entities.BPBusinessRuleSettings, Vanrise.BusinessProcess.Entities","Description":"Missing Status Rule","Condition":{"$type":"TOne.WhS.CodePreparation.Business.MissingStatusCondition, TOne.WhS.CodePreparation.Business"},"ActionTypes":[1]}'),  
  (18,'CP_ValidateCodesZones',7,'{"$type":"Vanrise.BusinessProcess.Entities.BPBusinessRuleSettings, Vanrise.BusinessProcess.Entities","Description":"Invalid Status Rule","Condition":{"$type":"TOne.WhS.CodePreparation.Business.InvalidStatusCondition, TOne.WhS.CodePreparation.Business"},"ActionTypes":[1]}'), 
  (19,'CP_ValidateZones',7,'{"$type":"Vanrise.BusinessProcess.Entities.BPBusinessRuleSettings, Vanrise.BusinessProcess.Entities","Description":"Code Group Rule","Condition":{"$type":"TOne.WhS.CodePreparation.Business.CodeGroupCondition, TOne.WhS.CodePreparation.Business"},"ActionTypes":[1]}'), 
  (20,'CP_ValidateZones',7,'{"$type":"Vanrise.BusinessProcess.Entities.BPBusinessRuleSettings, Vanrise.BusinessProcess.Entities","Description":"Multiple Country Rule","Condition":{"$type":"TOne.WhS.CodePreparation.Business.MultipleCountryCondition, TOne.WhS.CodePreparation.Business"},"ActionTypes":[1]}'),  
  (21,'CP_ValidateZones',7,'{"$type":"Vanrise.BusinessProcess.Entities.BPBusinessRuleSettings, Vanrise.BusinessProcess.Entities","Description":"Zone has Same Code more than one time Rule","Condition":{"$type":"TOne.WhS.CodePreparation.Business.SameCodeInSameZoneCondition, TOne.WhS.CodePreparation.Business"},"ActionTypes":[1]}'), 
  (22,'CP_ValidateCountries',7,'{"$type":"Vanrise.BusinessProcess.Entities.BPBusinessRuleSettings, Vanrise.BusinessProcess.Entities","Description":"Same code in different zones  Rule","Condition":{"$type":"TOne.WhS.CodePreparation.Business.SameCodeInDifferentZoneCondition, TOne.WhS.CodePreparation.Business"},"ActionTypes":[1]}'),
  (23,'CP_ValidateUICodesZones',7,'{"$type":"Vanrise.BusinessProcess.Entities.BPBusinessRuleSettings, Vanrise.BusinessProcess.Entities","Description":"Zone has no changes  Rule","Condition":{"$type":"TOne.WhS.CodePreparation.Business.ZoneWithoutChangesCondition, TOne.WhS.CodePreparation.Business"},"ActionTypes":[4]}'), 
  (24,'CP_ValidateCountries',7,'{"$type":"Vanrise.BusinessProcess.Entities.BPBusinessRuleSettings, Vanrise.BusinessProcess.Entities","Description":"Changes For Empty Country  Rule","Condition":{"$type":"TOne.WhS.CodePreparation.Business.ChangesInPastCondition, TOne.WhS.CodePreparation.Business"},"ActionTypes":[1]}'), 
  (25,'CP_ValidateAfterProcessing',7,'{"$type":"Vanrise.BusinessProcess.Entities.BPBusinessRuleSettings, Vanrise.BusinessProcess.Entities","Description":"Code Effective Before Zone Condition  Rule","Condition":{"$type":"TOne.WhS.CodePreparation.Business.CodeEffectiveBeforeZoneCondition, TOne.WhS.CodePreparation.Business"},"ActionTypes":[1]}'), 
  (26,'CP_ValidateAfterProcessing',7,'{"$type":"Vanrise.BusinessProcess.Entities.BPBusinessRuleSettings, Vanrise.BusinessProcess.Entities","Description":"All Codes In Zone Closed  Rule","Condition":{"$type":"TOne.WhS.CodePreparation.Business.AllCodesInZoneClosedCondition, TOne.WhS.CodePreparation.Business"},"ActionTypes":[4]}'),  
  (27,'CP_ValidateAfterProcessing',7,'{"$type":"Vanrise.BusinessProcess.Entities.BPBusinessRuleSettings, Vanrise.BusinessProcess.Entities","Description":"Can not close pending effective code  Rule","Condition":{"$type":"TOne.WhS.CodePreparation.Business.ClosePendingEffectiveCodeCondition, TOne.WhS.CodePreparation.Business"},"ActionTypes":[1]}'),
  (28,'CP_ValidateAfterProcessing',7,'{"$type":"Vanrise.BusinessProcess.Entities.BPBusinessRuleSettings, Vanrise.BusinessProcess.Entities","Description":"Add or Move Code To a Pending Zone Rule","Condition":{"$type":"TOne.WhS.CodePreparation.Business.AddMoveCodeToPendingClosedZoneCondition, TOne.WhS.CodePreparation.Business"},"ActionTypes":[1]}'),
  ...
  (30,'CP_ValidateAfterProcessing',7,'{"$type":"Vanrise.BusinessProcess.Entities.BPBusinessRuleSettings, Vanrise.BusinessProcess.Entities","Description":" Move Code To a Pending Effective Zone Rule","Condition":{"$type":"TOne.WhS.CodePreparation.Business.MoveCodeToPendingEffectiveZoneCondition, TOne.WhS.CodePreparation.Business"},"ActionTypes":[1]}'),
  (31,'CP_ValidateAfterProcessing',7,'{"$type":"Vanrise.BusinessProcess.Entities.BPBusinessRuleSettings, Vanrise.BusinessProcess.Entities","Description":"Close Code Not Exist And Effective Rule","Condition":{"$type":"TOne.WhS.CodePreparation.Business.CloseCodeNotExistAndEffectiveCondition, TOne.WhS.CodePreparation.Business"},"ActionTypes":[1]}'),
  (32,'CP_ValidateAfterProcessing',7,'{"$type":"Vanrise.BusinessProcess.Entities.BPBusinessRuleSettings, Vanrise.BusinessProcess.Entities","Description":"Can not close pending closed code  Rule","Condition":{"$type":"TOne.WhS.CodePreparation.Business.ClosePendingClosedCodeCondition, TOne.WhS.CodePreparation.Business"},"ActionTypes":[1]}')
--\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
