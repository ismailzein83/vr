...
(17,'CP_ValidateCodesZones',7,'{"$type":"Vanrise.BusinessProcess.Entities.BPBusinessRuleSettings, Vanrise.BusinessProcess.Entities","Description":"Undefined Status Rule","Condition":{"$type":"TOne.WhS.CodePreparation.Business.UndefinedStatusCondition, TOne.WhS.CodePreparation.Business"},"ActionTypes":[1]}'),
(18,'CP_ValidateCountries',7,'{"$type":"Vanrise.BusinessProcess.Entities.BPBusinessRuleSettings, Vanrise.BusinessProcess.Entities","Description":"Code Group Rule","Condition":{"$type":"TOne.WhS.CodePreparation.Business.CodeGroupCondition, TOne.WhS.CodePreparation.Business"},"ActionTypes":[1]}'),
(19,'CP_ValidateCountries',7,'{"$type":"Vanrise.BusinessProcess.Entities.BPBusinessRuleSettings, Vanrise.BusinessProcess.Entities","Description":"Multiple Country Rule","Condition":{"$type":"TOne.WhS.CodePreparation.Business.MultipleCountryCondition, TOne.WhS.CodePreparation.Business"},"ActionTypes":[1]}'),
(20,'CP_ValidateCountries',7,'{"$type":"Vanrise.BusinessProcess.Entities.BPBusinessRuleSettings, Vanrise.BusinessProcess.Entities","Description":"Zone has Same Code more than one time Rule","Condition":{"$type":"TOne.WhS.CodePreparation.Business.SameCodeInSameZoneCondition, TOne.WhS.CodePreparation.Business"},"ActionTypes":[1]}'),
