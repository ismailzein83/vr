...
(29,'CP_ValidateAfterProcessing',7,'{"$type":"Vanrise.BusinessProcess.Entities.BPBusinessRuleSettings, Vanrise.BusinessProcess.Entities","Description":" Move Code To a Pending Zone Rule","Condition":{"$type":"TOne.WhS.CodePreparation.Business.MoveCodeToPendingEffectiveZoneCondition, TOne.WhS.CodePreparation.Business"},"ActionTypes":[1]}'), 
