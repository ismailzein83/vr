...
namespace TOne.WhS.Invoice.Data.RDB
{
    public class InvoiceComparisonTemplateDataManager : IInvoiceComparisonTemplateDataManager
    {
        ...
        {
            return RDBDataProviderFactory.CreateProvider("WhS_Invoice", "TOneWhS_BE_DBConnStringKey", "TOneWhS_BE_DBConnString");
        }
        #endregion
