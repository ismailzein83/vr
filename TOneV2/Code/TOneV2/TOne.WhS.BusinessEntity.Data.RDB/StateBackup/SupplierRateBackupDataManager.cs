...
{
    public class SupplierRateBackupDataManager
    {
        #region RDB

        public static string TABLE_ALIAS = "suprbkup";
        public static string TABLE_NAME = "TOneWhS_BE_Bkup_SupplierRate";
        ...
        static SupplierRateBackupDataManager()
        {
