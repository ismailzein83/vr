...
namespace TOne.WhS.BusinessEntity.Data.RDB
{
    public class SaleZoneDataManager : ISaleZoneDataManager
    {
        ...
        public void JoinSaleZone(RDBJoinContext joinContext, string zoneTableAlias, string originalTableAlias, string originalTableZoneIdCol, bool withNoLockJoin, RDBJoinType joinType = RDBJoinType.Inner)
        {
        ...
        public void BackupBySNPId(RDBQueryContext queryContext, long stateBackupId, string backupDatabaseName, int sellingNumberPlanId)
        {
            ...
            insertQuery.IntoTable(new RDBTableDefinitionQuerySource(backupDatabaseName, SaleZoneBackupDataManager.TABLE_NAME));
        ...
        public void SetRestoreQuery(RDBQueryContext queryContext, long stateBackupId, string backupDatabaseName)
        {
            ...
            var selectQuery = insertQuery.FromSelect();
            selectQuery.From(new RDBTableDefinitionQuerySource(backupDatabaseName, SaleZoneBackupDataManager.TABLE_NAME), SaleZoneBackupDataManager.TABLE_ALIAS, null, true);
            var selectColumns = selectQuery.SelectColumns();
            ...
            whereQuery.EqualsCondition(SaleZoneBackupDataManager.COL_StateBackupID).Value(stateBackupId);
        }
