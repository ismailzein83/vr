...
USING (VALUES 
('Vanrise.Fzero.FraudAnalysis.BP.Arguments.ExecuteStrategyProcessInput','Execute Strategy Process','Vanrise.Fzero.FraudAnalysis.BP.ExecuteStrategyProcess, Vanrise.Fzero.FraudAnalysis.BP','{"$type":"Vanrise.BusinessProcess.Entities.BPConfiguration, Vanrise.BusinessProcess.Entities","MaxConcurrentWorkflows":10,"ScheduledExecEditor":"vr-cdr-fraudanalysis-executestrategy","ManualExecEditor":"vr-cdr-fraudanalysis-executestrategy-manual","RetryOnProcessFailed":false}'),
...
('Vanrise.Fzero.FraudAnalysis.BP.Arguments.NumberProfilingProcessInput','Number Profiling Process','Vanrise.Fzero.FraudAnalysis.BP.NumberProfilingProcess, Vanrise.Fzero.FraudAnalysis.BP','{"$type":"Vanrise.BusinessProcess.Entities.BPConfiguration, Vanrise.BusinessProcess.Entities","MaxConcurrentWorkflows":10,"ScheduledExecEditor":"vr-cdr-fraudanalysis-numberprofiling","ManualExecEditor":"vr-cdr-fraudanalysis-numberprofiling-manual","RetryOnProcessFailed":false}'),
...
('Vanrise.Fzero.CDRImport.BP.Arguments.StagingtoCDRProcessInput','Staging to Normal CDR Process','Vanrise.Fzero.CDRImport.BP.StagingtoCDRProcess, Vanrise.Fzero.CDRImport.BP','{"$type":"Vanrise.BusinessProcess.Entities.BPConfiguration, Vanrise.BusinessProcess.Entities","MaxConcurrentWorkflows":10,"ScheduledExecEditor":"vr-cdr-pstnbe-stagingtocdr","ManualExecEditor":"vr-cdr-pstnbe-stagingtocdr-manual","RetryOnProcessFailed":false}'),
