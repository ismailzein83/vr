...
;WITH Tasks_CTE (Id, Name, IsEnabled, [TriggerTypeId], TaskTrigger, [ActionTypeId], [TaskAction], RowNumber) AS 
	(
	...
	SELECT Id, Name, IsEnabled, [TriggerTypeId], TaskTrigger, [ActionTypeId], [TaskAction], RowNumber 
