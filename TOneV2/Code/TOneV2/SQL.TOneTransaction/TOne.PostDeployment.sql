...
(N'TOne.WhS.Routing.BP.Arguments.RoutingProcessInput',N'Whole Sale Routing Process Process',N'TOne.WhS.Routing.BP.RoutingProcess, TOne.WhS.Routing.BP',N'{"$type":"Vanrise.BusinessProcess.Entities.BPConfiguration, Vanrise.BusinessProcess.Entities","MaxConcurrentWorkflows":1,"RetryOnProcessFailed":false}'),
(N'TOne.WhS.Routing.BP.Arguments.RPRoutingProcessInput',N'Routing Product Routing Process',N'TOne.WhS.Routing.BP.RPRoutingProcess, TOne.WhS.Routing.BP',N'{"$type":"Vanrise.BusinessProcess.Entities.BPConfiguration, Vanrise.BusinessProcess.Entities","MaxConcurrentWorkflows":1,"RetryOnProcessFailed":false}'),
