...
USING (VALUES 
	(N'TOne.CDRProcess.Arguments.DailyRepricingProcessInput', N'Daily Repricing Process', N'TOne.CDRProcess.DailyRepricingProcess, TOne.CDRProcess', N'{"$type":"Vanrise.BusinessProcess.Entities.BPConfiguration, Vanrise.BusinessProcess.Entities","MaxConcurrentWorkflows":2,"Editor":"vr-runtime-taskaction-scheduledailyrepricing","RetryOnProcessFailed":false,"ScheduleTemplateURL":"/Client/Modules/Runtime/Views/WFScheduleTemplates/ScheduleDailyRepricingProcessTemplate.html"}'),
