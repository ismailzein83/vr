...
BEGIN	
	...
	SELECT TOP(@NbOfRows) [ID],[Title],[ParentID],[DefinitionID],[WorkflowInstanceID],[InputArgument],[ExecutionStatus],[LockedByProcessID],[LastMessage]
			,[RetryCount],EntityID,[CreatedTime],[StatusUpdatedTime],[InitiatorUserId],[timestamp]
