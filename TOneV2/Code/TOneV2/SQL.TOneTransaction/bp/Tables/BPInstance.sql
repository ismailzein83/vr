...
GO
CREATE NONCLUSTERED INDEX [IX_BPInstance_TaskId]
    ON [bp].[BPInstance]([TaskId] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_BPInstance_StatusUpdatedTime_ID]
    ON [bp].[BPInstance]([StatusUpdatedTime] DESC, [ID] DESC);
