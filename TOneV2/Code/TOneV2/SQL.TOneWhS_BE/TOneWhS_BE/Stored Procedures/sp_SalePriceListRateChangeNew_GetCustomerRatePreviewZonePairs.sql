...
-- =============================================
Create PROCEDURE [TOneWhS_BE].[sp_SalePriceListRateChangeNew_GetCustomerRatePreviewZonePairs]
...
SELECT @ProcessInstanceId  = @ProcessInstanceId_IN
	...
	select distinct spr.ZoneID,sp.OwnerID
