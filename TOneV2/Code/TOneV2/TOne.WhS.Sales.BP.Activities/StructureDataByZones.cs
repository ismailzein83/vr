...
namespace TOne.WhS.Sales.BP.Activities
{
    public class StructureDataByZones : CodeActivity
    {
        ...
        {
            IEnumerable<RateToChange> ratesToChangeList = this.RatesToChange.Get(context);
            IEnumerable<RateToClose> ratesToCloseList = this.RatesToClose.Get(context);
            ...
            foreach (RateToChange rateToChange in ratesToChangeList)
            {
                ...
                dataByZone.RatesToChange.Add(rateToChange);
            }

            foreach (RateToClose rateToClose in ratesToCloseList)
            {
                ...
                dataByZone.RatesToClose.Add(rateToClose);
            }
            ...
            foreach (SaleZoneRoutingProductToAdd routingProductToAdd in saleZoneRoutingProductsToAdd)
            {
                ...
                dataByZone.SaleZoneRoutingProductsToAdd.Add(routingProductToAdd);
            }
            ...
            foreach (SaleZoneRoutingProductToClose routingProductToClose in saleZoneRoutingProductsToClose)
            {
                ...
                dataByZone.SaleZoneRoutingProductsToClose.Add(routingProductToClose);
            }
