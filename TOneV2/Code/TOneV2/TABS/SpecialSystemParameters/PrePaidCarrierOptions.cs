...
{
    public class PrepaidCarrierOptions
    {
        /// <summary>
        ...
        public class CarrierOption : IComparable<CarrierOption>
        {
            ...
            /// <summary>
            /// The Amount beginning from which the actions defined take place
            /// </summary>
            ...
            /// <summary>
            /// Two Carrier options are logically equal if they are for the Carrier on the same Amount
            /// </summary>
            ...
            public override bool Equals(object obj)
            {
                ...
                if (other != null)
                    return (this.Carrier.Equals(other.Carrier) && this.Amount.Equals(other.Amount) && this.IsCustommer.Equals(other.IsCustommer));
                else
                    return false;
            }
            ...
            {
                return (this.Carrier.ToString() + ":" + this.Amount.ToString()).GetHashCode();
            }
        ...
        /// </summary>
        public PrepaidCarrierOptions()
        {
            System.Xml.XmlDocument document = new System.Xml.XmlDocument();
            document.LoadXml(SystemParameter.PrepaidCarrierOptions.LongTextValue);
            LoadXml(document);
        }

        /// <summary>
        /// Return a sorted list (by Carrier, then by Amount) of all options
        /// </summary>
        /// <returns></returns>
            ...
            foreach (System.Xml.XmlNode CarrierNode in CarrierNodes)
            {
                ...
                if (carrierAccountID != null && CarrierAccount.All.ContainsKey(carrierAccountID))
                {
                    ...
                    foreach (System.Xml.XmlNode optionNode in CarrierNode.ChildNodes)
                    {
                        ...
                        option.Amount = decimal.Parse(optionNode.Attributes["Amount"].Value);
            ...
            foreach (CarrierAccount Carrier in this.CarrierOptions.Keys)
            {
                ...
                if (CarrierOptions.Count > 0)
                {
                    ...
                    foreach (CarrierOption option in CarrierOptions)
                    {
                        ...
                        optionNode.Attributes["Amount"].Value = option.Amount.ToString();
        ...
        public void Save()
        {
            SystemParameter.PrepaidCarrierOptions.LongTextValue = this.ToXml().InnerXml;
            Exception ex;
            ObjectAssembler.SaveOrUpdate(SystemParameter.PrepaidCarrierOptions, out ex);
        }
        ...
        public readonly static string DefaultXml = @"<?xml version=""1.0"" encoding=""utf-8""?><PrepaidCarrierOptions><Carrier CarrierAccountID=""""><Option Amount="""" Actions="""" IsCustommer= """"/></Carrier></PrepaidCarrierOptions>";
    }
}
