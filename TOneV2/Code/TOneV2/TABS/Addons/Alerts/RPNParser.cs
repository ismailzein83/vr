...
namespace TABS.Addons.Alerts
{
    ...
    {
        public DecimalOperand(string szVarName, object varValue)
            : base(szVarName, varValue)
        {
        }
        public DecimalOperand(string szVarName)
            : base(szVarName)
        {
        }
        public override string ToString()
        ...
        public override void ExtractAndSetValue(string szValue, bool bFormula)
        {
            m_VarValue = !bFormula ? Convert.ToDecimal(szValue) : 0;
        }
        /// IArithmeticOperations methods.  Return of these methods is again a DecimalOperand
        public IOperand Plus(IOperand rhs)
        {
            if (!(rhs is DecimalOperand))
                throw new RPN_Exception("Argument invalid in DecimalOperand.Plus : rhs");
            DecimalOperand oprResult = new DecimalOperand("Result", Type.GetType("System.Decimal"));
            oprResult.Value = (decimal)this.Value + (decimal)((Operand)rhs).Value;
            return oprResult;
        }
        public IOperand Minus(IOperand rhs)
        {
            if (!(rhs is DecimalOperand))
                throw new RPN_Exception("Argument invalid in DecimalOperand.Minus : rhs");
            DecimalOperand oprResult = new DecimalOperand("Result", Type.GetType("System.Decimal"));
            oprResult.Value = (decimal)this.Value - (decimal)((Operand)rhs).Value;
            return oprResult;
        }
        ...
        {
            if (!(rhs is DecimalOperand))
                throw new ArgumentException("Argument invalid in DecimalOperand.Multiply : rhs");
            DecimalOperand oprResult = new DecimalOperand("Result", Type.GetType("System.Decimal"));
            oprResult.Value = (decimal)this.Value * (decimal)((Operand)rhs).Value;
            return oprResult;
        }
        ...
        {
            if (!(rhs is DecimalOperand))
                throw new RPN_Exception("Argument invalid in DecimalOperand.Divide : rhs");
            DecimalOperand oprResult = new DecimalOperand("Result", Type.GetType("System.Decimal"));
            oprResult.Value = (decimal)this.Value / (decimal)((Operand)rhs).Value;
            return oprResult;
        }
        ...
        {
            if (!(rhs is DecimalOperand))
                throw new RPN_Exception("Argument invalid in DecimalOperand.Modulo : rhs");
            DecimalOperand oprResult = new DecimalOperand("Result", Type.GetType("System.Decimal"));
            oprResult.Value = (decimal)this.Value % (decimal)((Operand)rhs).Value;
            return oprResult;
        }
        ...
        {
            if (!(rhs is DecimalOperand))
                throw new RPN_Exception("Argument invalid in DecimalOperand.== : rhs");
            BoolOperand oprResult = new BoolOperand("Result");
            oprResult.Value = (decimal)this.Value == (decimal)((Operand)rhs).Value;
            return oprResult;
        }
        public IOperand NotEqualTo(IOperand rhs)
        {
            if (!(rhs is DecimalOperand))
                throw new RPN_Exception("Argument invalid in DecimalOperand.!= : rhs");
            BoolOperand oprResult = new BoolOperand("Result");
            oprResult.Value = ((decimal)this.Value != (decimal)((Operand)rhs).Value) ? true : false;
            return oprResult;
        }
        public IOperand LessThan(IOperand rhs)
        {
    ...
    public class RPNHelper
    {
        ...
        public static bool CheckExpressionValid(string expression, string replaceableUnitRegex, Type type)
        {
            Regex regex = new Regex(
                replaceableUnitRegex,
                RegexOptions.IgnoreCase
                | RegexOptions.CultureInvariant
                );
            //replace all functions with true and all operators with &&
            expression = opRegex.Replace(regex.Replace(expression.ToLower(), "true"), "&&");
            try
            {
                RPNParser parser = new RPNParser();
                System.Collections.ArrayList arrExpr = parser.GetPostFixNotation(expression, type, false);
                parser.EvaluateRPN(arrExpr, type, null);
                return true;
            }
            catch
            {
