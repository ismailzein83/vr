    ...
    BEGIN
        ...
        WITH TB1 AS (
            ...
            SELECT CarrierID AS CarrierID,
                   ...
                   CONVERT(DECIMAL(14,2),(CASE WHEN Balance IS NOT NULL THEN Balance ELSE 0 END)) AS Balance,
                    Currency,
                    CreditLimit AS CustomerCreditLimit,
                   CONVERT(DECIMAL(14,2),(CASE WHEN Tolerance IS NOT NULL THEN Tolerance ELSE 0 END)) AS Tolerance,
                   CONVERT(DECIMAL(14,2),(CASE WHEN Billing IS NOT NULL THEN Billing ELSE 0 END)) AS BillingAsCustomer,
                   CONVERT(DECIMAL(14,2),(CASE WHEN Payment IS NOT NULL THEN Payment ELSE 0 END))  AS PaymentAsCustomer
            INTO #RESULT
            FROM TB2
            ORDER BY Tolerance
        ...
        SELECT CarrierID AS CarrierID,
               ...
               CONVERT(DECIMAL(14,2),(CASE WHEN Tolerance IS NOT NULL THEN Tolerance ELSE 0 END)) AS Tolerance,
               CONVERT(DECIMAL(14,2),(CASE WHEN Billing IS NOT NULL THEN Billing ELSE 0 END)) AS BillingAsSupplier,
               CONVERT(DECIMAL(14,2),(CASE WHEN Payment IS NOT NULL THEN Payment ELSE 0 END) ) AS PaymentAsSupplier
        INTO #RESULT2
        FROM TB2
        ORDER BY Tolerance
    ...
    ELSE
        BEGIN
            ...
            SELECT
                ...
                CONVERT(DECIMAL(14,2),SUM(am.BillingAsCustomer)) AS BillingAsCustomer,
                CONVERT(DECIMAL(14,2),SUM(am.BillingAsSupplier)) AS BillingAsSupplier,
                am.Currency,
                am.CustomerCreditLimit,
                am.SupplierCreditLimit,
                CASE WHEN Sum(am.Balance) > 0 THEN CONVERT(DECIMAL(14,2),( am.SupplierCreditLimit - SUM(am.Balance))) ELSE CONVERT(DECIMAL(14,2), (am.CustomerCreditLimit  + SUM(am.Balance))) END AS Tolerance,
                CONVERT(DECIMAL(14,2),SUM(am.PaymentAsCustomer)) AS PaymentAsCustomer,
                CONVERT(DECIMAL(14,2),SUM(am.PaymentAsSupplier)) AS PaymentAsSupplier
            INTO #RESULT3
            FROM @Amounts am
