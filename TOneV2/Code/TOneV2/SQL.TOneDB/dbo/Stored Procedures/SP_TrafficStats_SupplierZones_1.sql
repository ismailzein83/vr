...
DECLARE @Result TABLE (
		...
		NumberOfCalls int,Cost_Nets float, Sale_Nets float,Profit numeric (13,5),AverageSaleRate NUMERIC(13,5),AverageCostRate NUMERIC(13,5),Percentage numeric (13,5) 
		)

INSERT INTO @Result(ZoneID ,Attempts, DurationsInMinutes,SuccessfulAttempts, ASR, ACD, DeliveredASR, AveragePDD, NumberOfCalls, Cost_Nets, Sale_Nets, Profit,AverageSaleRate,AverageCostRate, Percentage)
	SELECT 
