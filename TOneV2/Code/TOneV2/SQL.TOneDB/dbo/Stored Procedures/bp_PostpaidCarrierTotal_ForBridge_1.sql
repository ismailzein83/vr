...
CREATE PROCEDURE [dbo].[bp_PostpaidCarrierTotal_ForBridge]
...
BEGIN
	...
	ELSE
		BEGIN
			...
			FROM @Amounts am
			GROUP BY CarrierID,Suffix,CarrierName, ProfileID, Currency, CustomerCreditLimit, SupplierCreditLimit
			ORDER BY Tolerance 			
		END
END
set ANSI_NULLS ON
