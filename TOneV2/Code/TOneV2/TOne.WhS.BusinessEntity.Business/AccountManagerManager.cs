...
namespace TOne.WhS.BusinessEntity.Business
{
    public class AccountManagerManager
    {
        ...
        {
            List<AssignedCarrier> assignedCarriers = GetAssignedCarriers(SecurityContext.Current.GetLoggedInUserId(), true, CarrierAccountType.Supplier);
        ...
        {
            List<AssignedCarrier> assignedCarriers = GetAssignedCarriers(SecurityContext.Current.GetLoggedInUserId(), true, CarrierAccountType.Customer);
        ...
        public List<string> GetAssignedAccountIds(int managerId, CarrierAccountType carrierType)
        {
