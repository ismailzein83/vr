...
namespace TOne.WhS.BusinessEntity.Business
{
    public class ConfigManager
    {
        ...
        {
            PurchaseAreaSettingsData saleAreaSettings = GetPurchaseAreaSettings();
            return saleAreaSettings.AllowRateZero;
        }
        ...
        public PricingSettings MergePricingSettings(PricingSettings pricingSettingsParent, PricingSettings pricingSettingsChild)
        {
            ...
            result.AllowRateZero = pricingSettingsParent.AllowRateZero;
            ...
            if (pricingSettingsChild.AllowRateZero.HasValue)
                result.AllowRateZero = pricingSettingsChild.AllowRateZero.HasValue;
