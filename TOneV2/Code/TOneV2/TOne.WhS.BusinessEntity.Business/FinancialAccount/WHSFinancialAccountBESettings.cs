...
namespace TOne.WhS.BusinessEntity.Business
{
    public class WHSFinancialAccountDefinitionSettings : BusinessEntityDefinitionSettings
    {
        ...
        public override string ManagerFQTN { get { return "TOne.WhS.BusinessEntity.Business.WHSFinancialAccountManager, TOne.WhS.BusinessEntity.Business"; } }

        public override string SelectorUIControl { get { return "whs-be-financialaccount-selector"; } }
        
        public override string DefinitionEditor { get { return "whs-be-financialaccountbedefinition-editor"; } }
