...
{
    public class SaleZoneCostSummaryReportGenerator : TOne.Entities.IReportGenerator    
    {
        public Dictionary<string, System.Collections.IEnumerable> GenerateDataSources(TOne.Entities.ReportParameters parameters)
        {
            ...
            List<SaleZoneCostSummaryFormatted> saleZoneCostSummary = manager.GetSaleZoneCostSummary(parameters.FromTime, parameters.ToTime, parameters.SupplierAMUId, parameters.CustomerAMUId);
            Dictionary<string, System.Collections.IEnumerable> dataSources = new Dictionary<string, System.Collections.IEnumerable>();
            dataSources.Add("SaleZoneCostSummary", saleZoneCostSummary);
            return dataSources;
        }
