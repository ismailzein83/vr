...
namespace TOne.Analytics.Business.BillingReports
{
    public class SaleZoneCostSummaryReportGenerator : TOne.Entities.IReportGenerator    
    {
        public Dictionary<string, System.Collections.IEnumerable> GenerateDataSources(TOne.Entities.ReportParameters parameters)
        {
            ...
            List<SaleZoneCostSummaryFormatted> saleZoneCostSummary = manager.GetSaleZoneCostSummary(parameters.FromTime, parameters.ToTime, customersIds, suppliersIds, parameters.CurrencyId);
