...
namespace TOne.Analytics.Business.BillingReports
{
    public class CustomerRoutingReportGenerator : TOne.Entities.IReportGenerator
    {
        public Dictionary<string, System.Collections.IEnumerable> GenerateDataSources(TOne.Entities.ReportParameters parameters)
        {
            ...
            List<CustomerRoutingFormatted> customerRouting = manager.GetCustomerRouting(parameters.FromTime, parameters.ToTime, parameters.CustomerId, parameters.SupplierId, parameters.SupplierAMUId, parameters.CustomerAMUId);
