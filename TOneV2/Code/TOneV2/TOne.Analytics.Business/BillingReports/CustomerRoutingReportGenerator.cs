...
{
    public class CustomerRoutingReportGenerator : TOne.Entities.IReportGenerator
    {
        public Dictionary<string, System.Collections.IEnumerable> GenerateDataSources(TOne.Entities.ReportParameters parameters)
        {
            ...
            List<CustomerRoutingFormatted> customerRouting = manager.GetCustomerRouting(parameters.FromTime, parameters.ToTime, parameters.CustomersId, parameters.SuppliersId, customersIds, suppliersIds, parameters.CurrencyId);
            Dictionary<string, System.Collections.IEnumerable> dataSources = new Dictionary<string, System.Collections.IEnumerable>();
            dataSources.Add("CustomerRouting", customerRouting);
            return dataSources;
        }
        ...
        public Dictionary<string, RdlcParameter> GetRdlcReportParameters(TOne.Entities.ReportParameters parameters)
        {
            ...
            list.Add("Title", new RdlcParameter { Value = "Customer Routing Report", IsVisible = true });
