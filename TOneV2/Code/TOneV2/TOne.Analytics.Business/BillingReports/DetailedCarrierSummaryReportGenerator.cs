...
{
    public class DetailedCarrierSummaryReportGenerator : TOne.Entities.IReportGenerator
    {
        public Dictionary<string, System.Collections.IEnumerable> GenerateDataSources(TOne.Entities.ReportParameters parameters)
        {
            ...
            List<DetailedCarrierSummaryFormatted> detailedCarrierSummary = manager.GetDetailedCarrierSummary(parameters.FromTime, parameters.ToTime, parameters.CustomersId, parameters.SuppliersId, customersIds, suppliersIds , parameters.CurrencyId);
        ...
        public Dictionary<string, RdlcParameter> GetRdlcReportParameters(TOne.Entities.ReportParameters parameters)
        {
            ...
            list.Add("Title", new RdlcParameter { Value = "Detailed Carrier Summary", IsVisible = true });
