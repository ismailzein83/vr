...
namespace TOne.Analytics.Business.BillingReports
{
    public class DailyCarrierSummaryReportGenerator : TOne.Entities.IReportGenerator
    {
        public Dictionary<string, System.Collections.IEnumerable> GenerateDataSources(TOne.Entities.ReportParameters parameters)
        {
            ...
            List<CarrierSummaryDailyFormatted> carrirerSummary = manager.GetDailyCarrierSummary(parameters.FromTime, parameters.ToTime , parameters.CustomerId, parameters.SupplierId , parameters.IsCost, false , parameters.SupplierAMUId, parameters.CustomerAMUId);
