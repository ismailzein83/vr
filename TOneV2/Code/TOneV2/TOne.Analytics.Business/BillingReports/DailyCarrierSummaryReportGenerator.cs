...
{
    public class DailyCarrierSummaryReportGenerator : TOne.Entities.IReportGenerator
    {
        public Dictionary<string, System.Collections.IEnumerable> GenerateDataSources(TOne.Entities.ReportParameters parameters)
        {
            ...
            List<CarrierSummaryDailyFormatted> carrirerSummary = manager.GetDailyCarrierSummary(parameters.FromTime, parameters.ToTime, parameters.CustomersId, parameters.SuppliersId, parameters.IsCost, false, customersIds, suppliersIds, parameters.CurrencyId);
