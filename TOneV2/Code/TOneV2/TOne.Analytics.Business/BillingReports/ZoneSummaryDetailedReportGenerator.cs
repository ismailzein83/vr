    ...
    public class ZoneSummaryDetailedReportGenerator : TOne.Entities.IReportGenerator
    {
        public Dictionary<string, System.Collections.IEnumerable> GenerateDataSources(TOne.Entities.ReportParameters parameters)
        {
            ...
            List<ZoneSummaryDetailedFormatted> zoneSummaryDetailed =
                manager.GetZoneSummaryDetailed(parameters.FromTime, parameters.ToTime, parameters.CustomersId, parameters.SuppliersId, parameters.IsCost, parameters.CurrencyId, parameters.SupplierGroup, parameters.CustomerGroup, customersIds, suppliersIds, parameters.GroupBySupplier, out service);
