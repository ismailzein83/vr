    ...
    function whsRoutesyncHuaweiSoftX3000Communication(UtilsService, VRUIUtilsService, WhS_RouteSync_HuaweiSwitchLoggerAPIService) {
        ...
        function HuaweiSoftX3000CommunicationCtor($scope, ctrl, $attrs) {
            ...
            function initializeController() {
                ...
                UtilsService.waitMultiplePromises([loggerGridReadyDeferred.promise, sshGridReadyDeferred.promise]).then(function () {
                    defineAPI();
                });
            }
            ...
            function defineAPI() {
                ...
                api.load = function (payload) {
                    ...
                    promises.push(loadSwitchSSHCommunicationsPromise);
                    ...
                    function getLoadSwitchSSHCommunicationsPromise() {
                        var loadSwitchSSHCommunicationsDeferred = UtilsService.createPromiseDeferred();
                        ...
                        WhS_RouteSync_HuaweiSwitchLoggerAPIService.GetSwitchLoggerTemplates().then(function (response) {
                            ...
                            loadSwitchSSHCommunicationsDeferred.resolve();
                        });

                        return loadSwitchSSHCommunicationsDeferred.promise;
                    }
