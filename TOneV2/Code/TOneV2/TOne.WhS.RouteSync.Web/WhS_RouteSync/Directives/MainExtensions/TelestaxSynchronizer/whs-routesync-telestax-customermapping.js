...
app.directive('whsRoutesyncTelestaxCustomermapping', ['VRUIUtilsService', 'UtilsService',
    function (VRUIUtilsService, UtilsService) {
        return {
            ...
            controller: function ($scope, $element, $attrs) {
                var ctrl = this;
                var ctor = new TelestaxCustomerMappingDirectiveCtor($scope, ctrl, $attrs);
                ctor.initializeController();
            },
            controllerAs: 'ctrl',
            bindToController: true,
            templateUrl: '/Client/Modules/WhS_RouteSync/Directives/MainExtensions/TelestaxSynchronizer/Templates/TelestaxCustomerMappingTemplate.html'
        };

        function TelestaxCustomerMappingDirectiveCtor($scope, ctrl, $attrs) {
                    ...
                    if (payload != undefined) {
                        ...
                        if (customerMappings != undefined && customerMappings.length > 0) {
                            ...
                            for (var i = 0; i < customerMappings.length; i++) {
                                ...
                                extendCustomerMapping(currentCustomerMapping);
                            }
                            updateCustomerDescriptions();
                        }
                    }
