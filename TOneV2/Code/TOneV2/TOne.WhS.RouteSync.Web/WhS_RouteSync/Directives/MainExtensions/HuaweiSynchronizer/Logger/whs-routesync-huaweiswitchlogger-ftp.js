(function (app) {
    ...
    whsRoutesyncHuaweiloggerFtp.$inject = ["UtilsService", 'VRUIUtilsService'];

    function whsRoutesyncHuaweiloggerFtp(UtilsService, VRUIUtilsService) {
        return {
            restrict: "E",
            scope: {
                onReady: "="
        ...
        function FTPSwitchCommunicationCtor($scope, ctrl, $attrs) {
            ...
            function defineAPI() {
                ...
                api.getData = function () {
                    var data = {
                        $type: "TOne.WhS.RouteSync.Huawei.Business.HuaweiFTPLogger, TOne.WhS.RouteSync.Huawei",
