...
app.directive('whsRoutesyncCarrieraccountmappingTelestaxGrid', ['VRValidationService', 'VRUIUtilsService', 'UtilsService', 'WhS_BE_CarrierAccountAPIService', 'WhS_BE_CarrierAccountTypeEnum', 'WhS_BE_CarrierAccountActivationStatusEnum',
    function (VRValidationService, VRUIUtilsService, UtilsService, WhS_BE_CarrierAccountAPIService, WhS_BE_CarrierAccountTypeEnum, WhS_BE_CarrierAccountActivationStatusEnum) {
        return {
            ...
            controller: function ($scope, $element, $attrs) {
                var ctrl = this;
                var ctor = new TelestaxCarrierAccountMappingGridCtor($scope, ctrl, $attrs);
                ctor.initializeController();
            },
            controllerAs: 'ctrl',
            bindToController: true,
            templateUrl: '/Client/Modules/WhS_RouteSync/Directives/CarrierAccountMapping/Templates/CarrierAccountMappingTelestaxGridTemplate.html'
        };

        function TelestaxCarrierAccountMappingGridCtor($scope, ctrl, $attrs) {
            ...
            function defineAPI() {
                ...
                api.load = function (payload) {
                    ...
                    var telestaxCarrierAccountMappingsGridLoadPromise = getTelestaxCarrierAccountMappingsGridLoadPromise();
                    promises.push(telestaxCarrierAccountMappingsGridLoadPromise);
            ...
            function getTelestaxCarrierAccountMappingsGridLoadPromise() {

                var loadTelestaxCarrierAccountMappingsGridPromiseDeferred = UtilsService.createPromiseDeferred();
                ...
                WhS_BE_CarrierAccountAPIService.GetCarrierAccountInfo(serilizedCarrierAccountFilter).then(function (response) {
                    ...
                    loadTelestaxCarrierAccountMappingsGridPromiseDeferred.resolve();
                }).catch(function (error) {
                    loadTelestaxCarrierAccountMappingsGridPromiseDeferred.reject(error);
                });

                return loadTelestaxCarrierAccountMappingsGridPromiseDeferred.promise;
            }
