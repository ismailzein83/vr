...
namespace TOne.WhS.AccountBalance.MainExtensions.FinancialAccountTypes.SupplierPostpaid
{
    public class SupplierPostpaidSettings : FinancialAccountExtendedSettings
    {
        ...
        {
            SupplierPostpaidDefinitionSettings definitionSetting = new FinancialAccountDefinitionManager().GetFinancialAccountDefinitionExtendedSettings<SupplierPostpaidDefinitionSettings>(context.AccountTypeId);
