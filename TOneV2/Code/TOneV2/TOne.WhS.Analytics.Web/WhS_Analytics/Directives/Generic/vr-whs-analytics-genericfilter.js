...
app.directive("vrWhsAnalyticsGenericfilter", ['UtilsService', 'VRNotificationService', 'WhS_Analytics_GenericAnalyticDimensionEnum', 'VRUIUtilsService', 'WhS_Analytics_GenericAnalyticMeasureEnum', 'VRValidationService', 'VRDateTimeService',
    function (UtilsService, VRNotificationService, WhS_Analytics_GenericAnalyticDimensionEnum, VRUIUtilsService, WhS_Analytics_GenericAnalyticMeasureEnum, VRValidationService, VRDateTimeService) {
        ...
        function GenericFilter($scope, ctrl, $attrs) {
            ...
            function initializeController() {
                ...
                ctrl.fromdate = VRDateTimeService.getNowDateTime();
