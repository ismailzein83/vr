...
function carrierSummaryController($scope, WhS_Analytics_GenericAnalyticDimensionEnum, WhS_Analytics_GenericAnalyticMeasureEnum, VRNotificationService, UtilsService, VRUIUtilsService) {
    ...
    function loadPayload() {
        ...
        payload.filters.push(WhS_Analytics_GenericAnalyticDimensionEnum.Currency.value);
        return payload;
    }
    ...
    function loadMeasures() {
        ...
        measures.push(WhS_Analytics_GenericAnalyticMeasureEnum.PricedDuration.value);
        measures.push(WhS_Analytics_GenericAnalyticMeasureEnum.NumberOfCalls.value);
        measures.push(WhS_Analytics_GenericAnalyticMeasureEnum.SaleNets.value);
        measures.push(WhS_Analytics_GenericAnalyticMeasureEnum.CostNets.value);
        measures.push(WhS_Analytics_GenericAnalyticMeasureEnum.Profit.value);
       
    }
}
appControllers.controller('WhS_Analytics_CarrierSummaryController', carrierSummaryController);
