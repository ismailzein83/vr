var RouteRuleEditorController = function ($scope, $http, $location, $routeParams, notify, RoutingAPIService) {
    ...
    function defineScopeObjects() {
        ...
        $scope.optionsRuleType = {
            datasource:[
              { name: 'Customer', url: '/Client/Modules/Routing/Views/Management/EditorTemplates/CustomerTemplate.html' },
              { name: 'Pool', url: '/Client/Modules/Routing/Views/Management/EditorTemplates/PoolTemplate.html' },
              { name: 'Product', url: '/Client/Modules/Routing/Views/Management/EditorTemplates/ProductTemplate.html' }
            ],
            selectedvalue: ""
        };          
        $scope.optionsRouteType.datasource = [
             { name: 'Override Route', url: '/Client/Modules/Routing/Views/Management/EditorTemplates/RouteOverrideTemplate.html', objectType: 'TOne.LCR.Entities.OverrideRouteActionData, TOne.LCR.Entities' },
             { name: 'Priority Rule', url: '/Client/Modules/Routing/Views/Management/EditorTemplates/PriorityTemplate.html', objectType: 'TOne.LCR.Entities.PriorityRouteActionData, TOne.LCR.Entities' },
             { name: 'Block Route', url: '/Client/Modules/Routing/Views/Management/EditorTemplates/RouteBlockTemplate.html', objectType: 'TOne.LCR.Entities.BlockRouteActionData, TOne.LCR.Entities' }
        ];

        $scope.optionsEditorType.datasource = [
             { name: 'Zone', url: '/Client/Modules/Routing/Views/Management/EditorTemplates/ZoneTemplate.html', objectType: 'TOne.LCR.Entities.ZoneSelectionSet, TOne.LCR.Entities' },
             { name: 'Code', url: '/Client/Modules/Routing/Views/Management/EditorTemplates/CodeTemplate.html', objectType: 'TOne.LCR.Entities.CodeSelectionSet, TOne.LCR.Entities' }
        ];
