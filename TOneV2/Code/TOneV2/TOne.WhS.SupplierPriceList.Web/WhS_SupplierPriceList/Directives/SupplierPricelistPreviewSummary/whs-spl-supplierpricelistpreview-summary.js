...
app.directive("whsSplSupplierpricelistpreviewSummary", ["WhS_BE_CarrierAccountAPIService", "UtilsService", "VRUIUtilsService", "VRNotificationService", "WhS_SupPL_SupplierPriceListPreviewPIService", "VRCommon_FileAPIService", "VRCommon_CurrencyAPIService", "WhS_SupPL_SupplierPriceListTypeEnum", "DateTimeFormatEnum",
    function (WhS_BE_CarrierAccountAPIService, UtilsService, VRUIUtilsService, VRNotificationService, WhS_SupPL_SupplierPriceListPreviewPIService, VRCommon_FileAPIService, VRCommon_CurrencyAPIService, WhS_SupPL_SupplierPriceListTypeEnum, DateTimeFormatEnum) {
        ...
        function SupplierPriceListPreviewSummary($scope, ctrl) {
            ...
            function loadSupplierPricelistPreviewSummary() {
                ...
                return WhS_SupPL_SupplierPriceListPreviewPIService.GetSupplierPricelistPreviewSummary(processInstanceId).then(function (previewSummary) {
                    ...
                    $scope.scopeModel.NumberOfImportedCodes = previewSummary.NumberOfImportedCodes;
                    $scope.scopeModel.NumberOfImportedZoneRates = previewSummary.NumberOfImportedZoneRates;
                });
            }
        }
