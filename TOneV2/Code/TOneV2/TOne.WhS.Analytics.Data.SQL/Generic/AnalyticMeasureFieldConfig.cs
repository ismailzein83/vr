...
namespace TOne.WhS.Analytics.Data.SQL
{
    ...
    public class MeasureValueExpression
    {
        ...
        public static MeasureValueExpression MaxDurationInMin_Expression = new MeasureValueExpression { ColumnAlias = "Measure_MaxDurationInSeconds", Expression = "CONVERT(DECIMAL(10,2),Max (ts.MaxDurationInSeconds)/60.0)", ExpressionSummary = AnalyticSummary.Max.ToString("G") };
