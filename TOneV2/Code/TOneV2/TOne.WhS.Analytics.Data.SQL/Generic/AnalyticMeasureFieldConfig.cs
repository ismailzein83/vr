...
namespace TOne.WhS.Analytics.Data.SQL
{
    ...
    public class MeasureValueExpression
    {
        ...
        public static MeasureValueExpression DurationsInSeconds_Expression = new MeasureValueExpression { ColumnAlias = "Measure_DurationInSeconds", Expression = "Sum(ts.TotalDurationInSeconds)", ExpressionSummary = AnalyticSummary.Sum.ToString("G") };
