app.constant('ReleaseCodeMeasureEnum', {
    RelCode: { value: 0, propertyName: "RelCode", description: "Rel. Code", type: "text", fieldName: "Data.RelCode" },
    ...
    FirstCall: { value: 6, propertyName: "FirstCall", description: "First Call", type: "Datetime", fieldName: "Data.FirstCall" },
    LastCall: { value: 7, propertyName: "LastCall", description: "Last Call", type: "Datetime", fieldName: "Data.LastCall" }
});