 app.constant('HourlyReportMeasureEnum', {
        ...
        GrayArea: { value: 7, propertyName: "GrayArea", description: "% GrayArea", isSum: true, type: "Number", fieldName: "Data.GrayArea" },
        CapacityUsageDetails: { value: 8, propertyName: "CapacityUsageDetails", description: "Capacity Usage Details", isSum: true, type: "MultiProgress", fieldName:"Data.GrayArea|Data.GreenArea"},
        GreenArea: { value: 12, propertyName: "GreenArea", description: "% GreenArea", isSum: true, type: "Number", fieldName: "Data.GreenArea" },
