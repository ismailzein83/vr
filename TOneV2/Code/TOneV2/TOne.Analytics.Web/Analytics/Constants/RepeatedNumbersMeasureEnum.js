app.constant('RepeatedNumbersMeasureEnum', {
    CustomerID: { value: 2, propertyName: "CustomerID", description: "Customer", isSum: true, type: "Text",isShown:true },
   
    SupplierID: { value: 4, propertyName: "SupplierID", description: "Supplier", isSum: true, type: "Text", isShown: true },
    SwitchName: { value: 3, propertyName: "SwitchName", description: "Switch Name", isSum: true, type: "Text", isShown: false },
    ZoneID: { value: 5, propertyName: "OurZoneID", description: "Zone", isSum: true, type: "Text", isShown: true },
