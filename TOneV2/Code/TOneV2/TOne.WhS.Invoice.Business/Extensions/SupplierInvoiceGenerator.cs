...
namespace TOne.WhS.Invoice.Business.Extensions
{
	public class SupplierInvoiceGenerator : InvoiceGenerator
	{
		...
		public override void GenerateInvoice(IInvoiceGenerationContext context)
		{
			...
			if (supplierInvoiceDetails != null)
			{
				...
				if ((minAmount.HasValue && totalAmountInSystemCurrency >= minAmount.Value) || (!minAmount.HasValue && totalAmountInSystemCurrency != 0))
				{
                    ...
                    supplierInvoiceDetails.NoDeals = supplierInvoiceDetails.TotalDealAmount == 0;
                    supplierInvoiceDetails.NoSMS = supplierInvoiceDetails.TotalSMSAmountAfterCommission == 0;
                    supplierInvoiceDetails.NoVoice = supplierInvoiceDetails.TotalAmountAfterCommission == 0;
        ...
        private void AddAdjustmentToCustomerCurrency(List<SupplierInvoiceBySaleCurrencyItemDetails> supplierInvoiceByCostCurrencyItemDetails, int currency, DateTime fromDate, DateTime toDate, decimal value)
        {
            ...
            {
                supplierInvoiceByCostCurrencyItemDetails.Add(new SupplierInvoiceBySaleCurrencyItemDetails
                {
                    FromDate = fromDate,
                    ToDate = toDate,
