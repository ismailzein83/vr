...
namespace TOne.CDRProcess.Activities
{
    ...
    {
        public TOneQueue<CDRBase> InputQueue { get; set; }

        public TOneQueue<CDRMain> OutputMainCDRQueue { get; set; }

        public TOneQueue<CDRInvalid> OutputInvalidCDRQueue { get; set; }
    ...
    public sealed class ProcessBillingCDRs : DependentAsyncActivity<ProcessBillingCDRsInput>
    {
        ...
        [RequiredArgument]
        public InOutArgument<TOneQueue<CDRInvalid>> OutputInvalidCDRQueue { get; set; }
        ...
        protected override void OnBeforeExecute(AsyncCodeActivityContext context, Vanrise.BusinessProcess.AsyncActivityHandle handle)
        {
            if (this.OutputMainCDRQueue.Get(context) == null)
                this.OutputMainCDRQueue.Set(context, new TOneQueue<CDRBase>());
            ...
            DoWhilePreviousRunning(previousActivityStatus, handle, () =>
            {
                do
                {
                    hasItem = inputArgument.InputQueue.TryDequeue((billingCDR) =>
                    {
                        ...
                        //    TABS.Billing_CDR_Main main = (TABS.Billing_CDR_Main)billingCDR;
                        ...
                        //    inputArgument.OutputMainCDRQueue.Enqueue(billingCDR);
                        //}
                        //else
                        //{
                        //    inputArgument.OutputInvalidCDRQueue.Enqueue(billingCDR);
                        //}
