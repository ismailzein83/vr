...
{
    public class AffectedCarrierAccountFilterInRateChanges : ICarrierAccountFilter
    {
        ...
        private class CustomObject
        {
            ...
            {
                AffectedCustomerIds = new SalePriceListChangeManager().GetAffectedCustomerIdsRateChangesByProcessInstanceId(processInstanceId);
            }
