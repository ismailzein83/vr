...
namespace TOne.WhS.Routing.Business
{
    public class TrafficStatisticQualityConfigurationManager
    {
        ...
        //        public List<string> GetExpressionMeasureFields(Guid QualityConfigurationId, string expression)
        //        {
        //            if (string.IsNullOrEmpty(expression))
        //                return null;

        //            string cacheName = string.Concat("GetExpressionMeasureFields_", QualityConfigurationId.ToString("N"));
