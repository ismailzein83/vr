    ...
    public class CloseCodeNotExistAndEffectiveCondition : BusinessRuleCondition
    {
        ...
        public override bool Validate(IBusinessRuleConditionValidateContext context)
        {
            ...
            if (zoneToProcess.CodesToClose != null)
            {
                ...
                {
                    if (codeToClose.ChangedExistingCodes.Count() == 0 && !codeToClose.ChangedExistingCodes.Any(item => item.CodeEntity.Code == codeToClose.Code) && !zoneToProcess.CodesToAdd.Any(itm => itm.Code == codeToClose.Code))
                        return false;
                }
            }
