RateAnalysisController.$inject = ['$scope', 'UtilsService', '$q', 'CarrierAccountAPIService', 'CarrierTypeEnum', 'SupplierPricelistsAPIService'];

function RateAnalysisController($scope, UtilsService, $q, CarrierAccountAPIService, CarrierTypeEnum, SupplierPricelistsAPIService) {
    var mainGridAPI;
    defineScope();
    load();
