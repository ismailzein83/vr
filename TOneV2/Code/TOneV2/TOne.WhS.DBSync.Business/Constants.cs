...
namespace TOne.WhS.DBSync.Business
{
    ...
    {
        public const string _Temp = "_Temp";
        public const string SCHEMA_Common = "Common";
        public const string SCHEMA_TOneWhS_BE = "TOneWhS_BE";
        public const string DB_TOneConfiguration_Migration = "TOneConfiguration_Migration";
