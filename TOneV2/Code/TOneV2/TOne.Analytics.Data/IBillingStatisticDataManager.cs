...
namespace TOne.Analytics.Data
{
    public interface IBillingStatisticDataManager : IDataManager
    {
        ...
        DestinationVolumeTrafficResult GetDestinationTrafficVolumes(DateTime fromDate, DateTime toDate, string customerID, string supplierID, int zoneID, int attempts, VolumeReportsTimePeriod timePeriod, int topDestination);
