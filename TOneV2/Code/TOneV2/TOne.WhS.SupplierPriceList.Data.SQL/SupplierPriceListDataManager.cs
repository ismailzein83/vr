...
namespace TOne.WhS.SupplierPriceList.Data.SQL
{
...

    {
        ...
        {
            int recordesEffected = ExecuteNonQuerySP("TOneWhS_BE.sp_SupplierPriceList_SyncWithImportedData", priceListId, processInstanceId, splStateBackupId, supplierId, currencyId, fileId, effectiveOn);
            return (recordesEffected > 0);
        }
    }
}
