(function (appControllers) {
    ...
    operatorProfileManagementController.$inject = ['$scope', 'UtilsService', 'VRNotificationService', 'VRUIUtilsService', 'InterConnect_BE_OperatorProfileService'];

    function operatorProfileManagementController($scope, UtilsService, VRNotificationService, VRUIUtilsService, InterConnect_BE_OperatorProfileService) {
        var gridAPI;
    ...
    appControllers.controller('InterConnect_BE_OperatorProfileManagementController', operatorProfileManagementController);
})(appControllers);