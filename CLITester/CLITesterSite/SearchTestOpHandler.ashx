...
public class SearchTestOpHandler : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        var result = new
        {
            ...
            aaData = data
            .Select(p => new[] { p.Name , p.Route, p.CreationDate.ToString(), (p.EndDate.ToString() == "")? "" : p.EndDate.ToString(), (p.DisplayName == null || p.DisplayName == "")? "" : p.DisplayName, (p.TestCli == null || p.TestCli == "") ? "" : p.TestCli, (p.ReceivedCli == null || p.ReceivedCli == "")? "" : p.ReceivedCli,
