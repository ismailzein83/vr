<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ManageRequestCalls.aspx.cs" Inherits="ManageRequestCalls" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="row-fluid">
        <div class="span12">
            ...
            <h3 class="page-title">History Request Calls
            </h3>
            <ul class="breadcrumb">
                <li><i class="icon-home"></i><a href="default.aspx">Home</a><i class="icon-angle-right">
                </i></li>
                <li><a href="#">History Request Calls</a></li>
            </ul>
        ...
        <div class="span12">
            ...
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption"><i class="icon-reorder"></i>History Request Calls List</div>
                    <div class="actions">
                        <div class="btn-group">
                            ...
                            <div id="sample_2_column_toggler" class="dropdown-menu hold-on-click dropdown-checkboxes pull-right">
                                 <label>
                                    <input type="checkbox" checked data-column="0">Request Id</label>
                                <label>
                                    <input type="checkbox" checked data-column="1">Creation Date</label>
                                <label>
                                    <input type="checkbox" checked data-column="2">Release Date</label>
                                <label>
                                    <input type="checkbox" checked data-column="3">Operator</label>
                                <label>
                                    <input type="checkbox" checked data-column="4">Client</label>
                                <label>
                                    <input type="checkbox" checked data-column="5">Phone Number</label>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="portlet-body">
                    <table class="table table-striped table-bordered table-hover table-full-width" id="sample_2">
                        <thead>
                            <tr>
                                <th class="span2">Request Id</th>
                                <th class="span2">Creation Date</th>
                                <th class="span2">Release Date</th>
    ...
    <script>
        ...
        var initTable2 = function () {
            var oTable = $('#sample_2').dataTable({
                ...
                'bStateSave': false,
                'sAjaxSource': 'SearchReqCallHandler.ashx?operatorId=0&startDate=' + $('#txtStartDate').val() + '&releaseDate=' + $('#txtEndDate').val(),
            });
            ...
            $("#btnSearch").click(function () {
                ...
                var res = dl1.split("~");
                var ajaxHandler = 'SearchReqCallHandler.ashx?operatorId=' + res[1] + '&startDate=' + $('#txtStartDate').val() + '&releaseDate=' + $('#txtEndDate').val();
